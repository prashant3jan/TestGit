...
<table>
	...
	<tr>
		<td>Father's / Husbands Name <s:textfield name="memberBean.applicantFather" style="width:120px;" /></td>
	</tr>
	<tr>
		<td>Applicant's Mother's Name <s:textfield name="memberBean.applicantMother" style="width:120px;" /></td>
	</tr>
	<tr>
		<td>Applicant's Occupation <s:select name="memberBean.applicantOccupation" list="{'Business','Govt. Service', 'Pvt. Service','Agriculture','Others'}" multiple="false" /></td>
	</tr>
	<tr>
		<td>Present Address <s:textfield name="memberBean.applicantAddress" /></td>
	</tr>
	<tr>
		<td>Applicant's City <s:textfield name="memberBean.applicantCity" /></td>
		<td>Applicant's State <s:textfield name="memberBean.applicantState" /></td>
		<td>Applicant's Pin <s:textfield name="memberBean.applicantPin" /></td>
	</tr>
	<tr>
		<td>PAN Number <s:textfield name="memberBean.applicantPan" label="Applicant's PAN Number" /></td>
		<td>Mobile No <s:textfield name="memberBean.applicantMobile" label="Applicant's Mobile Number" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Nominee's Address <s:textfield name="memberBean.nomineeAddress" /></td>
	</tr>
</table>
<div id="colorbox">
...
<div id="box5">
	<div>
		Membership fee in figure: <s:textfield name="memberBean.memFeeFig" />
	</div>
	<div>
		Membership Fee In Words <s:textfield name="memberBean.memFeeWords" />
	</div>
...
<div id="wrapper">
	...
	<div id="box8" class="leftbox"><s:textfield
