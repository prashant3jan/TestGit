...
if "%1"=="EventDataExtra"    (set JTABLE=org.opengts.db.tables.EventDataExtra)       & goto foundTable
...
if "%1"=="DBAudit"           (set JTABLE=org.opengts.dbtools.DBAudit)                & goto foundTable
...
if "%1"=="RGCache"           (set JTABLE=org.opengts.extra.tables.RGCache)           & goto foundTable
