...
SERVER_LIST_DIR="${GTS_HOME}/bin"
SERVER_LIST="${SERVER_LIST_DIR}/serverList"
SERVER_LIST_CUSTOM="${SERVER_LIST_DIR}/serverList.custom"
...
function runServers() {
    ...
    if   [ -f "${SERVER_LIST}" ]; then
        ...
        . ${SERVER_LIST}
    elif [ -f "${SERVER_LIST_DIR}/${SERVER_LIST}" ]; then
        # -- multiple calls to "execServer"
        . ${SERVER_LIST_DIR}/${SERVER_LIST}
    else
...
# --
echo "Missing start|stop|restart|list|..."
usage
