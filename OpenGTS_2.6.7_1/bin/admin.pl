...
$DBTools_Tables  = "$GTS_STD_PKG.dbtools";
...
%Class_names = (
    ...
    "EventDataExtra"    => $Standard_Tables . ".EventDataExtra",
    ...
    "DBAudit"           => $DBTools_Tables  . ".DBAudit",
    # --
