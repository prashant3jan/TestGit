...
case "$1" in 
    ...
    "EventDataExtra"    ) JMAIN="org.opengts.db.tables.EventDataExtra"       ;;
    ...
    "DBAudit"           ) JMAIN="org.opengts.dbtools.DBAudit"                ;;
    # --
    ...
    "RGCache"           ) JMAIN="org.opengts.extra.tables.RGCache"           ;;
    ...
    # --
    "Download"          ) JMAIN="org.opengts.opt.tables.Download"            ;;
esac
if [ "$JMAIN" = "" ]; then
    usage
fi
