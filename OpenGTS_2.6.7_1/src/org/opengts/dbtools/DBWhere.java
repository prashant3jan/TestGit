...
//  2018/09/10  GTS Developement Team
//     -Added "isNULL(fld)" and "isNotNULL(fld)"
//  2020/02/19  GTS Developement Team
//     -Added INLIST(...) inclusion/exclusion [2.6.7-B21d]
// ----------------------------------------------------------------------------
...
public class DBWhere
{
    ...
    **/
    ...
    /**
    *** Returns true if nothing has yet been appended to this DBWhere
    **/
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String isNULL(String fld)
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String isNotNULL(String fld)
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        //sb.append(DBProvider.getProvider().getStartColumnChar()).append(fld).append(DBProvider.getProvider().getEndColumnChar());
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String INLIST(String fld, boolean inclusion, Iterable<?> list)
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        if (USE_NATIVE_INLIST) {
            ...
            int i = 0;
            for (Iterator<?> v = list.iterator(); v.hasNext(); i++) {
                // -- concatenate to previous field/value
                if (i > 0) { 
                    if (!inclusion) {
                        // -- exclude: ( F!="a" AND F!="b" AND ... )
                        sb.append(" AND "); 
                    } else {
                        // -- include: ( F="a" OR F="b" OR ... )
                        sb.append(" OR ");
                    }
                }
                // -- add field/value
    ...
    **/
    ...
    {
        return this.INLIST(fld, true, list);
    }
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String INLIST(String fld, boolean inclusion, Object list[])
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        if (USE_NATIVE_INLIST) {
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String INLIST(String fld, boolean inclusion, int list[])
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        if (USE_NATIVE_INLIST) {
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String INLIST(String fld, boolean inclusion, long list[])
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        if (USE_NATIVE_INLIST) {
    ...
    *** @return A String representation of the internal temporary StringBuffer
    **/
    public String INLIST(String fld, boolean inclusion, DBSelect<?> dbsel)
    {
        StringBuffer sb = this._getTempSB();
        sb.append("(");
        if (dbsel == null) {
        ...
        if (USE_NATIVE_INLIST) {
            ...
            // -- not supported
            Print.logWarn("DBSelect not supported for non-native in-list");
        }
        sb.append(")");
        return sb.toString();
    }
    ...
    **/
    ...
    {
        return this.INLIST(fld, true, dbsel);
    }
