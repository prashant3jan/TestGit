...
//     -Modified "setSelectedFields" to change order of field name checking [2.6.7-B20b]
// ----------------------------------------------------------------------------
        ...
        if (ListTools.isEmpty(sf)) {
            ...
            if (fact != null) {
                for (int i = 0; i < sf.length; i++) {
                    ...
                    if (sf[i].equalsIgnoreCase(DBProvider.FLD_COUNT())) { // check before 'hasField' [2.6.7-B20b]
                        // ok, "COUNT(*)" allowed
                    } else
                    if (fact.hasField(sf[i])) { // check after 'FLD_COUNT' [2.6.7-B20b]
