...
public class DBRecordIterator<DBR extends DBRecord<DBR>>
{
    ...
    private DBReadWriteMode     rwMode          = DBReadWriteMode.READ_ONLY;
    ...
    **/
    public DBRecordIterator(DBReadWriteMode rwMode, DBSelect<DBR> dbSel)
        throws DBException
    {
        super();
        this.rwMode     = (rwMode != null)? rwMode : DBReadWriteMode.READ_ONLY;
        this.iterator   = null;
    ...
    **/
    ...
    /**
    *** Gets the Read/WriteMode
    **/
    protected DBReadWriteMode getReadWriteMode()
    {
        return (this.rwMode != null)? this.rwMode : DBReadWriteMode.READ_ONLY;
    }
    ...
    **/
        ...
        throws DBException, DBNotFoundException
    {
        ...
        try {
            ...
            rcdArry = DBRecord.select(this.getReadWriteMode(), this.dbSelector, null); // "unchecked cast"
        } finally {
