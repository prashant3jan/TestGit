...
//     -Removed "&channel=" parameter [2.6.7-B10d]
// ----------------------------------------------------------------------------
...
public class GoogleRoads
{
    ...
    public static final String PROP_GoogleRoads_includeChannel  = "GoogleRoads.includeChannel";
  ...
  //public    static final double   SNAPTOROAD_MaxDistanceM = 300.0; // recommended, but not practical
    ...
    public    static final String   PROP_channel            = "channel";            // speed   snap
    ...
    **/
    ...
    private boolean      inclChannel = false;
    ...
    **/
    ...
    {
        this(rtProps, RTConfig.getBoolean(PROP_GoogleRoads_includeChannel,false));
    }

    /**
    *** Constructor
    **/
    public GoogleRoads(RTProperties rtProps, boolean inclChannel)
    {
        this();
        if (rtProps != null) {
            this.props = rtProps;
    ...
    **/
    protected String getSpeedLimitsURL(GeoPoint gp, String clientChannel)
    {
        ...
        /* channel */
        // -- IMPORTANT NOTE: 2018/11/21 [2.6.7-B10d]
        // -  https://developers.google.com/maps/documentation/roads/speed-limits
        // -  Google has removed the "&channel=" parameter from the RoadsAPI SpeedLimit feature.
        // -  In fact, if the "&channel=" is present the SpeedLimit lookup will FAIL:
        // -  > BadRequest: Invalid JSON payload received. Unknown name "channel": Cannot bind query parameter. ...
        if (this.inclChannel) { // defaults to "false"
            String channel;
    ...
    **/
    public double getSpeedLimitKPH(GeoPoint gp, String clientChannel)
    {

        /* URL */
        String url = this.getSpeedLimitsURL(gp, clientChannel);
    ...
    **/
        ...
        boolean interpolate, Locale locale)
    {
        ...
        /* predefined URL */
        String rgURL = this.getProperties().getString(PROP_snapToRoadsURL,null); // if defined, must already contain API_KEY
        if (!StringTools.isBlank(rgURL)) {
            URIArg uriArg = new URIArg(rgURL, true);
