...
//  2016/10/03 v2.6.3,  2017/04/13 v2.6.4,  2017/10/09 v2.6.5,  2018/09/10 v2.6.6,
//  2020/02/19 v2.6.7,
// ----------------------------------------------------------------------------
package org.opengts;
...
public class Version
{
    ...
    public  static final String COPYRIGHT = "Copyright 2007-2020, GeoTelematic Solutions, Inc.";

    // ------------------------------------------------------------------------

    // -- This string is parsed via 'grep' & 'sed' scripts.
    // -- ONLY the version value specified within the quotes should change.
    private static final String VERSION = "2.6.7"; // 2.6.7-B48b, 2.6.6-B72
    ...
    private static final long PACKAGE_TIMESTAMP = 1582143701L;
