    ...
    extends InputStream
{
    ...
    *** @param b  The byte array into which the read bytes will be returned.
    ***           The length of the byte array indicates how many bytes should be read.
    *** @param blockOK  True to allow force reading the entire byte array, even if the read will block.
    ***                 Otherwise only read up to the number of currently available bytes.
