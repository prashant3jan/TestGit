...
//     -Added RGCache support [2.6.7-B35d]
// ----------------------------------------------------------------------------
    ...
    implements ReverseGeocodeProvider, GeocodeProvider
{
    ...
    // -- [RGCache]
    // -    # -- DB cache
    // -    RGCache.enableDBCache=true
    // -    RGCache.ignoreWhileMoving=true
    // -    RGCache.readByPrimaryKey=true
    // -    RGCache.maximumAgeDays=180
    // -    RGCache.deleteExpiredEntries=false
    // -    # -- memory cache
    // -    Domain.ReverseGeocodeProvider.cacheMaximumSize=3000
    // -    Domain.ReverseGeocodeProvider.cacheMaxEntryAgeSec=14400
    // -    Domain.ReverseGeocodeProvider.cacheTrimIntervalSec=1800
    // -    Domain.ReverseGeocodeProvider.cacheEnableDB=true
    ...
    protected static final String  PROP_cacheMaxEntryAgeMS      = "cacheMaxEntryAgeMS";   // Long: (use "cacheMaxEntryAgeSec")
    protected static final String  PROP_cacheTrimIntervalSec    = "cacheTrimIntervalSec"; // Long: Auto-trim interval
    protected static final String  PROP_cacheTrimIntervalMS     = "cacheTrimIntervalMS";  // Long: (use "cacheTrimIntervalSec")
    protected static final String  PROP_cacheEnableDB           = "cacheEnableDB";        // Boolean: Enable DB caching

    // ------------------------------------------------------------------------

    /* ReverseGeocodeCache [RGCache] */
    public    static       int     CACHE_MAXIMUM_SIZE           =  0;                 //  0 means disabled
    public    static       long    CACHE_MAXIMUM_AGE_MS         =  4L * 60L * 60000L; //  4 hours?
    public    static       long    AUTO_TRIM_INTERVAL_MS        = 30L * 60000L;       // 30 minutes?
    ...
    protected static final int     RG_PROVIDER                  = ReverseGeocodeCache.RGPROV_OPENCAGEDATA; // [RGCache]
    ...
    public OpenCageData(String name, String key, RTProperties rtProps)
    {
        ...
        if (rtProps != null) {
            // -- ReverseGeocodeCache (may not be supported in this release) [RGCache]
        ...
        /* start ReverseGeocodeCache [RGCache] */
    ...
    **/
        ...
        Properties props)
    {
        ...
        revGeo: { // single-pass loop

            /* check ReverseGeocodeCache [RGCache] */
    ...
    public ReverseGeocode getAddressReverseGeocode(
        GeoPoint gp, boolean isMoving, String localeStr, 
        boolean cache, String clientID,
        Properties props)
    {
