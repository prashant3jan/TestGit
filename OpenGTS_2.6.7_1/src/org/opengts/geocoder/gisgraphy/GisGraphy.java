    ...
    implements ReverseGeocodeProvider, SubdivisionProvider
{
    ...
    **/
    public ReverseGeocode getReverseGeocode(
        ...
        Properties props)
    {
        ReverseGeocode rg = this.getAddressReverseGeocode(gp, localeStr, isMoving, cache, props);
        return rg;
    }
    ...
    *** @return The ReverseGeocode instance
    **/
    private ReverseGeocode getAddressReverseGeocode(GeoPoint gp, String localeStr, boolean isMoving, boolean cache, Properties props) 
    {
