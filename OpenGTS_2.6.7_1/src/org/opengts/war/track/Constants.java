...
public interface Constants
{
    ...
    public  static final String DEFAULT_BILLING_URI         = "/BillingReport";

    public  static final String DEFAULT_DEMO_LOGIN_URI      = "/DemoLogin";

    public  static final String DEFAULT_JSON_URI            = "/JSON";
    public  static final String DEFAULT_CTRAC_URI           = "/Ctrac";
  ...
  //public  static final String PARM_REQSTATE               = CommonServlet.PARM_REQSTATE;
    ...
    public  static final String PARM_REMEMBER               = "remember";
    ...
    public  static final String PARM_SA_RELOGIN_PASS        = "sar_p";
    public  static final String PARM_SA_RELOGIN_ACCT        = "sar_a";
    public  static final String PARM_SA_RELOGIN_USER        = "sar_u";
    public  static final String PARM_SA_RELOGIN_TIME        = "sar_t";

    // ------------------------------------------------------------------------
    // Previous login times (prior to current login)

  //public  static final String LAST_LOGIN_USER             = "lastLogin_user";
  //public  static final String LAST_LOGIN_ACCOUNT          = "lastLogin_account";
    ...
    public  static final String PAGE_LOGIN_MSG              = "login.msg";              // login message page
    ...
    public  static final String PAGE_MENU_DASHBOARD         = "dashboard.main";         // Dashboard
