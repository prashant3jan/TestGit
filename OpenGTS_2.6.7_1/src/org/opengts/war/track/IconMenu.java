        ...
        throws IOException
    {
        ...
        for (String mgn : menuMap.keySet()) {
            ...
            for (WebPage wp : mg.getWebPageList(reqState)) {
                ...
                String iconImg2  = showIcon? wp.getMenuIconImage2() : null;
                ...
                if (StringTools.isBlank(buttonImg)) {
                    ...
                    if (!StringTools.isBlank(iconImg)) {
                        // <img src="NotFound.gif" onerror="this.onerror=null;this.src='Found.gif';" />
                        out.write("<img class='"+menuIconImage+"' border='0'"+
                            " src='"+iconImg+"'"+
                            (!StringTools.isBlank(iconImg2)?" onerror=\"this.onerror=null;this.src='"+iconImg2+"';\"":"")+
                            "/>");
                        out.write("<br>");
                    }
