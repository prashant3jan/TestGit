    ...
    implements Constants
{
    ...
    **/
    ...
    /**
    *** Allows subclass to filter the DeviceChooser list of Groups/Devices/Drivers
    *** that will appear in the pull-down menu
    **/
    ...
    {
        // -- override to implement custom filtering
        return idList; // default return as-is
    }
            ...
            public void write(PrintWriter out) throws IOException {
                ...
                if (isDevice) {
                    ...
                    if (DeviceChooser.isDeviceChooserUseTable(privLabel)) { // Device
                        ...
                        java.util.List<String> devList = reqState.getDeviceIDList(DBReadWriteMode.READ_WRITE, false/*inclInactv*/);
                ...
                if (isDriver) {
                    ...
                    if (DeviceChooser.isDeviceChooserUseTable(privLabel)) { // Driver
                        ...
                        java.util.List<String> drvList = reqState.getDriverIDList(DBReadWriteMode.READ_WRITE);
                ...
                if (DeviceChooser.isDeviceChooserUseTable(privLabel) && 
                    ...
                    idList = ReportMenu.this.filterDeviceChooserList(reqState, idList); // [DCFILTER]
