    ...
    implements Constants
{
    ...
    // -- must match Track._DEFAULT_ID_ [TODO: move to common area]
        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(cssAccountLogin, pageMsg) {
            ...
            public void write(PrintWriter out) throws IOException {
                ...
                boolean acctLogin    = privLabel.getShowAccountLogin();
                boolean userLogin    = privLabel.getShowUserLogin();
                boolean emailLogin   = privLabel.getShowEmailLogin();
                ...
                if (acctLogin) {
                    ...
                    out.print(      "<td class='accountLoginFieldValue'>");
                    out.print(      "<input id='"+fldID+"' type='hidden' name='"+Constants.PARM_ACCOUNT +"' value='"+_DEFAULT_ID_+"'/>");
                    out.print(      "</td>");
                    out.print(  "</tr>\n");
                }
