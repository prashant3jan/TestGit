    ...
    implements Constants
{
  ...
  //public  static final String PARM_ADDRESS_LINE_2     = "u_adrl2";
        ...
        throws IOException
    {
        ...
        /* argument user-id */
        String userList[] = reqState.getUserList(); // uses DBReadWriteMode.READ_WRITE
        ...
        boolean showFilter   = privLabel.getBooleanProperty(PrivateLabel.PROP_AdminPage_showSearchFilter,false) && Track.jsFileExists(FILTER_JS);
            ...
            if (selUser == null) {
                ...
                try {
                    ...
                    if (dupEmailOK) {
                        ...
                        User user = User.getUserForContactEmail(null, contactEmail, false/*unique*/);
                        if (user == null) {
                            // -- no duplicate found
                            selUser.setContactEmail(contactEmail);
                        } else 
            ...
            public void write(PrintWriter out) throws IOException {
              ...
              //String selectUserJS = "javascript:dinfoSelectUser()";
                ...
                if (_listUsers) {
                    ...
                    // -- user selection table (Select, User ID, User Desc)
                    out.write("<span class='"+CommonServlet.CSS_ADMIN_SELECT_TITLE+"'>"+i18n.getString("UserInfo.selectUser","Select a User")+":</span>\n");
                    ...
                    if (_viewGroups) {
                        ...
                        try {
                            if (_selUser != null) {
                                _selUser.clearCachedDeviceGroupIDs();
                                devGroups = _selUser.getExplicitlyAuthorizedDeviceGroupIDs(DBReadWriteMode.READ_WRITE);
                            } else {
                                devGroups = null;
                            }
                        } catch (DBException dbe) {
                        ...
                        if (_editGroups) {
                            ...
                            try {
                                java.util.List<String> grpList = DeviceGroup.getDeviceGroupsForAccount(DBReadWriteMode.READ_WRITE,currAcctID,false);
                                for (int g = 0; g < _devGrps.length; g++) {
                  ...
                  //out.println(FormRow_ComboBox (PARM_USER_SELECT   , !isCurrentUserSelected, i18n.getString("UserInfo.userID","User ID")+":", _selUserID, _userList, selectUserJS, -1));
                    ...
                    if (_showACLs && _viewAcls) {
                        //Print.logInfo("UserAcl JSON = \n" + User.getAclEntriesJSON(_selUser,privLabel));
