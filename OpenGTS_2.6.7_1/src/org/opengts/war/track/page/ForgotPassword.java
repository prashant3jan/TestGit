  ...
  //private static final boolean SEND_ACCOUNT_LIST          = true;
        ...
        String contactEmail)
    {
        ...
        if (StringTools.isBlank(to)) {
            ...
            String cc   = null;
            String bcc  = null;
            boolean sent = EMail.send(from,to,cc,bcc,subj,body.toString(),smtpProps).isOK();
            if (sent) {
        ...
        String contactEmail)
    {
        ...
        if (StringTools.isBlank(to)) {
            ...
            String cc   = null;
            String bcc  = null;
            boolean sent = EMail.send(from,to,cc,bcc,subj,body,smtpProps).isOK();
            if (sent) {
                Print.logInfo("Password email sent");
        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CSS_FORGOT_PASSWORD, m) {
            public void write(PrintWriter out) throws IOException {
                ...
                boolean usrLogin = privLabel.getShowUserLogin();
