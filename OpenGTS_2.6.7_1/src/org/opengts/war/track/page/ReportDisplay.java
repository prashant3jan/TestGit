...
//     -Fixed pop-up map CSS issue (CSS now written to map) [2.6.6-B48c]
// ----------------------------------------------------------------------------
    ...
    implements Constants
{
        ...
        throws ReportException, IOException
    {
        ...
        mapProvider.writeStyle(pw, reqState); // [2.6.6-B48c]
        ...
        if (EventUtil.IsXMLMapDataFormat(mdf)) {
            ...
            if (gp == null) {
                ...
                for (DBDataIterator dbi = report.getBodyDataIterator(); dbi.hasNext();) { // XML
            ...
            if (gp == null) {
                int evNdx = 0;
                boolean nonEdpWarn = false;
                for (DBDataIterator dbi = report.getBodyDataIterator(); dbi.hasNext();) { // JSON
                    Object ev = dbi.next().getRowObject();
                    if (ev instanceof EventDataProvider) {
                        EventDataProvider edp = (EventDataProvider)ev;
                        edp.setEventIndex(evNdx++);
        ...
        throws ReportException, IOException
    {
        ...
        for (DBDataIterator dbi = report.getBodyDataIterator(); dbi.hasNext();) { // KML
        ...
        throws IOException
    {
        ...
        //Print.logInfo("ReportID: " + reportID);
