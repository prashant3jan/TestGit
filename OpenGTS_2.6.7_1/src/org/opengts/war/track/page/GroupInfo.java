    ...
    implements Constants
{
    ...
    private String _queueDeviceGroupProperties(DeviceGroup selGroup, User userAuth, HttpServletRequest request, I18N i18n)
    {
        ...
        try {
            devList = selGroup.getDevices(DBReadWriteMode.READ_WRITE, userAuth, true/*inclInactv*/);
        ...
        throws IOException
    {
        ...
        /* argument group-id */
        java.util.List<String> groupList = reqState.getDeviceGroupIDList(DBReadWriteMode.READ_WRITE, true); // non-null, length > 0
        ...
        if (deleteGroup) {
            ...
            try {
                ...
                groupList = reqState.getDeviceGroupIDList(DBReadWriteMode.READ_WRITE, true); // non-null, length > 0
        ...
        if (newGroup) {
            ...
            if (createGroupOK) {
                try {
                    ...
                    reqState.clearDeviceGroupList();
                    groupList = reqState.getDeviceGroupIDList(DBReadWriteMode.READ_WRITE, true);
                    selGroup = group;
        ...
        /* Content */
        final java.util.List<String> _groupList = groupList;
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    out.write("<span class='"+CommonServlet.CSS_ADMIN_SELECT_TITLE+"'>"+i18n.getString("GroupInfo.selectGroup","Select a {0}",grpTitles)+":</span>\n");
                ...
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    IDDescription.SortBy sortBy = IDDescription.GetSortBy(_sortByStr);
                    {
                        ...
                        try {
                            OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(DBReadWriteMode.READ_WRITE, currAcct.getAccountID(), _selGroupID, null/*User*/, true/*inclInactv*/);
