...
//     -Added support for PROP_ReportLayout_defaultBestLatLon [2.6.6-B09]
// ----------------------------------------------------------------------------
...
public abstract class ReportLayout
{
    ...
    **/
    ...
    // ------------------------------------------------------------------------
    // Default to "Best" latitude/longitude

    public static boolean GetDefaultBestLatLon(ReportData rd)
    {
        if (rd != null) {
            PrivateLabel pl = rd.getPrivateLabel(); // not null
            return pl.getBooleanProperty(BasicPrivateLabel.PROP_ReportLayout_defaultBestLatLon,false);
        } else {
            return false;
        }
    }
    ...
    **/
        ...
        throws ReportException
    {
        ...
        if (rp != null) {
            return rp.writeReport(format, rd, out, indentLevel); // ReportPresentation
        } else {
            return 0;
        }
    }
