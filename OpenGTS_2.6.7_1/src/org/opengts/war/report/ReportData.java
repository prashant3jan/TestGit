...
public abstract class ReportData
{
    ...
    **/
    ...
    {
        // -- Note: after this list has been populated, some reports (subclasses) may  
        // -  remove Devices from this list to fit the requirements of the report: 
        // -  ie. StateMileageReport
    ...
    **/
    public int writeReport(String format, OutputProvider out)
        throws ReportException
    {
        return this.writeReport(format, out, 0);
    }
