...
//  2017/07/13  GTS Development Team
...
//     -Added support for DATA_HDOP [2.6.6-B40a]
// ----------------------------------------------------------------------------
    ...
    extends ReportLayout
{
    ...
    public static final String  DATA_HDOP                   = "hdop";
    ...
    public static final String  DATA_GPS_SPEED              = "gpsSpeed";
  ...
  //public static final String  DATA_APPLIED_PRESSURE       = "appliedPressure";
    ...
    public static final String  DATA_HUMIDITY               = "humidity";
    ...
    public static final String  DATA_CREATE_AGE             = "createAge";              // receive delay
    ...
    **/
    ...
    /* format temperature column label */
    protected static String formatTemperatureLabel(int ndx, ReportData rd)
    { // see DATA_THERMO_#
        if (rd.getDeviceCount() == 1) {
            // -- check Device for custom temperature label
            Device dev = rd.getFirstDevice();
            if (dev != null) {
                String label = dev.getThermalProfileLabel(ndx, null);
                if (!StringTools.isBlank(label)) {
                    int p = StringTools.lastIndexOf(label,' ','_','-');
                    return (p > 0)? (label.substring(0,p)+"\n"+label.substring(p+1)) : label;
                }
            }
        }
        I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
        ...
        public EventDataRow() {
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_DRIVER_STATUS) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    ...
                    EventData ed = (EventData)obj;
                    int  drvStat = ed.getDriverStatus();
            ...
            */
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_LATITUDE) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    ...
                    EventData ed = (EventData)obj;
                    Locale locale = rd.getLocale();
                    boolean bestLatLon = !ed.isValidGeoPoint() && ReportLayout.GetDefaultBestLatLon(rd);
                    double lat = bestLatLon? ed.getBestLatitude() : ed.getLatitude(); // "best"?
                    arg = StringTools.trim(arg);
                    String valStr = "";
                    Account.LatLonFormat latlonFmt = Account.getLatLonFormat(rd.getAccount());
                    if (arg.equalsIgnoreCase(GeoPoint.SFORMAT_DMS) || (StringTools.isBlank(arg) && latlonFmt.isDegMinSec())) {
                    ...
                    long gpsAge = bestLatLon? 0L : ed.getGpsAge();
                    //if (gpsAge >= GPS_AGE_THRESHOLD_1) {
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_LONGITUDE) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    ...
                    Locale locale = rd.getLocale();
                    boolean bestLatLon = !ed.isValidGeoPoint() && ReportLayout.GetDefaultBestLatLon(rd);
                    double lon = bestLatLon? ed.getBestLongitude() : ed.getLongitude(); // "best"?
                    arg = StringTools.trim(arg);
                    String valStr = "";
                    Account.LatLonFormat latlonFmt = Account.getLatLonFormat(rd.getAccount());
                    if (arg.equalsIgnoreCase(GeoPoint.SFORMAT_DMS) || (StringTools.isBlank(arg) && latlonFmt.isDegMinSec())) {
            ...
            // -- HDOP
            this.addColumnTemplate(new DataColumnTemplate(DATA_HDOP) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    Locale locale = rd.getLocale();
                    if (ed.hasHDOP()) {
                        ...
                        return EventDataLayout.formatDouble(hdop, arg, "0.0");
                    }
                    return rc.getBlankFiller();
                }
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    return i18n.getString("EventDataLayout.hdop","HDOP");
                }
            });
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_ACCURACY) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    ...
                    if (ed.hasHorzAccuracy()) {
                        ...
                        double horzAcc = ed.getHorzAccuracy(true); // estimate from HDOP
                        if (horzAcc > 0.0) {
                            Account.AltitudeUnits altUnits = Account.getAltitudeUnits(rd.getAccount());
                            double horzAccU = altUnits.convertFromMeters(horzAcc);
                            return "*" + EventDataLayout.formatDouble(horzAccU, arg, "0");
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_GPS_SPEED) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    double kph = ed.getGpsSpeedKPH(); // KPH
                    if (kph > 0.0) {
                        Account a = rd.getAccount();
                        double speed = Account.getSpeedUnits(a).convertFromKPH(kph);
                        return EventDataLayout.formatDouble(speed, arg, "0");
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    return i18n.getString("EventDataLayout.gpsSpeed","GPS Speed") + "\n${speedUnits}";
                }
            });
            ...
            */
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_HUMIDITY) {
                // -- Humidity %
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String   arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    double   hum = ed.getHumidity(); // %
                    if (hum <= 0.0) {
                        // -- not specified
                        return rc.getBlankFiller();
                    } else {
                        // -- percent 0..1
                        return Math.round(hum*100.0) + "%";           // percent
                    }
                }
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    return i18n.getString("EventDataLayout.humidity","Humidity"); // + "\n%";
                }
            });
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_1) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(0, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_2) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(1, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_3) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(2, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_4) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(3, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_5) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(4, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_6) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(5, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_7) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(6, rd);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_THERMO_8) {
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    return EventDataLayout.formatTemperatureLabel(7, rd);
                }
            });
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_FAULT_CODES) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    ...
                    if (DTOBDFault.IsJ1708(faultRTP)) {
                        // -- J1708/J1587
                        return DTOBDFault.GetFaultString(faultRTP, false/*firstOnly?*/);
                    } else
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_FAULT_CODE) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    Locale locale  = rd.getLocale();
                    String arg     = StringTools.trim(rc.getArg());
                    EventData ed   = (EventData)obj; // non-null
                    Device dev     = ed.getDevice(); // likely non-null
                    String vehMake = (dev != null)? dev.getVehicleMake() : null;
                    RTProperties faultRTP = ed.getFaultCodeRTProperties(); 
                    ...
                    if (DTOBDFault.IsJ1708(faultRTP)) {
                        ...
                        if (arg.equalsIgnoreCase("link")) {
                            long fault = DTOBDFault.EncodeFault(faultRTP);
                            ColumnValue cv = new ColumnValue(DTOBDFault.GetFaultString(faultRTP,true/*firstOnly*/));
                            RequestProperties reqState = rd.getRequestProperties();
                        ...
                        if (arg.equalsIgnoreCase("desc")) {
                            return DTOBDFault.GetFaultDescription(faultRTP, vehMake, locale, firstOnly, fmt);
                        } else {
                            return DTOBDFault.GetFaultString(faultRTP, firstOnly);
                        }
                    } else
                    if (DTOBDFault.IsJ1939(faultRTP)) {
                        // -- J1939
