...
//     -Renamed KEY_DEVICE_VIN to KEY_DEVICE_VID
// ----------------------------------------------------------------------------
    ...
    implements CSSRowClass
{
    ...
    public static final String KEY_DEVICE_VID   = "$deviceVID";
    ...
    **/
    ...
    {
        Object devVIN = this.getValue(KEY_DEVICE_VID,null); // this.fieldValues.get(KEY_DEVICE_VID);
        if (devVIN != null) {
            return (String)devVIN;
        } else {
            Device dev = this.getDevice(null);
            if (dev != null) {
                String vin = dev.getDeviceVID();
                this.setValue(KEY_DEVICE_VID, vin);
                return vin;
            } else {
                // -- default to returning the device ID (if defined)
                return this.getString(FieldLayout.DATA_DEVICE_ID, "");
        ...
        implements Comparator<FieldData>
    {
        ...
        public int compare(FieldData o1, FieldData o2) {
            ...
            double remainKM_1 = (D1 != null)? D1.getMaintRemainingKM(this.maintNdx) : -1.0;
            double remainKM_2 = (D2 != null)? D2.getMaintRemainingKM(this.maintNdx) : -1.0;
        ...
        implements Comparator<FieldData>
    {
        ...
        public int compare(FieldData o1, FieldData o2) {
            ...
            Device D1 = o1.getDevice();
            Device D2 = o2.getDevice();
            double remainKM_1 = (D1 != null)? D1.getMaintRemainingHR(this.maintNdx) : -1.0;
            double remainKM_2 = (D2 != null)? D2.getMaintRemainingHR(this.maintNdx) : -1.0;
            if (remainKM_1 == remainKM_2) {
                return 0;
            } else
            if (remainKM_1 < 0.0) {
    ...
    /**
    *** Custom FieldEventDataProvider(Adapter) class
    **/
    public static class FieldEventDataProvider/*Adapter*/
        extends FieldData
