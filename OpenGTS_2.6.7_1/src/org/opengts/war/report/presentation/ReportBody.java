...
public class ReportBody
{
        ...
        throws ReportException
    {
        ...
        /* report body */
        DBDataIterator data = (report != null)? report.getBodyDataIterator() : null; // HTML
        ...
        /* report totals */
        DBDataIterator totals = (report != null)? report.getTotalsDataIterator() : null; // HTML
        ...
        throws ReportException
    {
        ...
        /* report body */
        DBDataIterator data = (report != null)? report.getBodyDataIterator() : null; // XML
        if ((data != null) && data.hasNext()) {
            int RC = 0;
            for (RC = 0; data.hasNext(); RC++) {
                DBDataRow dr = data.next();
        ...
        throws ReportException
    {
        ...
        /* report body */
        DBDataIterator data = (report != null)? report.getBodyDataIterator() : null; // CSV
        if ((data != null) && data.hasNext()) {
            int RC = 0;
            for (RC = 0; data.hasNext(); RC++) {
                DBDataRow dr = data.next();
        ...
        throws ReportException
    {
        ...
        /* report body */
        DBDataIterator data = (report != null)? report.getBodyDataIterator() : null; // XLS
        if ((data != null) && data.hasNext()) {
            int RC = 0;
            for (RC = 0; data.hasNext(); RC++) {
                DBDataRow dr = data.next();
    ...
    **/
        ...
        throws ReportException
    {
        ...
        /* report body */
        DBDataIterator data = (rd != null)? rd.getBodyDataIterator() : null; // Callback
        if ((data != null) && data.hasNext()) {
