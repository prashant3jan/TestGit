                ...
                if (DeviceCmd_SMS_class != null) {
                    ...
                    for (DCServerConfig dcs : dcServerList) { // for (String _dchn : optDevCmdHandlerClasses) 
                        ...
                        if (dchClass != null) {
                            ...
                            Print.logDebug("DeviceCommand Page class not found: " + dchClassName);
                            continue;
        ...
        try {
            ...
            if (Device.supportsMaintenance()) {
                ...
                if (maintOdomOK && Device.supportsMaintenance_KM()) { // Domain.Properties.deviceInfo.showMaintenanceOdometer=false
                    ...
                    selDev.setMaintIntervalKM(0,intrvKM0);
                    if (mResetKM0) {
                        selDev.setMaintOdometerKM(0,selDev.getLastOdometerKM());
                    }
                    ...
                    selDev.setMaintIntervalKM(1,intrvKM1);
                    if (mResetKM1) {
                        selDev.setMaintOdometerKM(1,selDev.getLastOdometerKM());
                    }
                }
                ...
                if (maintHoursOK && Device.supportsMaintenance_HR()) { // Domain.Properties.deviceInfo.showMaintenanceHours=false
                    ...
                    selDev.setMaintIntervalHR(0,intrvHR0);
                    if (mResetHR0) {
                        double lastEngHrs = selDev.getLastEngineHours();
                        selDev.setMaintEngHoursHR(0,lastEngHrs);
                    }
                }
                // -- maintenance notes
        ...
        throws IOException
    {
      ...
      //boolean refreshList  = deviceCmd.equals(COMMAND_INFO_REFRESH);
        ...
        if (_uiList) {
            ...
            Print.logInfo("DeviceModel: list ...");
        ...
        if (_uiEdit || _uiView) {
            ...
            Print.logInfo("DeviceModel: edit/view ...");
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                    ...
                    boolean lastPtoHrsOK  = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showReportedPtoHours,SHOW_REPORTED_PTO_HRS);
                    boolean maintOdomOK   = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showMaintenanceOdometer,SHOW_MAINTENANCE_ODOM);
                    boolean maintOdomEdit = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_editMaintenanceOdometer,SHOW_MAINTENANCE_ODOM);
                    boolean maintHoursOK  = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showMaintenanceHours,SHOW_MAINTENANCE_HOURS);
                    boolean maintNotesOK  = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showMaintenanceNotes,SHOW_MAINTENANCE_NOTES);
                    boolean reminderOK    = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showReminderMessage,SHOW_REMINDER_MESSAGE);
                    boolean servTimeOK    = privLabel.getBooleanProperty(PrivateLabel.PROP_DeviceInfo_showServiceTime,SHOW_SERVICE_TIME);
                    ...
                    if (lastEngHrsOK && Device.supportsLastEngineHours()) {
                      ...
                      //String lastHrT  = i18n.getString("DeviceModel.lastEngineHours","Last Engine Hours");
                        ...
                        out.println(FormRow_TextField(PARM_ENGINE_HOURS, _uiEdit, i18n.getString("DeviceModel.reportEngineHours","Reported Engine Hours") +":" , hourStr, 10, 11, hour_ofs));
                    }
                    if (lastPtoHrsOK && Device.supportsLastPtoHours()) {
                      ...
                      //String lastHrT  = i18n.getString("DeviceModel.lastPtoHours","Last PTO Hours");
                        String ofsStr   = StringTools.format(offsetHr,"0.00");
                        String ofsText  = i18n.getString("DeviceModel.offset","Offset");
                        String hour_ofs = i18n.getString("DeviceModel.hours","Hours");
                        hour_ofs += " [" + ofsText + " " + ofsStr + "]";
                        out.println(FormRow_TextField(PARM_PTO_HOURS, _uiEdit, i18n.getString("DeviceModel.reportPtoHours","Reported PTO Hours") +":" , hourStr, 10, 11, hour_ofs));
                    }
                    if (Device.supportsMaintenance()) {
                        double offsetKM = (_selDev != null)? _selDev.getOdometerOffsetKM() : 0.0;
                        double offsetHR = (_selDev != null)? _selDev.getEngineHoursOffset() : 0.0;
        ...
        if (_uiCmd) {
            ...
            Print.logInfo("DeviceModel: command ...");
