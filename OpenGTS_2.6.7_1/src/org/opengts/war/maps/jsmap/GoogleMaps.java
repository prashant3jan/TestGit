    ...
    extends JSMap
{
    ...
    private static final String  PROP_addRoadMap[]            = { "google.addRoadMap"           , "addRoadMap"           }; // V3 only
    private static final String  PROP_addHybridMap[]          = { "google.addHybridMap"         , "addHybridMap"         }; // V3 only
    private static final String  PROP_addTerrainMap[]         = { "google.addTerrainMap"        , "addTerrainMap"        }; // V3 only
    private static final String  PROP_addSatelliteMap[]       = { "google.addSatelliteMap"      , "addSatelliteMap"      }; // V3 only
    ...
    **/
        ...
        throws IOException
    {
        ...
        JavaScriptTools.writeJSVar(out, "GOOGLE_ROADMAP"          , rtp.getBoolean(PROP_addRoadMap,true));
        JavaScriptTools.writeJSVar(out, "GOOGLE_HYBRID"           , rtp.getBoolean(PROP_addHybridMap,true));
        JavaScriptTools.writeJSVar(out, "GOOGLE_TERRAIN"          , rtp.getBoolean(PROP_addTerrainMap,false));
        JavaScriptTools.writeJSVar(out, "GOOGLE_SATELLITE"        , rtp.getBoolean(PROP_addSatelliteMap,false));
        // -- Microsoft Bing maps
    ...
    **/
        ...
        throws IOException 
    {
        ...
        /* map url */
        String mapCtlURL = this.getMapURL(reqState);
