    ...
    extends BasicPrivateLabel
{
    ...
    **/
    protected String _getDefaultWebPageJSP(RequestProperties reqState)
    {
        ...
        if (jsp.startsWith("/")) {
            ...
            //Print.logInfo("Returning absolute file path: " + jsp);
            return jsp;
        } else
        if (!ListTools.isEmpty(this.jspMap)) {
            ...
            if (!StringTools.isBlank(jf)) {
                //Print.logInfo("Returning absolute file path: "+jsp+" ==> "+jf);
                return jf;
            } else {
                // -- return null
            ...
            // -- return as-is
            //Print.logInfo("Returning as-is: "+jsp);
            return jsp;
        }
    }
    ...
    **/
    ...
    private static final String CONTEXT_FILE_OFFLINE = ".offline";
    ...
    *** Any global offline setting will not be effected.
    ...
    **/
    public String getWebPageAclName(String pageName)
    {
        ...
        return (wp != null)? wp.getAclName() : null;
    }
    ...
    **/
    public JSPEntry getJSPEntry(String jspName)
    {
        ...
        if ((map != null) && !StringTools.isBlank(jspName)) {
            ...
            String jspPropKey = LAF_JSPEntry_ + jspName; // LAF_JSPEntry_Default = "JSPEntry.default"
