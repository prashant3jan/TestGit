...
public class JavaScriptTools
{
    ...
    /**
    *** Returns the JavaScript directory
    **/
    public static String getJSDirectory()
    {
        return RTConfig.getString(DBConfig.PROP_track_js_directory, "./js");
    }

    /**
    *** Returns a reference to the specified JS file relative to the current context
    **/
    public static String qualifyJSFileRef(String jsFileRef)
    {
        ...
        if (jsFileRef.startsWith("/") || jsFileRef.startsWith(".")) {
            ...
            return JavaScriptTools.getJSDirectory() + "/" + jsFileRef;
        }
    }
