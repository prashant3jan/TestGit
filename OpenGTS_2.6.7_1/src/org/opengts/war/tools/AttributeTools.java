...
public class AttributeTools
{
    ...
    private static final String     SessionSequenceKey      = "_seqID";
    ...
    *** Creates a new HttpSession, if one does not already exist.
    *** @param req The ServletRequest
    *** @return The HttpSession extracted from the specified ServletRequest,
    ***         or null if 'req' is not an instance of HttpServletRequest, 
    ...
    public static HttpSession getSession(ServletRequest req)
    {
        ...
        try {
            return (req instanceof HttpServletRequest)?
                ((HttpServletRequest)req).getSession(create) :
                null;
        } catch (IllegalStateException ise) {
            Print.logException("'HttpServletRequest.getSession("+create+")' Error", ise);
            return null;
        }
    }
    ...
    public static void clearSessionAttributes(HttpSession sess)
    {
        if (sess != null) {
            try {
                ...
                // -- if already invalidated/expired
            }
        }
    }
    ...
    **/
    ...
    /**
    *** Gets the set of Session attributes as a JSON object
    **/
    public static JSON._Object getSessionAttributes_JSON(ServletRequest req)
    {
        return getSessionAttributes_JSON(getSession(req));
    }

    /**
    *** Gets the set of Session attributes as a JSON object
    **/
    public static JSON._Object getSessionAttributes_JSON(HttpSession sess)
    {
        ...
        JSON._Object jAttr = new JSON._Object();
        for (Enumeration<String> n = sess.getAttributeNames(); n.hasMoreElements();) {
            String key = n.nextElement();
            Object val = sess.getAttribute(key);
            if (val instanceof DBRecord) {
                // -- table objects are simply returned as a class name
                jAttr.addKeyValue(key, StringTools.className(val));
            } else {
                // -- JSON should convert to the proper type
                jAttr.addKeyValue(key, val);
            }
        }
    ...
    /**
    *** Gets the set of Session attributes as a RTProperties instance
    **/
    public static RTProperties getSessionAttributes_RTP(ServletRequest req)
    {
        return getSessionAttributes_RTP(getSession(req));
    }

    /**
    *** Gets the set of Session attributes as a RTProperties instance
    **/
    public static RTProperties getSessionAttributes_RTP(HttpSession sess)
    {
        ...
        /* list of session attribute names */
        RTProperties rAttr = new RTProperties();
        for (Enumeration<String> n = sess.getAttributeNames(); n.hasMoreElements();) {
            String key = n.nextElement();
            Object val = sess.getAttribute(key);
            rAttr.setProperty(key, val);
        }
    ...
    /** 
    *** Returns true if the HttpServletRequest contains the specified Cookie name
    *** @return True if the specified Cookie name is found
    **/
    public static boolean hasCookie(HttpServletRequest request, String cookieName)
    {
        return (AttributeTools.getCookie(request,cookieName) != null)? true : false;
    }

    /** 
    *** Gets a specific Cookie from the HttpServletRequest
    *** @return The named Cookie, or null is not found
    **/
    public static Cookie getCookie(HttpServletRequest request, String cookieName)
    {
        ...
        /* invalid Cookie name specified? */
        if (StringTools.isBlank(cookieName)) {
            return null;
        }

        /* get Cookies */
        Cookie cookies[] = request.getCookies();
        if (ListTools.isEmpty(cookies)) {
            // -- no Cookies
            return null;
        }
    ...
    **/
    public static String getCookieValue(HttpServletRequest request, String cookieName)
    {
        ...
        /* get Cookie */
        Cookie cookie = AttributeTools.getCookie(request, cookieName);
    ...
    /**
    *** Removes a Cookie to the Response
    **/
    public static boolean removeCookie(HttpServletResponse response, String cookieName)
    {

        /* remove Cookie */
        return AttributeTools.addCookie(response,cookieName,0,"");
    ...
    **/
    public static void removeAllCookies(HttpServletRequest request, HttpServletResponse response)
    {
        if ((request != null) && (response != null)) {
            ...
            if (!ListTools.isEmpty(cookies)) {
                for (Cookie c : cookies) {
                    AttributeTools.removeCookie(response, c.getName());
                }
            }
        }
    }
    ...
    **/
    public static boolean addCookie(HttpServletResponse response, String cookieName, int maxAge, String value)
    {
