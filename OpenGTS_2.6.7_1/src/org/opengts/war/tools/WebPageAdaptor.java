    ...
    implements WebPage
{
    ...
    public  static final String  FILTER_JS                              = ReportPresentation.FILTER_JS;

    private static final boolean COMBOBOX_SHOW_DISABLED_IF_NOT_ENABLED  = true;

    private static final String  DEFAULT_MAT_ICON                       = "map";
    ...
    **/
    ...
    protected static String JS_alert(boolean inclJS, String msg)
    {
        if (!StringTools.isBlank(msg)) {
            ...
            String m = msg;
            m = StringTools.replace(m, "mailto:"          , ""   ); // remove "mailto:"
            m = StringTools.replace(m, "\""               , "'"  ); // filter out quotes
    ...
    private String          iconImageURI2       = null;

    private String          matIcon             = null;
    ...
    **/
    ...
    {
        //if (!this.jspURI.startsWith("$")) Print.logStackTrace("**** Getting JSP/FTL: " + this.jspURI);
        return this.jspURI;
    }

    public void setJspURI(String jspURI)
    {
        //Print.logInfo("Setting JSP URI ["+this.getPageName()+"]: " + jspURI);
        this.jspURI = jspURI;
        //if (!this.jspURI.startsWith("$")) Print.logStackTrace("**** Setting JSP/FTL: " + this.jspURI);
    }
    ...
    public String getMenuIconImage2()
    {
        return this.iconImageURI2;
    }
    
    public void setMenuIconImage2(String iconURI)
    {
        if (StringTools.isBlank(iconURI) || iconURI.startsWith("!")) {
            this.iconImageURI2 = null;
        } else {
            this.iconImageURI2 = iconURI;
        }
    }
    ...
    {
        if (StringTools.isBlank(matIcon))
        {
            this.matIcon = DEFAULT_MAT_ICON;
        }
        else
        {
