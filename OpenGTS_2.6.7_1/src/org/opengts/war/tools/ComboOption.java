...
public class ComboOption
{
    ...
    public static boolean isText_YES(Locale locale, String state)
    {
        ...
        // -- strict check only
        return StringTools.isBoolean_TRUE(state,true/*strict*/)? true : false;

    }

    public static boolean isText_NO(Locale locale, String state)
    {
        ...
        // -- strict check only
        return StringTools.isBoolean_FALSE(state,true/*strict*/)? true : false;
    ...
    public static boolean parseYesNoText(Locale locale, String state, boolean dft)
    {
        ...
        if (ComboOption.isText_NO(locale,state)) {
            return false;
        } else
        if (ComboOption.isText_YES(locale,state)) {
            return true;
        }
