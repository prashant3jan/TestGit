...
public interface MapProvider
{
    ...
    public static final String  PROP_map_pushpins[]             = new String[] { "map.showPushpins"       , "map.pushpins"           };  // boolean (iff false, only show last pushpin)
    public static final String  PROP_map_balloons[]             = new String[] { "map.showBalloons"       , "map.balloons"           };  // boolean (iff false, only show last info-balloon)
