...
//     -Added back support for "EventNotificationEMail" (for legacy purposes) [2.6.7-B15f] 
// ----------------------------------------------------------------------------
    ...
    implements RTConfig.PropertySetter
{
    ...
    public  static final String LAF_Login_Default_Account                   = "LoginDefaultAccountID";      // Default Account ID on login
    public  static final String LAF_Login_With_Account                      = "LoginWithAccountD";          // Show Account ID login
    public  static final String LAF_Login_With_User                         = "LoginWithUserID";            // Show User ID login
    public  static final String LAF_Login_With_EMail                        = "LoginWithEMailAddress";      // Show EMail Address ID login
    public  static final String LAF_Login_RememberMe_Enable                 = "LoginRememberMeEnable";      // RememberMe: Enabled [PROP_RememberMe_enable]
    public  static final String LAF_Login_RememberMe_MaxAge                 = "LoginRememberMeMaxAge";      // RememberMe: MaxAgeSec [PROP_RememberMe_maximumAgeSec]
    ...
    public  static final String LAF_Map_Auto_Enable                         = "Map.auto.enable";            // map auto-update enable
    public  static final String LAF_Map_Auto_Interval                       = "Map.auto.interval";          // map auto-update interval
    public  static final String LAF_Map_Auto_Count                          = "Map.auto.count";             // map auto-update count
    public  static final String LAF_Map_Auto_OnLoad                         = "Map.auto.onLoad";            // map auto-update start on-load
    public  static final String LAF_Map_Auto_RecenterMode                   = "Map.auto.recenterMode";      // map auto-update zoom/recenter mode (PROP_TrackMap_autoUpdateRecenter)
    ...
    /* RememberMe(Track) */
    public  static final String PROP_RememberMe_enable                      = "rememberMe.enable";              // boolean
    public  static final String PROP_RememberMe_maximumAgeSec               = "rememberMe.maximumAgeSec";       // int
  ...
  //public  static final String PROP_AccountLogin_legacyLAF                 = "accountLogin.legacyLAF";
    ...
    public  static final String PROP_AccountLogin_showRememberMe            = "accountLogin.showRememberMe"; // RememberMe
    ...
    /* AdminPage properties (DeviceInfo, GroupInfo, UserInfo, ZoneInfo, RoleInfo, etc) */
    public  static final String PROP_AdminPage_showSearchFilter             = "adminPage.showSearchFilter";         // true|false
  ...
  //public  static final String PROP_DeviceInfo_showWorkOrderField          = "deviceInfo.showWorkOrderField";      // true|false
    ...
    public  static final String PROP_DeviceInfo_showReportedPtoHours        = "deviceInfo.showReportedPtoHours";    // true|false
    public  static final String PROP_DeviceInfo_showMaintenanceOdometer     = "deviceInfo.showMaintenanceOdometer"; // true|false
    public  static final String PROP_DeviceInfo_editMaintenanceOdometer     = "deviceInfo.editMaintenanceOdometer"; // true|false
    public  static final String PROP_DeviceInfo_showMaintenanceHours        = "deviceInfo.showMaintenanceHours";    // true|false
    public  static final String PROP_DeviceInfo_showMaintenanceFixedTime    = "deviceInfo.showMaintenanceFixedTime";// true|false
    ...
    // -- misc properties
    public  static final String PROP_TrackMap_routeSegmentColorSelector     = "trackMap.routeSegmentColorSelector"; // <RuleSelector> (RouteSegmentColor)
    ...
    public  static final String PROP_ReportLayout_defaultBestLatLon         = "reportLayout.defaultBestLatLon";     // true|false
  ...
  //public  static final String PROP_RuleInfo_showEMailWrapper              = "ruleInfo.showEMailWrapper";          // true|false
    ...
    public  static final String PROP_RuleInfo_showTriggerActionMQ           = "ruleInfo.showTriggerActionMQ";        // false|true|email
    public  static final String PROP_RuleInfo_showPredefinedActions         = "ruleInfo.showPredefinedActions";
    public  static final String PROP_RuleInfo_showSysadminNotifyEmail       = "ruleInfo.showSysadminNotifyEmail";
    ...
    public  static final String PROP_SysAdminAccounts_showLoginMessage      = "sysAdminAccounts.showLoginMessage";      // true|false (GTSE only)
    public  static final String PROP_SysAdminAccounts_showInactiveMessage   = "sysAdminAccounts.showInactiveMessage";   // true|false (GTSE only)
    ...
    public  static final String PROP_SysAdminAccounts_showBillingReportLink = "sysAdminAccounts.showBillingReportLink"; // true|false
    public  static final String PROP_SysAdminAccounts_showDeviceCounts      = "sysAdminAccounts.showDeviceCounts";      // true|false
    public  static final String PROP_SysAdminAccounts_allowEditBCross       = "sysAdminAccounts.allowEditBCross";       // true|false
  ...
  //public  static final String PROP_SysAdminAccounts_enableAutoLoginReturn = "sysAdminAccounts.enableAutoLoginReturn"; // String
    ...
    public  static final String PROP_SysAccountsLogin_enableLogin           = "sysAccountsLogin.enableLogin";           // true|false|sysadmin
    ...
    /* Account ForcedLogout properties */
    public  static final String PROP_SysAccountsLogout_enableForcedLogout   = "sysAccountsLogout.enableForcedLogout";   // true|false|sysadmin
  ...
  //private Map<String,String>          hostAliasMap            = null;
    ...
    private String                      defaultLoginAccount     = null;  // NO LONGER SUPPORTED
    ...
    **/
    public void setDomainName(String name)
    {
        if (StringTools.isBlank(name)) {
            ...
            //this.setProperty(RTKey.SESSION_NAME, this.domainName); <-- must be current session only
    ...
    **/
    public void setShowAccountLogin(boolean acctLogin)
    {
    ...
    **/
    public boolean getShowAccountLogin()
    {
        String loginShow = this.getStringProperty(BasicPrivateLabel.LAF_Login_With_Account, null);
      //String loginShow = RTConfig.getThreadString(BasicPrivateLabel.LAF_Login_With_Account,null);
        if (!StringTools.isBlank(loginShow)) {
            return StringTools.parseBoolean(loginShow, this.acctLogin);
        } else {
    ...
    **/
    public void setShowUserLogin(boolean userLogin)
    {
    ...
    **/
    public boolean getShowUserLogin()
    {
        String loginShow = this.getStringProperty(BasicPrivateLabel.LAF_Login_With_User, null);
      //String loginShow = RTConfig.getThreadString(BasicPrivateLabel.LAF_Login_With_User,null);
        if (!StringTools.isBlank(loginShow)) {
            return StringTools.parseBoolean(loginShow, this.userLogin);
        } else {
    ...
    **/
    public void setShowEmailLogin(boolean emailLogin)
    {
    ...
    **/
    public boolean getShowEmailLogin()
    {
        String loginShow = this.getStringProperty(BasicPrivateLabel.LAF_Login_With_EMail, null);
      //String loginShow = RTConfig.getThreadString(BasicPrivateLabel.LAF_Login_With_EMail,null);
        if (!StringTools.isBlank(loginShow)) {
            return StringTools.parseBoolean(loginShow, this.allowEmailLogin);
        } else {
    ...
    **/
    ...
    {
        String dftAcctID = this.getStringProperty(BasicPrivateLabel.LAF_Login_Default_Account, null);
      //String dftAcctID = RTConfig.getThreadString(BasicPrivateLabel.LAF_Login_Default_Account,null);
    ...
    **/
    ...
    /**
    *** Gets all ACL entries that start with the specified key.
    *** Does not return null.
    **/
    public Collection<String> getSubAclEntryNames(String startsWith)
    {
        Vector<String> list = new Vector<String>();
        for (Iterator<AclEntry> i = this.privateAclMap.values().iterator(); i.hasNext();) {
            AclEntry acl = i.next();
            String aclName = acl.getName();
            if (aclName.startsWith(startsWith)) {
                list.add(aclName);
            }
        }
    ...
    /**
    *** Gets the AclEntry name for the specified page name
    **/
    public String getWebPageAclName(String pageName)
    {
        // -- overridden by PrivateLabel
        return null;
    }
    ...
    **/
    ...
    /**
    *** Returns the AccessLevel for specified User and ACL key
    *** @param user     The User
    *** @param aclName  The ACL key
    *** @return The AccessLevel for specified User and ACL key
    **/
    ...
    **/
    ...
    {
        this.eventNotifyFrom    = emailFrom;   // this.getSmtpProperties().getUserEmail(emailFrom);
    ...
    **/
    public String getPlatinumLogoURL(String acctID, String dftURL)
    {
        ...
        for (;;) { // single-pass loop
            ...
            urlStr = RTConfig.getString(BasicPrivateLabel.LAF_Banner_ImageSource, null);
    ...
    **/
    ...
    /**
    *** Gets the Object property value for the specified key
    *** @param key  The property key
    *** @param dft  The default value returned if the property key is not defined
    *** @return The property Object value
    **/
    public Object getObjectProperty(String key, Object dft)
    {

        /* try temporary properties */
        Object v = RTConfig.getThreadProperty(key, null);
        if (v != null) {
            return v;
        }
    ...
    **/
    public Object getObjectProperty(String key[], Object dft)
    {
        if (key != null) {
            for (String k : key) {
                Object val = this.getObjectProperty(k, null);
                if (val != null) {
                    return val;
                }
            }
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
        if (val instanceof I18N.Text) {
            return ((I18N.Text)val).toString(this.getLocale());
        } else
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
        return (val != null)? StringTools.parseDouble(val,dft) : dft;
    }
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
        return (val != null)? StringTools.parseLong(val,dft) : dft;
    }
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
        return (val != null)? StringTools.parseInt(val,dft) : dft;
    }
    ...
    **/
    ...
    {
        Object val = this.getObjectProperty(key, null);
        return (val != null)? StringTools.parseBoolean(val.toString(),dft) : dft;
    }
    ...
    **/
    ...
    /**
    *** Returns true if SystemAccountsForcedLogout is enabled
    *** @return True if SystemAccountsForcedLogout is enabled, false otherwise
    **/
    public boolean isSystemAccountsForcedLogoutEnabled(String acctID)
    {

        /* explicitly disabled */
        String enableLogout = this.getStringProperty(BasicPrivateLabel.PROP_SysAccountsLogout_enableForcedLogout,null);
        if (StringTools.isBlank(enableLogout)) {
            // -- blank defaults to false
            return false;
        } else
        if (enableLogout.equalsIgnoreCase(AccountRecord.getSystemAdminAccountID())) {
            if (!AccountRecord.isSystemAdminAccountID(acctID)) {
                // -- not explicitly "sysadmin"
                return false;
            }
        } else
        if (!StringTools.parseBoolean(enableLogout,false)) {
            // -- explicitly disabled
            return false;
        }
