...
//     -Added STATUS_SOUND_TRIGGER, STATUS_SOUND_ON, STATUS_SOUND_OFF [2.6.6-B29]
//     -Added STATUS_TILT [2.6.6-B32a]
//     -Added STATUS_TRANSMISSION_GEAR/STATUS_TRANSMISSION_REVERSE [2.6.6-B58g]
//  2020/02/19  GTS Development Team
//     -Added STATUS_PLOW_*
//     -Added STATUS_LIGHTING_RANGE, STATUS_EXCESS_CO2_ON, STATUS_EXCESS_CO2_OFF
//     -Added STATUS_IOT_SENSOR, STATUS_LICENSE_PLATE_#
// ----------------------------------------------------------------------------
// Possible additions:
...
// Available: 0x1000 to 0xCFFF
    ...
    // ...
    public static final int STATUS_2000                 = 0x2000;   //  8192
    // ...
    public static final int STATUS_3000                 = 0x3000;   // 12288
    // ...
    public static final int STATUS_4000                 = 0x4000;   // 16384
    // ...
    public static final int STATUS_5000                 = 0x5000;   // 20480
    // ...
    public static final int STATUS_6000                 = 0x6000;   // 24576
    // ...
    public static final int STATUS_7000                 = 0x7000;   // 28672
    // ...
    public static final int STATUS_8000                 = 0x8000;   // 32768
    // ...
    public static final int STATUS_9000                 = 0x9000;   // 36864
    // ...
    public static final int STATUS_A000                 = 0xA000;   // 40960
    // ...
    public static final int STATUS_B000                 = 0xB000;   // 45056
    // ...
    public static final int STATUS_C000                 = 0xC000;   // 49152
    // ...
...
// Generic codes: 0xF000 to 0xF0FF
    ...
    public static final int STATUS_REGISTERED           = 0xF00F;   // 61455
    // Description:
    //      Time of first registration of device on the server
...
// (motion related status codes - typically while ignition is on)
    ...
    //      Use by some devices that send a "start-of-idle" event
...
// Miscellaneous
    ...
    public static final int STATUS_PLOW_INIT            = 0xF874;   // 63604
    // Description:
    //      Plowing route started

    public static final int STATUS_PLOW_START           = 0xF875;   // 63605
    // Description:
    //      Plowing route started

    public static final int STATUS_PLOW_STOP            = 0xF876;   // 63606
    // Description:
    //      Plowing route stopped

    public static final int STATUS_PLOW_ABORT           = 0xF877;   // 63607
    // Description:
    //      Plowing route abort

    public static final int STATUS_PLOW_WORK            = 0xF878;   // 63608
    // Description:
    //      Plowing route working

    public static final int STATUS_PLOW_STANDBY         = 0xF87E;   // 63614
    // Description:
    //      Plowing stand-by

    public static final int STATUS_PLOW_ERROR           = 0xF87F;   // 63615
    // Description:
    //      Plowing error
    ...
    public static final int STATUS_LIGHTING_RANGE       = 0xF8A7;   // 63655
    // Description:
...
// ----------------------------------------------------------------------------
    ...
    public static final int STATUS_SOUND_TRIGGER        = 0xF8C4;   // 63684
    // Description:
    //      Sound triggered event

    public static final int STATUS_SOUND_ON             = 0xF8C6;   // 63686
    // Description:
    //      Sound on

    public static final int STATUS_SOUND_OFF            = 0xF8C8;   // 63688
    // Description:
    //      Sound off

    // --------------------------------

    public static final int STATUS_EXCESS_CO2_ON        = 0xF8CA;   // 63690
    // Description:
    //      Excess CO2 on/detected

    public static final int STATUS_EXCESS_CO2_OFF       = 0xF8CB;   // 63691
    // Description:
    //      Sound off
...
// OBC/J1708/CANBUS status: 0xF900 to 0xF9FF
    ...
    // Description:
    //      Freefall detected (accelerometer)

    public static final int STATUS_TILT                 = 0xF949;   // 63817
    // Description:
    //      Above/Below inclinometer
    //      Also "roll over", "off camber"
    ...
    public static final int STATUS_TRANSMISSION_GEAR    = 0xF9B0;   // 63920
    // Description:
    //      Transmission gear changed

    public static final int STATUS_TRANSMISSION_REVERSE = 0xF9B1;   // 63921
    // Description:
    //      Transmission gear in reverse
...
// ----------------------------------------------------------------------------
// IoT/MQTT status [0xFB00 to 0xFB9F]

    public static final int STATUS_IOT_SENSOR           = 0xFB20;   // 64288
  //public static final int STATUS_IOT_WEATHER          = 0xFB30;   // 

// ----------------------------------------------------------------------------
// Tire Pressure/Temperature [0xFBA0 to 0xFBFF]
...
// ----------------------------------------------------------------------------
// Internal device status  [0xFD00 to 0xFD5F]
...
// ----------------------------------------------------------------------------
// General image attachments [0xFD60 to 0xFD9F]
...
// ----------------------------------------------------------------------------
// License/Number-Plate-Recognition [0xFDA0 to 0xFDBF]

    public static final int STATUS_LICENSE_PLATE_0      = 0xFDA0;   // 64928
    public static final int STATUS_LICENSE_PLATE_1      = 0xFDA1;   // 64929
    public static final int STATUS_LICENSE_PLATE_2      = 0xFDA2;   // 64930
    public static final int STATUS_LICENSE_PLATE_3      = 0xFDA3;   // 64931
    // Description:
    //      License/Number Plate Recognition

// ----------------------------------------------------------------------------
// Reserved [0xFDC0 to 0xFDFF]

// ----------------------------------------------------------------------------
// Reserved [0xFE00 to 0xFEFF]

// ----------------------------------------------------------------------------
// General Rule trigger status [0xFF00 to 0xFF1F]
...
// ----------------------------------------------------------------------------
    ...
    **/
    public static boolean IsDiscardable(int code)
    {
        ...
        switch (code) {
            ...
            case STATUS_LAST_LOCATION   : // [2.6.7-B07h]
            case STATUS_CELL_LOCATION   : // [2.6.7-B07h]
            case STATUS_IOT_SENSOR      : // [2.6.7-B34e]
    ...
    **/
    ...
    {
        switch (code) {
            case STATUS_MOTION_OVER_SPEED_1 : // STATUS_MOTION_EXCESS_SPEED
  ...
  //public static final String  CAT_Hazardlights     = "Hazardlights";
    ...
    private static final PairedStatusCodes             pairedStatusCodeList[] = {
      ...
      //new PairedStatusCodes(STATUS_PLOW_START         , STATUS_PLOW_STOP          , CAT_Plowing     , I18N.getString(StatusCodes.class,"StatusCodes.PairedStatusCodes.Plow"        ,"Plow Start/Stop")),
      ...
      //new PairedStatusCodes(STATUS_SOUND_ON           , STATUS_SOUND_OFF          , CAT_Sound       , I18N.getString(StatusCodes.class,"StatusCodes.PairedStatusCodes.Sound"       ,"Sound On/Off")),
      //new PairedStatusCodes(STATUS_EXCESS_CO2_ON      , STATUS_EXCESS_CO2_OFF     , CAT_CO2         , I18N.getString(StatusCodes.class,"StatusCodes.PairedStatusCodes.CO2"         ,"CO2 On/Off")),
    ...
    **/
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_REGISTERED          , "REGISTERED"   , I18N.getString(StatusCodes.class,"StatusCodes.registered"         ,"Registered"       )       ),
      ...
      //new Code(STATUS_STATE_EXIT          , "STA.EXIT"     , I18N.getString(StatusCodes.class,"StatusCodes.stateExit"          ,"State_Exit"       ), true ), // (off) 
        ...
        new Code(STATUS_PLOW_INIT           , "PLOW_INIT"    , I18N.getString(StatusCodes.class,"StatusCodes.plowInit"           ,"Plow_Initialize"  )       ), //
        new Code(STATUS_PLOW_START          , "PLOW_START"   , I18N.getString(StatusCodes.class,"StatusCodes.plowStart"          ,"Plow_Start"       ), true ), // (on ) 
        new Code(STATUS_PLOW_STOP           , "PLOW_STOP"    , I18N.getString(StatusCodes.class,"StatusCodes.plowStop"           ,"Plow_Stop"        ), true ), // (off) 
        new Code(STATUS_PLOW_ABORT          , "PLOW_ABORT"   , I18N.getString(StatusCodes.class,"StatusCodes.plowAbort"          ,"Plow_Abort"       ), true ), // 
        new Code(STATUS_PLOW_WORK           , "PLOW_WORK"    , I18N.getString(StatusCodes.class,"StatusCodes.plowWork"           ,"Plow_Work"        )       ), // 
        new Code(STATUS_PLOW_STANDBY        , "PLOW_STANDBY" , I18N.getString(StatusCodes.class,"StatusCodes.plowStandby"        ,"Plow_Standby"     )       ), // 
        new Code(STATUS_PLOW_ERROR          , "PLOW_ERROR"   , I18N.getString(StatusCodes.class,"StatusCodes.plowError"          ,"Plow_Error"       ), true ), // 
        ...
        new Code(STATUS_LIGHTING_RANGE      , "LIGHT_RANGE"  , I18N.getString(StatusCodes.class,"StatusCodes.lightingRange"      ,"Lighting_Range"   ), true ), // 
        ...
        new Code(STATUS_SOUND_TRIGGER       , "SOUND_TRIGGER", I18N.getString(StatusCodes.class,"StatusCodes.soundTrigger"       ,"Sound"            ), true ),
        new Code(STATUS_SOUND_ON            , "SOUND_ON"     , I18N.getString(StatusCodes.class,"StatusCodes.soundOn"            ,"Sound_On"         )       ), // (on ) 
        new Code(STATUS_SOUND_OFF           , "SOUND_OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.soundOff"           ,"Sound_Off"        )       ), // (off) 
        new Code(STATUS_EXCESS_CO2_ON       , "CO2_ON"       , I18N.getString(StatusCodes.class,"StatusCodes.co2On"              ,"CO2_On"           ), true ), // (on ) 
        new Code(STATUS_EXCESS_CO2_OFF      , "CO2_OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.co2Off"             ,"CO2_Off"          )       ), // (off) 
        ...
        new Code(STATUS_OBD_VIN             , "OBD.VIN"      , I18N.getString(StatusCodes.class,"StatusCodes.obc_VIN"            ,"Vehicle_ID"       )       ), 
        ...
        new Code(STATUS_FREEFALL            , "FREEFALL"     , I18N.getString(StatusCodes.class,"StatusCodes.freefall"           ,"FreeFall"         ), true ),
        new Code(STATUS_TILT                , "TILT"         , I18N.getString(StatusCodes.class,"StatusCodes.tilt"               ,"Tilt"             ), true ),
        ...
        new Code(STATUS_TRANSMISSION_GEAR   , "TRANS.GEAR"   , I18N.getString(StatusCodes.class,"StatusCodes.transGear"          ,"Trans_Gear"       )       ),
        new Code(STATUS_TRANSMISSION_REVERSE, "TRANS.REVERSE", I18N.getString(StatusCodes.class,"StatusCodes.transReverse"       ,"Trans_Reverse"    )       ),
        ...
        new Code(STATUS_IOT_SENSOR          , "IOT.SENSOR"   , I18N.getString(StatusCodes.class,"StatusCodes.iotSensor"          ,"IoT_Sensor"       )       ),
        ...
        new Code(STATUS_LICENSE_PLATE_0     , "LIC.PLATE.0"  , I18N.getString(StatusCodes.class,"StatusCodes.licensePlate_0"     ,"LicensePlate_0"   )       ),
        new Code(STATUS_LICENSE_PLATE_1     , "LIC.PLATE.1"  , I18N.getString(StatusCodes.class,"StatusCodes.licensePlate_1"     ,"LicensePlate_1"   )       ),
        new Code(STATUS_LICENSE_PLATE_2     , "LIC.PLATE.2"  , I18N.getString(StatusCodes.class,"StatusCodes.licensePlate_2"     ,"LicensePlate_2"   )       ),
        new Code(STATUS_LICENSE_PLATE_3     , "LIC.PLATE.3"  , I18N.getString(StatusCodes.class,"StatusCodes.licensePlate_3"     ,"LicensePlate_3"   )       ),
    ...
    **/
    public static String GetDescription(int code, BasicPrivateLabel bpl, String dftDesc)
    {
        Code sc = StatusCodes.GetCode(code, bpl);
        if (sc != null) {
            // -- found description
    ...
    **/
    ...
    {
        return StatusCodes.GetDescription(code, bpl, null);
    }
