...
public class EventDataAnalog
{
            ...
            for (int aNdx = 1; aNdx <= ANALOG_COUNT; aNdx++) {
                ...
                if (!StringTools.isBlank(alogStr)) {
                    ...
                    if (edaClass != null) {
                        ...
                        double dftGain = dcsc.getAnalogDefaultGain(1.0);
                        double dftOffs = dcsc.getAnalogDefaultOffset(0.0);
                        eda = new EventDataAnalog(aNdx, alogStr, dftGain, dftOffs);
                    }
                    if (EventDataAnalog.isValid(eda)) {
    ...
    **/
        ...
        double value)
    {
        ...
        if (edaMap == null) {
            if (dcsc != null) {
                edaMap = dcsc.getEventDataAnalogMap();
            } else {
                return false;
            }
        }
