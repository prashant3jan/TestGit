...
public class DBConfig
{
    ...
    private static final String PACKAGE_DBTOOLS_                = PACKAGE_OPENGTS_ + "dbtools.";   // "org.opengts.dbtools."
    ...
    public  static final String PACKAGE_WAR_TOOLS_              = PACKAGE_WAR_     + "tools.";     // "org.opengts.war.tools."
    public  static final String PACKAGE_WAR_TRACK               = PACKAGE_WAR_     + "track";      // "org.opengts.war.track"
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** The customer "Service Account" JWT Secret<br>
    *** Type: String/Hex
    **/
    public static final String PROP_ServiceAccount_JWT_Secret           = "ServiceAccount.JWT.Secret";

    /**
    *** Runtime Configuration Property<br>
    *** The customer "Service Account" JWT Obfuscation Seed<br>
    *** Type: String/Hex
    **/
    public static final String PROP_ServiceAccount_JWT_Seed             = "ServiceAccount.JWT.Seed";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Class name of ELogHOSProvider handler<br>
    *** Type: String
    **/
    public static final String PROP_Account_eLogHOSProviderClass        = "Account.eLogHOSProviderClass";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property (may not be used in this release)<br>
    *** File name for new user welcome email<br>
    *** Type: File
    **/
    public static final String PROP_Account_newUserWelcomeEmailFile     = "Account.newUserWelcomeEmailFile";
    ...
    *** Type: String
    **/
    public static final String PROP_Account_maintenanceLabelKM_         = "Account.maintenanceLabelKM.";
    public static final String PROP_Account_maintenanceLabelHR_         = "Account.maintenanceLabelHR.";
    public static final String PROP_Account_maintenanceLabelFT_         = "Account.maintenanceLabelFT.";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Type of short description used for label pushpins
    *** Type: Enum(DeviceID|ShortName|VehicleID|LicensePlate)
    **/
    public static final String PROP_DeviceRecord_labelPushpinNameType   = "DeviceRecord.labelPushpinNameType";
  //public static final String PROP_DeviceRecord_vehicleIDNameType      = "DeviceRecord.vehicleIDNameType";

    // ----------------------

    /**
    *** Runtime Configuration Property<br>
    *** True to enforce having a unique DeviceID
    **/
    public static final String PROP_Device_enforceUniqueDeviceID        = "Device.enforceUniqueDeviceID";

    /**
    *** Runtime Configuration Property<br>
    *** True to enable loading Device record by UniqueID
    **/
    public static final String PROP_Device_loadByUniqueID               = "Device.loadByUniqueID";

    /**
    *** Runtime Configuration Property<br>
    *** True to enable loading Device record by unique DeviceID
    **/
    public static final String PROP_Device_loadByDeviceID               = "Device.loadByDeviceID";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Returns the number of periodic maintenance hour values to support<br>
    *** (must be less-than-or-equal-to the maximum supported by the Device record)<br>
    *** Type: Integer
    **/
    public static final String PROP_Device_maintenanceHoursCount        = "Device.maintenanceHoursCount";

    /**
    *** Runtime Configuration Property<br>
    *** Returns the number of periodic maintenance fixed-time values to support<br>
    *** (must be less-than-or-equal-to the maximum supported by the Device record)<br>
    *** Type: Integer
    **/
    public static final String PROP_Device_maintenanceFixedTimeCount    = "Device.maintenanceFixedTimeCount";

    /**
    *** Runtime Configuration Property<br>
    *** Returns the default periodic maintenance fixed-time units<br>
    *** (0=Seconds, 1=Days, 2=Months)<br>
    *** Type: Integer
    **/
    public static final String PROP_Device_maintenanceFixedTimeUnits    = "Device.maintenanceFixedTimeUnits";
    ...
    **/
    ...
    public static final String PROP_RGClient_eventsPerSecond            = "RGClient.eventsPerSecond";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** >0 to suspend rule notifications on first device connections<br>
    *** The value indicates the number of delta-seconds allowed to still be considered a first-connection.
    *** Type: Int/Boolean
    **/
    public static final String PROP_Device_suspendFirstConnectNotify    = "Device.suspendFirstConnectNotify";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Indicator for whether the URL path should used when looking up a domain/url PrivateLabel<br>
    *** Type: Boolean
    **/
    public static final String PROP_Resource_PrivateLabelLookupUrlPath  = "Resource.PrivateLabelLookupUrlPath";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Create alternate keyed "atkey" in EventData over accountID/timestamp<br>
    *** Type: Boolean
    **/
    public static final String PROP_EventData_keyedAccountTime          = "EventData.keyedAccountTime";
    ...
    *** Type: Boolean
    **/
    public static final String PROP_Geozone_userRoleVisibility          = "Geozone.userRoleVisibility"; // RoleVisibility
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** True to enable ReverseGeocode caching to db table<br>
    *** Type: Boolean
    **/
    public static final String PROP_RGCache_enableDBCache               = "RGCache.enableDBCache";

    /**
    *** Runtime Configuration Property<br>
    *** True to ignore RGCache while the vehicle is moving<br>
    *** Type: Boolean
    **/
    public static final String PROP_RGCache_ignoreWhileMoving           = "RGCache.ignoreWhileMoving";

    /**
    *** Runtime Configuration Property<br>
    *** True to enable RGCache read-by-primary-key<br>
    *** Type: Boolean
    **/
    public static final String PROP_RGCache_readByPrimaryKey            = "RGCache.readByPrimaryKey";

    /**
    *** Runtime Configuration Property<br>
    *** Maximum age of RGCache entry (in days) before being considered 'expired'<br>
    *** Type: Long
    **/
    public static final String PROP_RGCache_maximumAgeDays              = "RGCache.maximumAgeDays";

    /**
    *** Runtime Configuration Property<br>
    *** True to delete expired entries<br>
    *** Type: Boolean
    **/
    public static final String PROP_RGCache_deleteExpiredEntries        = "RGCache.deleteExpiredEntries";
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** True to ignore robots requests (as detected by the User-Agent)<br>
    *** Type: Boolean
    **/
    public static final String PROP_track_ignoreRobotRequests           = "track.ignoreRobotRequests";
    ...
    **/
    ...
    protected static RTKey.Entry runtimeKeys[] = {
        ...
        new RTKey.Entry(PROP_ServiceAccount_JWT_Secret              , ""                            , "ServiceAccount JWT Secret"),
        new RTKey.Entry(PROP_ServiceAccount_JWT_Seed                , ""                            , "ServiceAccount JWT Obfuscation Seed"),
        // --
    ...
    public static void addTableFactories()
    {
        ...
        /* Standard tables */
        {
            String standardTables[] = new String[] {
                ...
                PACKAGE_TABLES_       + "EventDataExtra",
        ...
        /* Extra tables (optional) */
        {
            String extraTables[] = new String[] {
                ...
                PACKAGE_EXTRA_TABLES_ + "InboundSMS"        ,
                PACKAGE_EXTRA_TABLES_ + "ReportJob"         ,
                PACKAGE_EXTRA_TABLES_ + "RGCache"           ,
        ...
        /* optional tables (optional) */
        {
            String optTables[] = new String[] {
                ...
                PACKAGE_OPT_TABLES_ + "Download",
                PACKAGE_OPT_TABLES_ + "RGClient"
            };
    ...
    **/
    public static int cron()
    {
        ...
        try {
            ...
            Device device = Device.getDevice(rwMode, account, deviceID); // account.getDevice(deviceID);
