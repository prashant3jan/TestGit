...
//     -Added support for 'getRouteColor()' (RouteSegmentColor) [2.6.7-B17]
// ----------------------------------------------------------------------------
...
import org.opengts.util.JSON.JSONBean;
    ...
    implements JSONBean
{
    ...
    **/
    ...
    private static       int             NoClassDefFoundError_count = 0;
    private static       HashSet<String> NoClassDefFoundError_set = null;
    ...
    **/
    public static ImageIcon LoadImageIcon(File file)
    {
        ...
        } catch (NoClassDefFoundError ncdfe) { // java.lang.NoClassDefFoundError
            // -- "Could not initialize class sun.awt.X11.XToolkit"
            // -- "Could not initialize class sun.lwawt.macosx.LWCToolkit"
            // -- Note: When attempting to initialize many pushin images during initialization,
            // -    This exception can occur many times (possibly hundreds of times).  If the 
            // -    error is the same for every attempt at loading an icon, then there is no reason
            // -    to display this same error more than once.  The following keeps track of the
            // -    error messages and displays the error only the furst time is has occurred.
            String msg = ncdfe.getMessage();
            if (NoClassDefFoundError_set == null) { NoClassDefFoundError_set = new HashSet<String>(); }
            if (!NoClassDefFoundError_set.contains(msg)) {
                // -- we've not seen this error yet
                NoClassDefFoundError_set.add(msg);
                if (RTConfig.isDebugMode()) {
                    Print.logException("Missing platform ImageIcon support (similar errors are suppressed)", ncdfe);
                } else {
                    Print.logError("Missing platform ImageIcon support (similar errors are suppressed): " + ncdfe);
                }
            }
            NoClassDefFoundError_count++ ;
            return null;
        } catch (Throwable th) { // -- other error/exception
  ...
  //public static final String MARKER_ARG_PUSHPIN[]      = { "pushpin", "pp", "pin"  }; // might not be used
    ...
    public static class TextIcon
    {
        ...
        @JSONBeanGetter(name="name", tags="getDeviceList")
    ...
    **/
        ...
        OrderedMap<String,PushpinIcon> ppiMap)
    {
        ...
        for (File ppFile : ppFiles) {
            ...
            if (ppIcon == null) {
                // -- errors/warnings already displayed
    ...
    **/
    ...
    private String          routeColor   = null; // RouteSegmentColor
    ...
    *** @param routeC       The RouteSegmentColor following the pushpin
    **/
    public PushpinIcon(
        ...
        String routeC // RouteSegmentColor
        ) 
    {
        ...
        /* route-line segment color */
        this.routeColor   = StringTools.trim(routeC); // RouteSegmentColor
    ...
    **/
    @JSONBeanGetter(name="imageUrl", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconUrl", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconEval", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconWidth", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconHeight", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconHotspotX", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="iconHotspotY", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="shadowUrl", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="backUrl", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="backWidth", tags="getDeviceList")
    ...
    **/
    @JSONBeanGetter(name="backHeight", tags="getDeviceList")
    ...
    *** @return The icon image 'hotspot' X-offset
    **/
    @JSONBeanGetter(name="backOffsetX", tags="getDeviceList")
    ...
    *** @return The icon image 'hotspot' Y-offset
    **/
    @JSONBeanGetter(name="backOffsetY", tags="getDeviceList")
    ...
    /**
    *** Gets the RouteSegmentColor
    *** @return The RouteSegmentColor
    **/
    @JSONBeanGetter(name="routeColor", tags="getDeviceList")
    public String getRouteColor() // RouteSegmentColor
    {
    ...
    **/
    public String toString()
    {
        ...
        if (!StringTools.isBlank(this.getRouteColor())) { // RouteSegmentColor
            sb.append(", ");
            sb.append("RouteColor:'"  ).append(this.getRouteColor()).append("'");
        }
        return sb.toString();
    }
