...
//     -Added ACTION_CHECK_CRA (Note: currently CRA will still be checked even
//      if this is false)
//     -Added ACTION_VIA_MQ
// ----------------------------------------------------------------------------
...
public interface RuleFactory
{
    ...
    public static final int    ACTION_VIA_NOTIFY_QUEUE      = 0x00000200; // notify via Notify Queue
    ...
    public static final int    ACTION_VIA_MQ                = 0x00001000; // notify via MQ

    public static final int    ACTION_SAVE_LAST             = 0x00010000; // save last notification (into Device record)
    public static final int    ACTION_CHECK_CRA             = 0x00020000; // check canned-rule-ations (predefined actions)
    ...
    public enum NotifyAction implements EnumTools.BitMask, EnumTools.StringLocale {
        ...
        VIA_QUEUE    ((long)ACTION_VIA_NOTIFY_QUEUE,I18N.getString(RuleFactory.class,"RuleFactory.notifyAction.viaQueue"     ,"Queue"     )),
      ...
      //VIA_GCM      ((long)ACTION_VIA_GCM         ,I18N.getString(RuleFactory.class,"RuleFactory.notifyAction.viaGCM"       ,"GCM"       )),
        VIA_MQ       ((long)ACTION_VIA_MQ          ,I18N.getString(RuleFactory.class,"RuleFactory.notifyAction.viaMQ"        ,"MQ"        )),
        // ---
        SAVE_LAST    ((long)ACTION_SAVE_LAST       ,I18N.getString(RuleFactory.class,"RuleFactory.notifyAction.saveLast"     ,"SaveLast"  )),
        CHECK_CRA    ((long)ACTION_CHECK_CRA       ,I18N.getString(RuleFactory.class,"RuleFactory.notifyAction.checkCRA"     ,"CheckCRA"  ));
        // ---
        private long        vv = 0L;
    ...
    **/
    ...
    /**
    *** Returns a list of predefined rule actions suitable for presenting in a 
    *** user pull-down menu selection.
    ...
    *** @param selActionMask The action mask to execute if the selector triggers
    *** @param event         The event that contains the criteria used by the selector
    *** @return The mask containing the 'actions' performed.
    **/
    public int executeSelector(String selector, int selActionMask, EventData event);
