    ...
    implements Comparable<DCServerConfig>
{
    ...
    **/
    ...
    public enum CommandProtocol implements EnumTools.IsDefault, EnumTools.IntValue {
        ...
        public boolean isMQ()      { return this.equals(MQ ); }
    ...
    **/
    ...
    /**
    *** Gets a list of the archived log files present in the same directory as
    *** The main log file for this DCS.
    **/
    public static File[] getArchivedLogFiles(String dcsName)
    {
        ...
        /* get DCServerConfig for specified DCS */
        // -- only needed to makesure the DCS exists
        ...
        /* get the DCS main log file */
        File logFile = DCServerConfig.getLogFilePath(dcsName);
        if (logFile == null) {
            // -- Unable to determine log file for DCS
            return null;
        }

        /* get list of all DCS archived log files */
        File   logDir   = logFile.getParentFile();
        String logName  = logFile.getName();
        String filtGlob = logName+".20*.log"; // ie. "xirgo.log.20*.log"
        File logFiles[] = FileTools.getFiles(logDir, filtGlob, false/*recursive?*/);
        ListTools.sort(logFiles, new ListTools.StringComparator<File>());
        return logFiles;
    ...
    **/
    ...
    public static final String  COMMAND_PENDING                 = "pending";    // arg=""
  //public static final String  COMMAND_OUTPUT                  = "output";     // arg=gpioOutputState
    ...
    **/
    ...
    /**
    *** Sets the server name/id (DeviceCode)
    **/
    ...
    **/
    public File getConfigFile() // remove unused default parameter [2.6.6-B50]
    {
    ...
    **/
    ...
    /**
    *** Gets the first DCS unique-id prefix
    **/
    public String firstUniqueIdPrefix()
    {
        String uniqPfx[] = this.getUniquePrefix();
        return !ListTools.isEmpty(uniqPfx)? uniqPfx[0] : "";
    }
    ...
    **/
    ...
    /**
    *** Gets the "Analog Default Gain"
    *** @param dft  The default Analog Default Gain
    *** @return The Analog Default Gain
    **/
    public double getAnalogDefaultGain(double dft)
    {
        return this.getDoubleProperty(DCServerFactory.CONFIG_analogDefaultGain(this.getName()), dft);
    }
    ...
    *** @return The Analog Default Gain
    **/
    public static double getAnalogDefaultGain(DCServerConfig dcsc, double dft)
    {
        return (dcsc != null)? dcsc.getAnalogDefaultGain(dft) : dft;
    }

    // --------------------------------

    /**
    *** Gets the "Analog Default Offset"
    *** @param dft  The default Analog Default Offset
    *** @return The Analog Default Offset
    **/
    public double getAnalogDefaultOffset(double dft)
    {
        return this.getDoubleProperty(DCServerFactory.CONFIG_analogDefaultOffset(this.getName()), dft);
    }
    ...
    *** @return The Analog Default Offset
    **/
    public static double getAnalogDefaultOffset(DCServerConfig dcsc, double dft)
    {
        return (dcsc != null)? dcsc.getAnalogDefaultOffset(dft) : dft;
    }
    ...
    **/
    ...
    /**
    *** Gets the number of digital input bits
    *** @param dft  The number of digital input bits
    *** @return The number of digital input bits
    **/
    public int getGpioInputBitCount(int dft)
    {
        String bitCntS = this.getStringProperty(DCServerFactory.CONFIG_gpioInputBitCount(this.getName()), null);
        if (StringTools.isBlank(bitCntS)) {
            // -- not specified (or blank)
            return dft;
        } else
        if (bitCntS.equalsIgnoreCase("default")) {
            // -- explicit "default"
            return dft;
        } else {
            // -- mask specified
            int bitCnt = StringTools.parseInt(bitCntS, -1);
            return (bitCnt >= 0)? bitCnt : dft;
        }
    }
    ...
    *** @return The number of digital input bits
    **/
    public static long getGpioInputBitCount(DCServerConfig dcsc, int dft)
    {
        return (dcsc != null)? dcsc.getGpioInputBitCount(dft) : dft;
    }

    // ------------------------------------------------------------------------

    /**
    *** Gets the "Simulate Digital Inputs" mask
    *** @param dft  The default Simulate Digital Inputs mask
    *** @return The Simulate Digital Inputs mask
    **/
    ...
    public Map<String,EventDataAnalog> getEventDataAnalogMap()
    {
        ...
        synchronized (this.eventDataAnalogLock) {
            if (this.eventDataAnalogMap == null) {
                ...
                this.initEventDataAnalogMap(null/*keyPfx*/, null/*edaClass*/);
            }
    ...
    **/
    ...
    /**
    *** Gets the File value for the specified property key 
    *** @param key  The property key
    *** @param dft  The default value if the property key is not defined
    *** @return The File value of the property
    **/
    public File getFileProperty(String key, File dft)
    {
        String fileS = this._getStringProperty(null, key, null);
        return !StringTools.isBlank(fileS)? new File(fileS) : dft;
    }
