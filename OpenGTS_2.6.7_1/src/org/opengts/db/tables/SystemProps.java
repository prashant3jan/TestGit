    ...
    extends DBRecord<SystemProps>
{
    ...
    **/
    public static Collection<String> getSystemPropsKeyList(DBReadWriteMode rwMode)
        throws DBException
    {
        ...
        throws DBException
    {
        ...
        return SystemProps.getSystemPropsKeyList(rwMode);
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        return propKey.exists(DBReadWriteMode.READ_WRITE);
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        SystemProps.Key propKey = new SystemProps.Key(propID);
        if (!propKey.exists(rwMode)) {
            if (create) {
                prop = propKey._getDBRecord();
        ...
        if (create) {
            ...
            prop = propKey._getDBRecord(true, rwMode);
            if (prop == null) {
