    ...
    extends AccountRecord<AccountString>
{
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (strID != null)) {
            ...
            return strKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
        ...
        throws DBException
    {
        ...
        AccountString str = AccountString.getAccountString(rwMode, account, stringID);
        if (str == null) {
            str = AccountString.getAccountString(rwMode, account, stringID, true);
        }
    ...
    /* get string */
    public static AccountString getAccountString(DBReadWriteMode rwMode, Account account, String strID)
        throws DBException
    {
        if ((account != null) && (strID != null)) {
            ...
            if (key.exists(rwMode)) {
                AccountString str = key._getDBRecord(true, rwMode);
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return AccountString.getAccountString(rwMode, account, strID);
    }

    /* get the singular/plural strings in an array that can be used directly by "i18n.getStr...(...)" */
    public static String[] getStringsArray(DBReadWriteMode rwMode, Account account, String strID, String dft[])
    {

        /* get values */
        try {
            AccountString str = AccountString.getAccountString(rwMode, account, strID);
            if (str != null) {
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return AccountString.getStringsArray(rwMode, account, strID, dft);
    }
    ...
    public static AccountString getAccountString(DBReadWriteMode rwMode, Account account, String strID, boolean create)
        throws DBException
    {
        ...
        AccountString.Key strKey = new AccountString.Key(acctID, strID);
        if (!strKey.exists(rwMode)) {
            if (create) {
                str = strKey._getDBRecord();
                str.setAccount(account);
        ...
        if (create) {
            ...
            str = AccountString.getAccountString(rwMode, account, strID);
            if (str == null) {
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return AccountString.getAccountString(rwMode, account, strID, create);
    }
        ...
        throws DBException
    {
        ...
        if ((account != null) && (strID != null) && !strID.equals("")) {
            AccountString str = AccountString.getAccountString(rwMode, account, strID, true); // does not return null
            str.save();
            return str;
        } else {
    ...
    public static void main(String args[])
    {
        ...
        if (RTConfig.getBoolean(ARG_EDIT,false)) {
            ...
            if (!stringExists) {
                ...
                try {
                    DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
                    AccountString str = AccountString.getAccountString(rwMode, acct, strID, false); // may throw DBException
