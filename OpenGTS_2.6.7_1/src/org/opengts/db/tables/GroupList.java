    ...
    **/
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (userID != null) && (groupID != null)) {
            ...
            return grpListKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
    ...
    /* get/create device list entry (READ_WRITE database assumed) */
        ...
        throws DBException
    {
        ...
        if (grpListKey.exists(rwMode)) { // may throw DBException
            // -- already exists
            GroupList listItem = grpListKey._getDBRecord(true, rwMode);
            listItem.setUser(user);
            return listItem;
        } else
        if (createOK) {
            GroupList listItem = grpListKey._getDBRecord();
    ...
    public static java.util.List<String> getUsersForGroup(DBReadWriteMode rwMode, String acctId, String groupId)
        throws DBException
    {
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return GroupList.getUsersForGroup(rwMode, acctId, groupId);
    }
