...
//     -Added "isSpeeding" method, and "speeding" icon/pushpin selection check [2.6.6-B03]
//  2020/02/19  GTS Development Team
//     -Partial support for "getRouteSegmentColor" [2.6.7-B17]
//     -Added "PersonalHealth" fields [2.6.7-B17c]
//     -Added field(s) FLD_roadSurface [2.6.7-B17h]
//     -Added field(s) FLD_co2PPM, FLD_vocPPM [2.6.7-B34d]
// ----------------------------------------------------------------------------
               ...
               JSON.JSONBean
{
    ...
    public  static final String  OPTCOLS_RotationalAttitude         = "startupInit.EventData.RotationalAttitude"; // RotationAttitudeFieldInfo
    ...
    public  static final String  OPTCOLS_SnowPlowData               = "startupInit.EventData.SnowPlowData";
    ...
    public  static final String  OPTCOLS_PersonalHealth             = "startupInit.EventData.PersonalHealth";
    public  static final String  OPTCOLS_AutoLicensePlateRecog      = "startupInit.EventData.AutoLicensePlateRecog";
    ...
    // ------------------------------------------------------------------------
    // -- EventData DB read limit direction
    ...
    public enum ImpactSeverity implements EnumTools.IntValue {
        Unknown   ( -1, "Unknown"   , I18N.getString(EventData.class,"EventData.impactSeverity.unknown"  ,"Uknown"   )),
        NonCrash  (  0, "NonCrash"  , I18N.getString(EventData.class,"EventData.impactSeverity.NonCrash" ,"NonCrash" )),
        VeryLight (  1, "VeryLight" , I18N.getString(EventData.class,"EventData.impactSeverity.VeryLight","VeryLight")),
        Light     (  2, "Light"     , I18N.getString(EventData.class,"EventData.impactSeverity.Light"    ,"Light"    )),
        Moderate  (  3, "Moderate"  , I18N.getString(EventData.class,"EventData.impactSeverity.Moderate" ,"Moderate" )),
        Heavy     (  4, "Heavy"     , I18N.getString(EventData.class,"EventData.impactSeverity.Heavy"    ,"Heavy"    )),
        VeryHeavy (  5, "VeryHeavy" , I18N.getString(EventData.class,"EventData.impactSeverity.VeryHeavy","VeryHeavy"));
        // ---
        private int         vv = 0;
        private String      dd = null;
        private I18N.Text   aa = null;
        ImpactSeverity(int v, String d, I18N.Text a) { vv = v; dd = d; aa = a; }
        public int     getIntValue()                 { return vv; }
        public String  toString()                    { return dd; }
        public String  toString(Locale loc)          { return aa.toString(loc); }
        public boolean isUnknown()                   { return this.equals(Unknown); }
        public boolean isNonCrash()                  { return this.equals(NonCrash); }
        public boolean isCrash()                     { return (this.getIntValue() > 0)? true : false; }
    };

    /**
    *** Gets the ImpactSeverity enum value for the specified name
    *** @param name The name of the ImpactSeverity (one of "Unknown", "NonCrash", "VeryLight", "Light", etc.)
    *** @return The ImpactSeverity, or ImpactSeverity.Unknown if the name is invalid
    **/
    public static ImpactSeverity getImpactSeverity(String name)
    {
        return EventData.getImpactSeverity(name, ImpactSeverity.Unknown);
    }

    /**
    *** Gets the ImpactSeverity enum value for the specified name
    *** @param name The name of the ImpactSeverity (one of "Unknown", "NonCrash", "VeryLight", "Light", etc.)
    *** @param dft  The default ImpactSeverity if the specified name is invalid.
    *** @return The ImpactSeverity, or the specified default if the name is invalid
    **/
    public static ImpactSeverity getImpactSeverity(String name, ImpactSeverity dft)
    {
        return EnumTools.getValueOf(ImpactSeverity.class, name, dft);
    }

    /**
    *** Returns the ImpactSeverity for the specified EventData record.
    *** @param e  The EventData record from which the ImpactSeverity will be obtained.  
    ***           If null, the default ImpactSeverity will be returned.
    *** @return The ImpactSeverity
    **/
    public static ImpactSeverity getImpactSeverity(EventData e)
    {
        return (e != null)? 
            EnumTools.getValueOf(ImpactSeverity.class,e.getImpactSeverity()) : 
            EnumTools.getDefault(ImpactSeverity.class);
    }

    // ------------------------------------------------------------------------
    // -- Temperature

    public  static final double  INVALID_TEMPERATURE                = Temperature.INVALID_TEMPERATURE;
    public  static final double  TEMPERATURE_LIMIT_LO               = Temperature.TEMPERATURE_LIMIT_LO;
    public  static final double  TEMPERATURE_LIMIT_HI               = Temperature.TEMPERATURE_LIMIT_HI;
    public  static final double  TEMPERATURE_LIMIT_LO_F             = Temperature.TEMPERATURE_LIMIT_LO_F;
    public  static final double  TEMPERATURE_LIMIT_HI_F             = Temperature.TEMPERATURE_LIMIT_HI_F;
    ...
    **/
    ...
    {
        return Temperature.isValidTemperatureF(F);
    }
    ...
    **/
    public static IgnitionState _getIgnitionState(int ignSt) // [2.6.7-B47w]
    {
        return EnumTools.getValueOf(IgnitionState.class, ignSt, IgnitionState.UNKNOWN);
    }
    ...
    **/  // EventData.getIgnitionState
    ...
    public static       int         LprCandColumnLength = -1;   // FLD_alprCandidates

    // ------------------------------------------------------------------------

    private static final String  ALTKEY_pushkey         = "pushkey";
    private static final String  ALTKEY_atkey           = "atkey";      // FLD_accountID, FLD_timestamp
    ...
    /**
    *** Returns "atkey" if "EventData.keyedAccountTime" property is true
    *** @return "atkey" if "EventData.keyedAccountTime" property is true
    **/
    private static String ADT_atkey()
    {
        // -- EventData.keyedAccountTime=true
        return RTConfig.getBoolean(DBConfig.PROP_EventData_keyedAccountTime,false)?ALTKEY_atkey:"";
    }
    ...
    **/
    private static String Altkey_AccountID()
    {
        ...
        // -- "atkey"
        String atkey = ADT_atkey();
        if (!StringTools.isBlank(atkey)) {
            if (AK.length() > 0) { AK.append(","); }
            AK.append(atkey).append(":0"); // accountID
        }
        // -- "adtkey"
    ...
    **/
    private static String Altkey_Timestamp()
    {
        ...
        if (!StringTools.isBlank(atkey)) {
            ...
            TK.append(atkey).append(":1"); // timestamp
        }
        // -- "adtkey"
        String adtkey = ADT_adtkey();
        if (!StringTools.isBlank(adtkey)) {
    ...
    **/
    ...
    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    // -- EventData JSONBean implementation that places the EventData JSON object
    // -  within another object with key name "EventData"

    public JSON.JSONBean getJSONBeanTable() // getEventDataBean()
    {
        return new JSON.JSONBean() {
            @JSONBeanGetter(name="EventData")
    ...
    **/
    ...
    // -- Extra Address fields  [OPTCOLS_AddressFieldInfo] (see also FLD_address)
    ...
    public static final String FLD_roadSurface          = "roadSurface";            // reverse-geocoded road-surface indicator
    public static final DBField AddressFieldInfo[] = {
        ...
        new DBField(FLD_roadSurface      , Integer.TYPE  , DBField.TYPE_INT16       , I18N.getString(EventData.class,"EventData.fld.roadSurface"        , "Road Surface"          ), ""), // enum ReverseGeocode.RoadSurface
    };

    // -- Device/Modem/GPS fields  [OPTCOLS_GPSFieldInfo]
    ...
    public static final String FLD_gpsSpeedKPH          = "gpsSpeedKPH";            // may not be fully impleented
    ...
    public static final DBField GPSFieldInfo[] = {
        ...
        new DBField(FLD_gpsSpeedKPH      , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.gpsSpeedKPH"        , "GPS Speed"             ), "format=#0.0 units=speed"),
    ...
    public static final String FLD_signature            = "signature";              // event signature key
  //public static final String FLD_solarVolts           = "solarVolts";             // solar panel voltage
    public static final DBField CustomFieldInfo[] = {
        ...
        new DBField(FLD_driverStatus     , Integer.TYPE  , DBField.TYPE_INT32       , I18N.getString(EventData.class,"EventData.fld.driverStatus"       , "Driver Status"         ), ""),
      ...
      //new DBField(FLD_emailRecipient   , String.class  , DBField.TYPE_STRING(200) , I18N.getString(EventData.class,"EventData.fld.emailRecipient"     , "EMail Recipients"      ), ""),
        ...
        new DBField(FLD_signature        , String.class  , DBField.TYPE_STRING(64)  , I18N.getString(EventData.class,"EventData.fld.signature"          , "Event Signature"       ), ""),
    };

    // -- OBD fields [OPTCOLS_CANBUSFieldInfo]
  ...
  //public static final String FLD_obdType              = "obdType";                // OBD type [0,1=J1708, 2=J1939, 3=OBDII]
    ...
    public static final String FLD_accelerometerXYZ     = "accelerometerXYZ";       // X,Y,Z (m/s/s)
  ...
  //public static final String FLD_fuelContamination    = "fuelContamination";      // mask indicating fuel contamination
    ...
    public static final String FLD_vBatteryAmps         = "vBatteryAmps";           // vehicle battery amperage draw
    ...
    // -- axle load
  //public static final String FLD_alxeLoad             = "axleLoad"                // kg
    // --
    ...
    public static final DBField CANBUSFieldInfo[] = { 
      ...
      //new DBField(FLD_obdType          , Integer.TYPE  , DBField.TYPE_UINT16     , I18N.getString(EventData.class,"EventData.fld.obdType"            , "OBD Type"              ), ""),
        ...
        new DBField(FLD_vBatteryAmps     , Double.TYPE   , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.vBatteryAmps"       , "Vehicle Battery Amps"  ), "format=#0.0"),
        ...
        new DBField(FLD_milDistanceKM    , Double.TYPE   , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.milDistanceKM"      , "MIL Distance KM"       ), "format=#0.0 units=distance"),
    ...
    // -- Vehicle Rotational Attitude fields [OPTCOLS_RotationalAttitude]
    // -  startupInit.EventData.RotationalAttitude=true
    public static final String FLD_rotationPitch        = "rotationPitch";          // pitch
    public static final String FLD_rotationRoll         = "rotationRoll";           // roll
    public static final String FLD_rotationYaw          = "rotationYaw";            // yaw
    public static final DBField RotationalAttitude[] = { 
        new DBField(FLD_rotationPitch    , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.rotationPitch"      , "Rotation Pitch"        ), "format=#0.0"),
        new DBField(FLD_rotationRoll     , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.rotationRoll"       , "Rotation Roll"         ), "format=#0.0"),
        new DBField(FLD_rotationYaw      , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.rotationYaw"        , "Rotation Yaw"          ), "format=#0.0"),
    };

    // -- Garmin (GFMI) fields  [OPTCOLS_GarminFieldInfo]
    ...
    // -- Atmospheric fields  [OPTCOLS_AtmosphereFieldInfo]
    ...
    public static final String FLD_rainFall             = "rainFall";               // mm
    public static final String FLD_ambientTemp          = "ambientTemp";            // C
    public static final String FLD_groundTemp           = "groundTemp";             // C
    ...
    public static final DBField AtmosphereFieldInfo[] = {
        ...
        new DBField(FLD_rainFall         , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.rainFall"           , "Rain Fall"             ), "format=#0.0"),
        ...
        new DBField(FLD_groundTemp       , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.groundTemp"         , "Ground Temperature"    ), "format=#0.0 units=temp"),
    ...
    // -- Temperature fields  [OPTCOLS_ThermoFieldInfo]
    // -  startupInit.EventData.ThermoFieldInfo=true|8|4
    public static final String FLD_thermoAverage_       = "thermoAverage";          // C
    public static final DBField ThermoAverageFields[] = DBField.CreateDBFieldArray(
        EventData.getThermoAverageCount(),
        new DBFieldTemplate(FLD_thermoAverage_, Double.TYPE, DBField.TYPE_DOUBLE, I18N.getString(EventData.class,"EventData.fld.thermoAverage","Temperature Average {0}"), "format=#0.0 units=temp")
        );
    ...
    // -- Analog sensor fields  [OPTCOLS_AnalogFieldInfo]
    ...
    public static final String FLD_co2PPM               = "co2PPM";                 // CO2 ppm (Carbon Dioxide)
    public static final String FLD_vocPPM               = "vocPPM";                 // VOC ppm (Volatile Organic Compounds)
    public static final DBField AnalogFieldInfo[] = {
        ...
        new DBField(FLD_co2PPM           , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.co2PPM"             , "CO2 ppm"               ), "format=#0.0"),
        new DBField(FLD_vocPPM           , Double.TYPE   , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.vocPPM"             , "VOC ppm"               ), "format=#0.0"),
    };
    // --
    ...
    // -- GPRS Cell-Tower data (Serving Cell)  [OPTCOLS_ServingCellTowerData]
    ...
    // -- GPRS Cell-Tower data (Neighbor Cells)  [OPTCOLS_NeighborCellTowerData]
    ...
    // -- Impact data  [OPTCOLS_ImpactData]
    ...
    public static final String FLD_impactSeverity       = "impactSeverity";     // impact severity (-1=Unknown,0=NonCrach,1=VeryLight,2=Light,3=Moderate,4=Heavy,5=VeryHeavy)
    public static final String FLD_impactID             = "impactID";           // impact ID
    public static final DBField ImpactData[] = { 
        ...
        new DBField(FLD_impactSeverity   , Integer.TYPE , DBField.TYPE_INT16     , I18N.getString(EventData.class,"EventData.fld.impactSeverity"     , "Impact Severity"       ), ""),
        new DBField(FLD_impactID         , String.class , DBField.TYPE_STRING(50), I18N.getString(EventData.class,"EventData.fld.impactID"           , "Impact ID"             ), ""),
    };

    // -- Vehicle lease/rental (should be in the Device record)  [OPTCOLS_LeaseRentalData]
    ...
    public static final DBField LeaseRentalData[] = {
        ...
        new DBField(FLD_leaseContractID   , String.class , DBField.TYPE_STRING(32), I18N.getString(EventData.class,"EventData.fld.leaseContractID"    , "Lease Contract ID"     ), ""),
    };

    // -- Trip summary (ATrack)  [OPTCOLS_TripSummary]
  ...
  //public static final String FLD_tripFuelEconomy      = "tripFuelEconomy";
    ...
    public static final DBField TripSummary[] = {
      ...
      //new DBField(FLD_tripFuelEconomy   , Double.TYPE  , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.tripFuelEconomy"   , "Trip Fuel Economy"     ), "format=#0.0"),
    ...
    // -- End-Of-Day summary (Antx)  [OPTCOLS_EndOfDaySummary]
    ...
    // -- Keyed creation time with millisecond resolution  [OPTCOLS_CreationTimeMillisecond]
    ...
    // -- Snowplow data [OPTCOLS_SnowPlowData]
    // -  startupInit.EventData.SnowPlowData=true
    public static final String FLD_plowStatus           = "plowStatus";             // String/ID
    public static final String FLD_plowSettings         = "plowSettings";           // RTProperties format
    public static final String FLD_plowErrorCode        = "plowErrorCode";          // String/ID
    public static final String FLD_plowBladeEngaged     = "plowBladeEngaged";       // Boolean
    public static final String FLD_plowBladeAngle       = "plowBladeAngle";         // Degrees
    public static final String FLD_plowBladeHeight      = "plowBladeHeight";        // Meters
    public static final String FLD_plowDownForce        = "plowDownForce";          // Kg
    public static final String FLD_plowInputMask        = "plowInputMask";          // bitmask
    public static final String FLD_plowDistanceKM       = "plowDistanceKM";         // Km
    public static final String FLD_granularMaterialID   = "granularMaterialID";     // Name/ID
    public static final String FLD_granularSpreadRate   = "granularSpreadRate";     // Kg/Km
    public static final String FLD_granularSeasonTotal  = "granularSeasonTotal";    // Kg
    public static final String FLD_liquidMaterialID     = "liquidMaterialID";       // Name/ID
    public static final String FLD_liquidSpreadRate     = "liquidSpreadRate";       // L/Km
    public static final String FLD_liquidSeasonTotal    = "liquidSeasonTotal";      // L
    public static final DBField SnowPlowData[] = {
        new DBField(FLD_plowStatus         , String.class , DBField.TYPE_STRING(8)  , I18N.getString(EventData.class,"EventData.fld.plowStatus"         , "Plow Status"           ), ""),
        new DBField(FLD_plowSettings       , String.class , DBField.TYPE_STRING(150), I18N.getString(EventData.class,"EventData.fld.plowSettings"       , "Plow Settings"         ), ""),
        new DBField(FLD_plowErrorCode      , String.class , DBField.TYPE_STRING(8)  , I18N.getString(EventData.class,"EventData.fld.plowErrorCode"      , "Plow Error Code"       ), ""),
        new DBField(FLD_plowBladeEngaged   , Boolean.TYPE , DBField.TYPE_BOOLEAN    , I18N.getString(EventData.class,"EventData.fld.plowBladeEngaged"   , "Plow Blade Engaged"    ), ""),
        new DBField(FLD_plowBladeAngle     , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.plowBladeAngle"     , "Plow Blade Angle"      ), ""),
        new DBField(FLD_plowBladeHeight    , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.plowBladeHeight"    , "Plow Blade Height"     ), ""),
        new DBField(FLD_plowDownForce      , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.plowDownForce"      , "Plow Down Force"       ), ""),
        new DBField(FLD_plowInputMask      , Long.TYPE    , DBField.TYPE_UINT32     , I18N.getString(EventData.class,"EventData.fld.plowInputMask"      , "Plow Input Mask"       ), "format=X4"),
        new DBField(FLD_plowDistanceKM     , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.plowDistanceKM"     , "Plow Distance KM"      ), "format=#0.0 units=distance"),
        new DBField(FLD_granularMaterialID , String.class , DBField.TYPE_STRING(16) , I18N.getString(EventData.class,"EventData.fld.granularMaterialID" , "Granular Material ID"  ), ""),
        new DBField(FLD_granularSpreadRate , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.granularSpreadRate" , "Granular Spread Rate"  ), ""),
        new DBField(FLD_granularSeasonTotal, Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.ranularSeasonTotal" , "Granular Season Total" ), ""),
        new DBField(FLD_liquidMaterialID   , String.class , DBField.TYPE_STRING(16) , I18N.getString(EventData.class,"EventData.fld.liquidMaterialID"   , "Liquid Material ID"    ), ""),
        new DBField(FLD_liquidSpreadRate   , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.liquidSpreadRate"   , "Liquid Spread Rate"    ), ""),
        new DBField(FLD_liquidSeasonTotal  , Double.TYPE  , DBField.TYPE_DOUBLE     , I18N.getString(EventData.class,"EventData.fld.liquidSeasonTotal"  , "Liquid Season Total"   ), ""),
    };

    // -- Personal Health attributes
    // -  startupInit.EventData.PersonalHealth=true [OPTCOLS_PersonalHealth]
    public static final String FLD_heartRate             = "heartRate";             // heart-rate beats-per-minute
    public static final String FLD_bpSystolic            = "bpSystolic";            // blood-pressure Systolic (mmHg)
    public static final String FLD_bpDiastolic           = "bpDiastolic";           // blood-pressure Diastolic (mmHg)
    public static final DBField PersonalHealth[] = {
        new DBField(FLD_heartRate          , Integer.TYPE , DBField.TYPE_UINT16      , I18N.getString(EventData.class,"EventData.fld.heartRate"   , "Heart Rate BPM"              ), "edit=2"),
        new DBField(FLD_bpSystolic         , Integer.TYPE , DBField.TYPE_UINT16      , I18N.getString(EventData.class,"EventData.fld.bpSystolic"  , "Blood Pressure Systolic"     ), "edit=2"),
        new DBField(FLD_bpDiastolic        , Integer.TYPE , DBField.TYPE_UINT16      , I18N.getString(EventData.class,"EventData.fld.bpDiastolic" , "Blood Pressure Diastolic"    ), "edit=2"),
        // Doctor name/contact/etc
        // Health Notes
    };

    // -  startupInit.EventData.AutoLicensePlateRecog=true [OPTCOLS_AutoLicensePlateRecog]
    // -  ALPR, ANPR, LPR, NPR - Automatic License|Number Plate REcognition
    public static final String FLD_alprPlateID           = "alprPlateID";           // highest confidence license-place captured (per vehicle)
    public static final String FLD_alprConfidence        = "alprConfidence";        // confidence level of captured license-place
    public static final String FLD_alprCandidates        = "alprCandidates";        // list of candidate plates and corresponding confidence levels
  //public static final String FLD_alprVehicleColor      = "alprVehicleColor";      // vehicle color
  //public static final String FLD_alprStateProvince     = "alprStateProvince";     // license plate state/province
    public static final String FLD_alprSourceID          = "alprSourceID";          // the source/camera that detected the license plate
    public static final DBField AutoLicensePlateRecog[] = {
        new DBField(FLD_alprPlateID        , String.class , DBField.TYPE_STRING(16)  , I18N.getString(EventData.class,"EventData.fld.alprPlateID"      , "ALPR Plate ID"           ), "edit=2"),
        new DBField(FLD_alprConfidence     , Double.TYPE  , DBField.TYPE_DOUBLE      , I18N.getString(EventData.class,"EventData.fld.alprConfidence"   , "ALPR Plate ID Confidence"), "edit=2"),
        new DBField(FLD_alprCandidates     , String.class , DBField.TYPE_STRING(100) , I18N.getString(EventData.class,"EventData.fld.alprCandidates"   , "ALPR Plate Candidates"   ), "edit=2"),
      //new DBField(FLD_alprVehicleColor   , String.class , DBField.TYPE_COLOR()     , I18N.getString(EventData.class,"EventData.fld.vehicleColor"     , "ALPR Vehicle Color"               ), "edit=2"),
      //new DBField(FLD_alprStateProvince  , String.class , DBField.TYPE_STRING(40)  , I18N.getString(EventData.class,"EventData.fld.alprStateProvince", "ALPR State/Privince"     ), "utf8=true"), 
        new DBField(FLD_alprSourceID       , String.class , DBField.TYPE_STRING(24)  , I18N.getString(EventData.class,"EventData.fld.alprSourceID"     , "ALPR Plate Source ID"    ), "edit=2"),
    };

    // -- WorkZone Grid data (still under development)  [OPTCOLS_WorkZoneGridData]
  ...
  //public static final String FLD_appliedPressure      = "appliedPressure";        // kPa
    ...
    // -- Auto increment  [OPTCOLS_AutoIncrementIndex]
    ...
    public static class Key
        extends DeviceKey<EventData> // DBRecordKey
    {
        public Key() {
    ...
    public static DBFactory<EventData> getFactory()
    {
        if (factory == null) {
          ...
          //factory.setLogMissingColumnWarnings(RTConfig.getBoolean(DBConfig.PROP_EventData_logMissingColumns,true));
            ...
            // -- FLD_alprCandidates max length
            DBField lprCanFld = factory.getField(FLD_alprCandidates);
            EventData.LprCandColumnLength = (lprCanFld != null)? lprCanFld.getStringLength() : 0;
    ...
    */
    ...
    // public final String getDeviceVID() { return super.getDeviceVID(); }
    ...
    **/
    //@JSONBeanGetter()  // see "getStatusCodeHex()" below
    ...
    **/
    ...
    public String getStatusCodeDescription()
    {
        ...
        BasicPrivateLabel bpl = (account != null)?
            account.getContextPrivateLabel() : Account.getSessionPrivateLabel();
        return StatusCodes.GetDescription(this.getStatusCode(),bpl,"");
    }
    ...
    **/
    public void setRawData(byte b[])
    {
        if ((b != null) && (b.length > 0)) {
            this.setRawData("0x" + StringTools.toHexString(b));
        }
    }
    ...
    **/
    @JSONBeanGetter(tags="gps", ignore="==0")
    ...
    **/
    @JSONBeanGetter(tags="gps,speed", ignore="==0")
    ...
    **/
    ...
    {
        this.setFieldValue(FLD_speedKPH, (v >= 0.0)? v : 0.0); // no neg speeds [2.6.7-B46g]
    }

    /**
    *** Returns true if speed is greater-than zero
    **/
    ...
    /**
    *** Gets the GPS speed in km/h<br>
    *** May be used for implementations that require OBD/GPS speed differentiation.
    *** Support for this value requires that the FLD_gpsSpeedKPH column exists in the EventData table.
    **/
    public void setGpsSpeedKPH(double v)
    {
        this.setOptionalFieldValue(FLD_gpsSpeedKPH, (v >= 0.0)? v : 0.0); // no neg speeds [2.6.7-B46g]
    }

    /**
    *** Gets the GPS speed in km/h
    *** @return The GPS speed value, or zero if not set or if the "gpsSpeedKPH" column does not exist in EventData.
    **/
    public double getGpsSpeedKPH()
    {
        Double v = (Double)this.getOptionalFieldValue(FLD_gpsSpeedKPH);
    ...
    /**
    *** Returns true if this EventData instance represents a speeding event
    **/
    public boolean isSpeeding(double dftLimitKPH, double dftOffsetKPH, boolean checkGeozones)
    {
        return Device.IsSpeeding(this, dftLimitKPH, dftOffsetKPH, checkGeozones);
    }

    /**
    *** Returns true if this EventData instance represents a speeding event
    **/
    public boolean isSpeeding(double dftLimitKPH, double dftOffsetKPH)
    {
        boolean checkGeozones = false; // default geozone check
        return this.isSpeeding(dftLimitKPH, dftOffsetKPH, checkGeozones);
    }

    /**
    *** Returns true if this EventData instance represents a speeding event
    **/
    public boolean isSpeeding(double dftLimitKPH)
    {
        double dftOffsetKPH = 0.0; // will use device speed offet
        return this.isSpeeding(dftLimitKPH, dftOffsetKPH);
    }
    ...
    **/
    ...
    {
        double dftLimitKPH = 0.0; // default speed limit
        return this.isSpeeding(dftLimitKPH);
    }
    ...
    **/ 
    ...
    {
        this.setFieldValue(FLD_heading, (v >= 0.0)? v : 0.0); // no neg heading [2.6.7-B46g]
    }
    
    // ------------------------------------------------------------------------

    @JSONBeanGetter(tags="gps,altitude", ignore="==0")
    ...
    @JSONBeanGetter(tags="odometer", ignore="==0")
    ...
    *** @return The offset adjusted odometer value
    **/
    //@JSONBeanGetter(tags="odometer", name="odometerKM")
    ...
    **/
    @JSONBeanGetter(tags="geozone", ignore="$blank")
    ...
    **/
    public Geozone getGeozone()
    {
        ...
        if ((this.geozone == null) && this.hasGeozoneID()) {
            ...
            try {
                Geozone gz[] = Geozone.getGeozone(rwMode, this.getAccount(), gid);
    ...
    **/
    ...
    //@JSONBeanGetter(tags="entity", ignore="$blank")
    ...
    **/
    @JSONBeanGetter(tags="battery", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="battery", ignore="<-273,==0")
    ...
    **/
    //@JSONBeanGetter(tags="signal", ignore="<=0")
    ...
    **/
    ...
    @JSONBeanGetter(tags="address,geocode", ignore="$blank")
    ...
    **/
    ...
    private static boolean ENFORCE_FASTONLY_RG = true;

    /**
    *** Gets the enforcement state for Fast-only reverse-geocoding
    **/
    public static boolean getEnforceFastOnlyReverseGeocode()
    {
        return EventData.ENFORCE_FASTONLY_RG;
    }

    /**
    *** Sets the enforcement state for Fast-only reverse-geocoding
    **/
    public static void setEnforceFastOnlyReverseGeocode(boolean enforce)
    {
        EventData.ENFORCE_FASTONLY_RG = enforce;
    }
        ...
        throws SlowOperationException
    {
        ...
        if (geocoderMode.isNone()) {
            ...
            Print.logDebug("GeocoderMode disabled: " + geocoderMode + " (" + acctID + ")");
            return null;
        }
        ...
        if (statusCode == StatusCodes.STATUS_GEOFENCE_DEPART) {
            ...
            if ((gz == null) || (gz.length == 0)) {
                ...
                if (clientId > 0L) {
                    gz = Geozone.getClientIDZones(acctID, clientId);
                }
            }
            // -- next try geozoneID
            if ((gz == null) || (gz.length == 0)) {
                ...
                if (!StringTools.isBlank(geozoneID)) {
                    try {
                        gz = Geozone.getGeozone(rwMode, acct, geozoneID);
                    } catch (DBNotFoundException dbnfe) {
                        Print.logWarn("Geozone not found: " + acctID + "/" + geozoneID);
                    } catch (DBException dbe) {
                        Print.logException("Error reading Geozone: " + acctID + "/" + geozoneID, dbe);
                    }
                }
            }
            // -- update and return if we found the geozone
            if ((gz != null) && (gz.length > 0) && gz[0].isReverseGeocode(devID)) {
                ...
                // --
                String rgName = "GZ-"+this.getGeozoneID();
                long deltaMS = DateTime.getCurrentTimeMillis() - startMS;
                Print.logInfo("EventData address: [%s/%s:%s(%d)] %s: %s",
                    acctID,devID,rgName,deltaMS,this.getGeoPoint().toString(),this.getAddress());
                // --
                return updFields;
            }
        } else
        ...
        String addrGPStr = addrGP.toString();

        /* (at least GeocoderMode.GEOZONE) get address from Geozone */
        Geozone gzone = Geozone.getGeozone(rwMode, acctID, null/*zoneID*/, addrGP, true); // <Geozone>.getReverseGeocode() == true
        if ((gzone != null) && !gzone.isDeviceInGroup(devID)) { gzone = null; }
        if (gzone != null) {
            Set<String> updFields = new HashSet<String>();
            Print.logInfo("Found Geozone : ["+gzone.getAccountID()+"/"+devID+"] " + gzone.getGeozoneID() + " - " + gzone.getDescription());
            ...
            long deltaMS = DateTime.getCurrentTimeMillis() - startMS;
            Print.logInfo("EventData address: [%s/%s:%s(%d)] %s: %s",
                acctID,devID,rgName,deltaMS,addrGPStr,this.getAddress());
            // --
            return updFields;
        }
        ...
        if (geocoderMode.isGeozone()) { // was: (!geocoderMode.okPartial())
            ...
            Print.logDebug("Skipping reverse-geocode per geocoderMode: " + geocoderMode + " (" + acctID + ")");
            return null;
        }
        ...
        if (fastOnly && !rgp.isFastOperation() && EventData.ENFORCE_FASTONLY_RG) {
        ...
        boolean isMoving = this.isInMotion();
        boolean cache = !isMoving? true : false; // cache if not moving
        ...
        if (!dev.checkLastRevGeocodeTime(rgp,isMoving,timestamp)) {
            // -- too soon since last RG, return last cached, or  nothing
            rg = rgp.getCachedReverseGeocode(addrGP);
        } else {
            try {
                ...
                // -- get reverse-geocode
                Account.ActiveStatus activeStatus = Account.GetActiveStatus(acct);
                if (activeStatus.isActive()) {
                    // -- reverse-geocode iff active
                    if (props == null) {
                        props = new Properties();
                    }
                    props.setProperty(Device.FLD_accountID, acctID);
                    props.setProperty(Device.FLD_deviceID , devID);
                    String clientID = acctID;
                    rg = rgp.getReverseGeocode(addrGP, isMoving, localeStr, cache, clientID, props);
                } else {
                    // -- Account is expired/suspended/etc ...
                    Print.logInfo("Account is "+activeStatus+" - skipping reverse-geocode: " + acctID);
                    rg = null;
                }
            } catch (Throwable th) {
                // -- ignore 
                ...
                // -- pop Domain properties
                privLabel.popRTProperties();
            }
        }

        /* update device last RG (whether or not 'rg' is null) */
        dev.updateLastRevGeocodeTime(isMoving, timestamp, true/*update*/);
        ...
        if (rg != null) {
            ...
            if (rg.hasIsTollRoad()) {
                this.setIsTollRoad(rg.getIsTollRoadBool());             // FLD_isTollRoad
                updFields.add(EventData.FLD_isTollRoad);
            }
          //if (rg.hasIsOneWay()) {
          //    this.setIsOneWay(rg.getIsOneWayBool());                 // FLD_isOneWay
          //    updFields.add(EventData.FLD_isOneWay);
          //}
            if (rg.hasRoadSurface()) {
                this.setRoadSurface(rg.getRoadSurface());               // FLD_roadSurface
                updFields.add(EventData.FLD_roadSurface);
            }
            // --
            String rgName = StringTools.blankDefault(rg.getRGProvider(),rgp.getName());
            long deltaMS = DateTime.getCurrentTimeMillis() - startMS;
            Print.logInfo("EventData address: [%s/%s:%s(%d)] %s: %s",
                acctID,devID,rgName,deltaMS,addrGPStr,this.getAddress());
            // --
    ...
    **/
        ...
        throws SlowOperationException
    {
        ...
        if (rgp == null) {
            // -- ReverseGeocodeProvider not specified
            Print.logInfo("ReverseGeocodeProvider not specified"); 
            return null;
        } else
        if (!rgp.isEnabled()) {
            Print.logInfo("ReverseGeocodeProvider disabled: " + rgp.getName());
        ...
        try {
            ...
            privLabel.pushRTProperties(); // stack properties (may be redundant in servlet environment)
            String localeStr = privLabel.getLocaleString();
            rg = rgp.getReverseGeocode(addrGP, isMoving, localeStr, cache, acctID, props); // get the reverse-geocode
        } catch (Throwable th) {
            // -- ignore
        } finally {
    ...
    **/
    @JSONBeanGetter(tags="geocode", ignore="<=0")
    ...
    **/
    ...
    @JSONBeanGetter(tags="toll,geocode", ignore="false")
    ...
    /* get road surface enum */
    @JSONBeanGetter(tags="roadSurface,geocode", ignore="<=0")
    public int getRoadSurface()
    {
        return this.getFieldValue(FLD_roadSurface, -1);
    }

    /* set road surface enum */
    public void setRoadSurface(int v)
    {
        this.setFieldValue(FLD_roadSurface, v);
    }
    ...
    /* get digital input mask */
    @JSONBeanGetter(name="input", tags="io,input", ignore="<=0")
    ...
    /* get digital input mask */
    @JSONBeanGetter(name="inputHex", tags="io,inputHex", ignore="0xFFFFFFFF,0x0000")
    public String getInputMaskHex()
    {
        long mask = this.getInputMask();
        if (mask < 0L) {
            return "0x" + StringTools.toHexString(mask, 32);
        } else
        if ((mask & ~0xFFFFL) != 0) {
            return "0x" + StringTools.toHexString((mask & 0x7FFFFFFFL), 32);
        } else {
            return "0x" + StringTools.toHexString((mask & 0xFFFFL), 16);
        }
    }
    ...
    /* get digital output mask */
    @JSONBeanGetter(name="output", tags="io,output", ignore="<=0")
    ...
    /* get digital input mask */
    @JSONBeanGetter(name="outputHex", tags="io,outputHex", ignore="0xFFFFFFFF,0x0000")
    public String getOutputMaskHex()
    {
        long mask = this.getOutputMask();
        if (mask < 0L) {
            return "0x" + StringTools.toHexString(mask, 32);
        } else
        if ((mask & ~0xFFFFL) != 0) {
    ...
    **/
    @JSONBeanGetter(tags="ignition", ignore="==0")
    ...
    **/
    ...
    /* get seatbelt mask */
    //@JSONBeanGetter(name="seatbelts", tags="seatbelt", ignore="<=0")
    ...
    /* get door state mask */
    //@JSONBeanGetter(name="doors", tags="doors", ignore="<=0")
    ...
    //@JSONBeanGetter(name="lights", tags="lights", ignore="<=0")
    ...
    @JSONBeanGetter(tags="barometer", ignore="==0")
    ...
    @JSONBeanGetter(tags="humidity", ignore="==0")
    ...
    @JSONBeanGetter(tags="rainFall", ignore="==0")
    public double getRainFall()
    {
        return this.getFieldValue(FLD_rainFall, 0.0); // millimeters
    }
    
    public void setRainFall(double mm) // millimeters
    {
        this.setFieldValue(FLD_rainFall, ((mm < 0.0)? 0.0 : mm));
    }
    ...
    **/
    @JSONBeanGetter(tags="ambientTemp,temperature", ignore="<-273,==0")
    ...
    **/
    ...
    /**
    *** Gets the ground/road temperature (C)
    *** @return The ground/road temperature (C)
    **/
    @JSONBeanGetter(tags="groundTemp,temperature", ignore="<-273,==0")
    public double getGroundTemp()
    {
        return this.getFieldValue(FLD_groundTemp, INVALID_TEMPERATURE);
    }

    /**
    *** Sets the ground/road temperature (C)
    *** @param v The ground/road temperature (C)
    **/
    public void setGroundTemp(double v)
    {
        this.setFieldValue(FLD_groundTemp, v);
    }
    ...
    **/
    @JSONBeanGetter(tags="cabinTemp,temperature", ignore="<-273,==0")
    ...
    **/
    @JSONBeanGetter(tags="cargoTemp,temperature", ignore="<-273,==0")
    ...
    **/
    ...
    private static final int DEFAULT_THERMO_AVERAGE_COUNT = 2;
    ...
    **/
    public static int getThermoAverageCount()
    {
        int mc;
        //mc = RTConfig.getInt(DBConfig.PROP_EventData_thermoAverageCount, DEFAULT_THERMO_AVERAGE_COUNT);
        String tac = RTConfig.getString(OPTCOLS_ThermoFieldInfo,null);
        if (StringTools.isBlank(tac)) {
            mc = DEFAULT_THERMO_AVERAGE_COUNT;
        } else
        if (tac.equalsIgnoreCase("true")) {
            mc = DEFAULT_THERMO_AVERAGE_COUNT;
        } else
        if (tac.equalsIgnoreCase("false")) {
            mc = 0;
        } else {
            mc = StringTools.parseInt(tac,DEFAULT_THERMO_AVERAGE_COUNT);
        }
        return (mc > 0)? mc : 0;
    }
    ...
    /**
    *** Returns the actual number of defined temperature fields
    **/
    public static int getActualThermoAverageCount()
    {
    ...
    **/
    public static String getThermoAverageFieldName(int ndx) // getThermoAverageName
    {
        switch (ndx) {
    ...
    /**
    *** Gets the temperature field index for the specified field name
    **/
    public static int getThermoAverageFieldIndex(String fldName)
    {
        if (!StringTools.isBlank(fldName)) {
            switch (fldName) {
                case FLD_thermoAverage0: return 0;
                case FLD_thermoAverage1: return 1;
                case FLD_thermoAverage2: return 2;
                case FLD_thermoAverage3: return 3;
                case FLD_thermoAverage4: return 4;
                case FLD_thermoAverage5: return 5;
                case FLD_thermoAverage6: return 6;
                case FLD_thermoAverage7: return 7;
            }
        }
        return -1;
    }
    ...
    /**
    *** Returns true if the specified field is a temperature field name
    **/
    public static boolean isThermoAverageFieldName(String fldName)
    {
        return (EventData.getThermoAverageFieldIndex(fldName) >= 0)? true : false;
    }
    ...
    **/
    ...
    @JSONBeanGetter(tags="thermo,temperature", ignore="<-273,==0")
    ...
    **/
    ...
    @JSONBeanGetter(tags="analog", ignore="<=0")
    ...
    @JSONBeanGetter(tags="pulse", ignore="<=0")
    ...
    @JSONBeanGetter(tags="frequency", ignore="<=0")
    ...
    @JSONBeanGetter(tags="ppm", ignore="<=0")
    public double getCo2PPM()
    {
        return this.getFieldValue(FLD_co2PPM, 0.0);
    }

    public void setCo2PPM(double v)
    {
        this.setFieldValue(FLD_co2PPM, (!Double.isNaN(v)?v:0.0));
    }
    ...
    {
        return this.getFieldValue(FLD_vocPPM, 0.0);
    }

    public void setVocPPM(double v)
    {
        this.setFieldValue(FLD_vocPPM, (!Double.isNaN(v)?v:0.0));
    }
    ...
    */
    ...
    /* Trip Fuel Economy */
    /*
    public double getTripFuelEconomy()
    {
        return this.getFieldValue(FLD_tripFuelEconomy, 0.0);
    }
    public void setTripFuelEconomy(double v)
    {
        this.setFieldValue(FLD_tripFuelEconomy, ((v >= 0.0)? v : 0.0));
    }
    */
    ...
    public boolean canUpdateCellTowerLocation()
    {
        ...
        BasicPrivateLabel bpl = acct.getPrivateLabel(); // never null

        /* MobileLocationProvider check */
        MobileLocationProvider mlp = bpl.getMobileLocationProvider(); // test for existance
    ...
    public Set<String> updateCellTowerLocation()
    {
        ...
        if ((ml != null) && ml.hasGeoPoint()) {
            ...
            return updFields; // success (but may still not have a valid location)
        } else {
    ...
    public void resetCellServingInfo()
    {
        RTProperties ctp = this.getServingCellTowerRTP();
        this.setCellServingInfo(ctp.toString());
    }

    // --------------------------------

    /* true if serving cell tower data is present/valid */
    public boolean hasServingCellTower()
    {
        if (this.getCellTowerID() <= 0) { // (hasServingCellTower)
            return false;
        } else
        if (this.getMobileCountryCode() < 0) { // (hasServingCellTower) could be 0
            return false;
        } else
        if (this.getMobileNetworkCode() < 0) { // (hasServingCellTower)
            return false;
        } else {
            return true;
        }
    ...
    /* get Serving CellTower RTProperties */
    public RTProperties getServingCellTowerRTP()
    {
        ...
        return ctp; // non-null (but may not contain valid cell-tower info)
    }
    ...
    {
        RTProperties ctp = this.getServingCellTowerRTP();
        if (ctp.getInt(CellTower.ARG_CID,-1) <= 0) {
            return null;
        } else {
    ...
    **/
    @JSONBeanGetter(tags="driver", ignore="$blank")
    ...
    **/
    @JSONBeanGetter(tags="driver", ignore="<=0")
    ...
    *** Plow loop mode enum
    **/
    public enum PlowLoopMode implements EnumTools.IntValue {
        // -- see ForceAmerica: [05]FA_GranularMode, [26]FA_PrewetLoopOp, [28]FA_LiquidLoopOp, [32]FA_DustCtlLoopOp
        UNKNOWN (0, "Unknown"   ),
        CLOSED  (1, "ClosedLoop"),
        OPEN    (2, "OpenLoop"  ),
        MANUAL  (9, "Manual"    );
        ...
        int    vv = 0;
        String dd = "";
        PlowLoopMode(int v, String d)   { vv=v; dd=d; }
        public int     getIntValue()    { return vv; }
        public String  toString()       { return dd; }
        public boolean isUnknown()      { return this.equals(UNKNOWN); }
        public boolean isClosed()       { return this.equals(CLOSED); }
        public boolean isOpen()         { return this.equals(OPEN); }
        public boolean isManual()       { return this.equals(MANUAL); }
    };

    /**
    *** Gets the plow loop mode enum for the specified int value
    **/
    public static PlowLoopMode getLoopMode(int v)
    {
        return EnumTools.getValueOf(PlowLoopMode.class, v);
    }

    // --------------------------------

    /**
    *** Gets the plow error code (if any)
    *** @return The plow error code
    **/
    @JSONBeanGetter(tags="plow", ignore="$blank")
    public String getPlowErrorCode()
    {
        String v = (String)this.getFieldValue(FLD_plowErrorCode);
        return StringTools.trim(v);
    }

    /**
    *** Gets the plow error code as an int
    *** @return The default value to return if unable to parse the error code into an int
    **/
    public int getPlowErrorCode(int dft)
    {
        String v = this.getPlowErrorCode();
        return StringTools.parseInt(v, dft);
    }

    /**
    *** Sets the plow error code
    *** @param v The plow error code
    **/
    public void setPlowErrorCode(String v)
    {
        this.setFieldValue(FLD_plowErrorCode, StringTools.trim(v));
    }

    /**
    *** Sets the plow error code as an int
    *** @param v The plow error code as an int
    **/
    public void setPlowErrorCode(int v)
    {
        this.setPlowErrorCode(String.valueOf(v));
    }

    // --------------------------------

    /**
    *** Gets the plow status
    *** @return The plow status
    **/
    @JSONBeanGetter(tags="plow", ignore="$blank")
    public String getPlowStatus()
    {
        String v = (String)this.getFieldValue(FLD_plowStatus);
        return StringTools.trim(v);
    }

    /**
    *** Sets the plow status
    *** @param v The plow status
    **/
    public void setPlowStatus(String v)
    {
        this.setFieldValue(FLD_plowStatus, StringTools.trim(v));
    }

    // --------------------------------

    /**
    *** Gets the plow settings
    *** @return The plow settings
    **/
    @JSONBeanGetter(tags="plow", ignore="$blank")
    public String getPlowSettings()
    {
        String v = (String)this.getFieldValue(FLD_plowSettings);
        return StringTools.trim(v);
    }

    /**
    *** Sets the plow settings
    *** @param v The plow settings
    **/
    public void setPlowSettings(String v)
    {
        this.setFieldValue(FLD_plowSettings, StringTools.trim(v));
    }
    ...
    *** @return The plow settings
    **/
    public RTProperties getPlowSettingsRTP()
    {
        return new RTProperties(this.getPlowSettings());
    }

    /**
    *** Sets the plow settings as an RTProperties instance
    *** @param v The plow settings as an RTProperties instance
    **/
    public void setPlowSettingsRTP(RTProperties rtp)
    {
        this.setPlowSettings((rtp != null)? rtp.toString() : null);
    }

    // --------------------------------

    /**
    *** Gets the plow blade engaged state
    *** @return The plow blade engaged state
    **/
    @JSONBeanGetter(tags="plow", ignore="false")
    public boolean getPlowBladeEngaged()
    {
        return this.getFieldValue(FLD_plowBladeEngaged, true);
    }

    /**
    *** Sets the plow blade engaged state
    *** @param v The plow blade engaged state
    **/
    public void setPlowBladeEngaged(boolean v)
    {
        this.setFieldValue(FLD_plowBladeEngaged, v);
    }

    /**
    *** Sets the plow blade "Up" state
    *** @param v True for "Up", False for "Down"
    **/
    public void setPlowBladeUp(boolean v)
    {
        //this.setPlowBladeHeight(v? 9999.0 : 0.0);
        this.setPlowBladeEngaged(!v);
    }

    /**
    *** Returns true if the plow blade is "up"
    *** @return True if the plow blade is "up"
    **/
    public boolean getPlowBladeUp()
    {
        //return (this.getPlowBladeHeight() > 0.0)? true : false;
        return this.getPlowBladeEngaged();
    }

    // --------------------------------

    /**
    *** Gets the plow blade angle
    *** @return The plow blade angle
    **/
    @JSONBeanGetter(tags="plow")
    public double getPlowBladeAngle()
    {
        return this.getFieldValue(FLD_plowBladeAngle, 0.0);
    }

    /**
    *** Sets the plow blade angle
    *** @param v The plow blade angle
    **/
    public void setPlowBladeAngle(double v)
    {
        this.setFieldValue(FLD_plowBladeAngle, v);
    }

    // --------------------------------

    /**
    *** Gets the plow blade height (millimeters)
    *** @return The plow blade height
    **/
    @JSONBeanGetter(tags="plow")
    public double getPlowBladeHeight()
    {
        return this.getFieldValue(FLD_plowBladeHeight, 0.0);
    }

    /**
    *** Sets the plow blade height (millimeters)
    *** @param v The plow blade height
    **/
    public void setPlowBladeHeight(double v)
    {
        this.setFieldValue(FLD_plowBladeHeight, v);
    }

    // --------------------------------

    /**
    *** Gets the plow down force (Kg)
    *** @return The plow down force
    **/
    @JSONBeanGetter(tags="plow", ignore="<0")
    public double getPlowDownForce()
    {
        return this.getFieldValue(FLD_plowDownForce, 0.0);
    }

    /**
    *** Sets the plow down force (Kg)
    *** @param v The plow down force
    **/
    public void setPlowDownForce(double v)
    {
        this.setFieldValue(FLD_plowDownForce, v);
    }

    // --------------------------------

    /* get plow digital input mask */
    @JSONBeanGetter(name="plowInput", tags="plow,io,input", ignore="<=0")
    public long getPlowInputMask()
    {
        Long v = (Long)this.getFieldValue(FLD_plowInputMask);
        return (v != null)? v.intValue() : 0L;
    }

    /* get plow digital input mask */
    @JSONBeanGetter(name="plowInputHex", tags="plow,io,inputHex", ignore="0xFFFFFFFF,0x0000")
    public String getPlowInputMaskHex()
    {
        long mask = this.getPlowInputMask();
        if (mask < 0L) {
            return "0x" + StringTools.toHexString(mask, 32);
        } else
        if ((mask & ~0xFFFFL) != 0) {
    ...
    /* return state of plow input mask bit */
    public boolean getPlowInputMaskBitState(int bit)
    {
        long m = this.getPlowInputMask();
        return (((1L << bit) & m) != 0L);
    }
    
    /* set plow digital input mask */
    public void setPlowInputMask(long v)
    {
        if (v == -1L) {
            // -- ignore
        } else
        if (v < 0L) {
            // -- FLD_inputMask is unsigned, set to zero
            this.setFieldValue(FLD_plowInputMask, 0L);
        } else {
            // -- FLD_inputMask is currently 32-bit max 
            this.setFieldValue(FLD_plowInputMask, (v & 0xFFFFFFFFL)); // 32-bits only
        }
    }
    ...
    /**
    *** Gets the Plow distance travelled
    **/
    @JSONBeanGetter(tags="plow", ignore="<=0")
    public double getPlowDistanceKM()
    {
        return this.getFieldValue(FLD_plowDistanceKM, 0.0);
    }

    /**
    *** Sets the Plow distance travelled
    **/
    public void setPlowDistanceKM(double v)
    {
        this.setFieldValue(FLD_plowDistanceKM, v);
    }

    // --------------------------------

    /**
    *** Gets the granular material name/id
    *** @return The granular material name/id
    **/
    @JSONBeanGetter(tags="plow", ignore="$blank")
    public String getGranularMaterialID()
    {
        String v = (String)this.getFieldValue(FLD_granularMaterialID);
        return StringTools.trim(v);
    }

    /**
    *** Sets the granular material name/id
    *** @param v The granular material name/id
    **/
    public void setGranularMaterialID(String v)
    {
        this.setFieldValue(FLD_granularMaterialID, StringTools.trim(v));
    }

    // --------------------------------

    /**
    *** Gets the granular spread rate (Kg/Km)
    *** @return The granular spread rate
    **/
    @JSONBeanGetter(tags="plow", ignore="<=0")
    public double getGranularSpreadRate()
    {
        return this.getFieldValue(FLD_granularSpreadRate, 0.0);
    }

    /**
    *** Sets the granular spread rate (Kg/Km)
    *** @param v The granular spread rate
    **/
    public void setGranularSpreadRate(double v)
    {
        this.setFieldValue(FLD_granularSpreadRate, v);
    }

    // --------------------------------

    /**
    *** Gets the granular season total (Kg)
    *** @return The granular season total
    **/
    @JSONBeanGetter(tags="plow", ignore="<=0")
    public double getGranularSeasonTotal()
    {
        return this.getFieldValue(FLD_granularSeasonTotal, 0.0);
    }

    /**
    *** Sets the granular season total (Kg)
    *** @param v The granular season total
    **/
    public void setGranularSeasonTotal(double v)
    {
        this.setFieldValue(FLD_granularSeasonTotal, v);
    }

    // --------------------------------

    /**
    *** Gets the liquid material name/id
    *** @return The liquid material name/id
    **/
    @JSONBeanGetter(tags="plow", ignore="$blank")
    public String getLiquidMaterialID()
    {
        String v = (String)this.getFieldValue(FLD_liquidMaterialID);
        return StringTools.trim(v);
    }

    /**
    *** Sets the liquid material name/id
    *** @param v The liquid material name/id
    **/
    public void setLiquidMaterialID(String v)
    {
        this.setFieldValue(FLD_liquidMaterialID, StringTools.trim(v));
    }

    // --------------------------------

    /**
    *** Gets the liquid spread rate (L/Km)
    *** @return The liquid spread rate
    **/
    @JSONBeanGetter(tags="plow", ignore="<=0")
    public double getLiquidSpreadRate()
    {
        return this.getFieldValue(FLD_liquidSpreadRate, 0.0);
    }

    /**
    *** Sets the liquid spread rate (L/Km)
    *** @param v The liquid spread rate
    **/
    public void setLiquidSpreadRate(double v)
    {
        this.setFieldValue(FLD_liquidSpreadRate, v);
    }

    // --------------------------------

    /**
    *** Gets the liquid season total (Kg)
    *** @return The liquid season total
    **/
    @JSONBeanGetter(tags="plow", ignore="<=0")
    public double getLiquidSeasonTotal()
    {
        return this.getFieldValue(FLD_liquidSeasonTotal, 0.0);
    }

    /**
    *** Sets the liquid season total (Kg)
    *** @param v The liquid season total
    **/
    public void setLiquidSeasonTotal(double v)
    {
        this.setFieldValue(FLD_liquidSeasonTotal, v);
    }

    // ------------------------------------------------------------------------

    /**
    *** Gets the PersonalHealth Heart-Rate BPM
    *** @return The PersonalHealth Heart-Rate BPM
    **/
    public int getHeartRate()
    {
        Integer v = (Integer)this.getOptionalFieldValue(FLD_heartRate);
        return (v != null)? v.intValue() : 0;
    }

    /**
    *** Sets the PersonalHealth Heart-Rate BPM
    *** @param v The PersonalHealth Heart-Rate BPM
    **/
    public void setHeartRate(int v)
    {
        this.setOptionalFieldValue(FLD_heartRate, ((v >= 0)? v : 0));
    }

    // --------------------------------

    /**
    *** Gets the PersonalHealth Systolic Blood-Pressure
    *** @return The PersonalHealth Systolic Blood-Pressure
    **/
    public int getBpSystolic()
    {
        Integer v = (Integer)this.getOptionalFieldValue(FLD_bpSystolic);
        return (v != null)? v.intValue() : 0;
    }

    /**
    *** Sets the PersonalHealth Systolic Blood-Pressure
    *** @param v The PersonalHealth Systolic Blood-Pressure
    **/
    public void setBpSystolic(int v)
    {
        this.setOptionalFieldValue(FLD_bpSystolic, ((v >= 0)? v : 0));
    }

    // --------------------------------

    /**
    *** Gets the PersonalHealth Diastolic Blood-Pressure
    *** @return The PersonalHealth Diastolic Blood-Pressure
    **/
    public int getBpDiastolic()
    {
        Integer v = (Integer)this.getOptionalFieldValue(FLD_bpDiastolic);
        return (v != null)? v.intValue() : 0;
    }

    /**
    *** Sets the PersonalHealth Diastolic Blood-Pressure
    *** @param v The PersonalHealth Diastolic Blood-Pressure
    **/
    public void setBpDiastolic(int v)
    {
        this.setOptionalFieldValue(FLD_bpDiastolic, ((v >= 0)? v : 0));
    }
    ...
    /**
    *** Gets the LPR captured plate id
    *** @return The captured plate id
    **/
    @JSONBeanGetter(tags="alpr", ignore="$blank")
    public String getAlprPlateID()
    {
        String v = (String)this.getOptionalFieldValue(FLD_alprPlateID);
        return StringTools.trim(v);
    }

    /**
    *** Sets the LPR captured plate id
    *** @param v The captured plate id
    **/
    public void setAlprPlateID(String v)
    {
        this.setOptionalFieldValue(FLD_alprPlateID, StringTools.trim(v));
    }

    /**
    *** Returns true if the main/primary ALPR license plate is defined
    **/
    public boolean hasAlprPlateID()
    {
        return !StringTools.isBlank(this.getAlprPlateID())? true : false;
    }

    // --------------------------------

    /**
    *** Gets the LPR captured plate confidence percent
    *** @return The LPR captured plate confidence percent
    **/
    public double getAlprConfidence()
    {
        Double v = (Double)this.getOptionalFieldValue(FLD_alprConfidence);
        return (v != null)? v.doubleValue() : 0.0;
    }

    /**
    *** Sets the LPR captured plate confidence percent
    *** @param v The LPR captured plate confidence percent
    **/
    public void setAlprConfidence(double v)
    {
        this.setOptionalFieldValue(FLD_alprConfidence, ((v >= 0.0)? v : 0.0));
    }

    // --------------------------------

    /**
    *** Gets the LPR captured plate candidates
    *** @return The captured plate candidates
    **/
    @JSONBeanGetter(tags="alpr", ignore="$blank")
    public String getAlprCandidates()
    {
        // -- "plate1:87,plate2:82,plate3:75"
        String v = (String)this.getOptionalFieldValue(FLD_alprCandidates);
        return StringTools.trim(v);
    }

    /**
    *** Sets the LPR captured plate candidates
    *** @param v The captured plate candidates
    **/
    public void setAlprCandidates(String v)
    { // "plate1:87,plate2:82,plate3:75")
        LicensePlate lp[] = LicensePlate.DecodeLicensePlates(v); // filter/sort
        this.setAlprCandidates(lp);
    }
    ...
    *** @param v The captured plate candidates
    **/
    public void setAlprCandidates(LicensePlate lp[])
    {
        double minConf = 0.0; // 0.75; // minimum confidence
        String lpS = LicensePlate.EncodeLicensePlates(lp, minConf, EventData.LprCandColumnLength);
        this.setOptionalFieldValue(FLD_alprCandidates, lpS);
    }

    /**
    *** Returns true if any ALPR license plate candidate is defined
    **/
    public boolean hasAlprCandidates()
    {
        return !StringTools.isBlank(this.getAlprCandidates())? true : false;
    }

    // --------------------------------

    /**
    *** Gets the LPR captured plate source id
    *** @return The captured plate source id
    **/
    @JSONBeanGetter(tags="alpr", ignore="$blank")
    public String getAlprSourceID()
    {
        String v = (String)this.getOptionalFieldValue(FLD_alprSourceID);
        return StringTools.trim(v);
    }

    /**
    *** Sets the LPR captured plate source id
    *** @param v The captured plate source id
    **/
    public void setAlprSourceID(String v)
    {
        this.setOptionalFieldValue(FLD_alprSourceID, StringTools.trim(v));
    }

    // --------------------------------

    /**
    *** Gets an array of candidate LicensePlate instances
    **/
    public LicensePlate getAlprLicensePlate_Main()
    {
        if (this.hasAlprPlateID()) {
            return new LicensePlate(this.getAlprPlateID(), this.getAlprConfidence());
        } else {
            return null;
        }
    }
    ...
    *** Gets an array of candidate LicensePlate instances
    **/
    public LicensePlate[] getAlprLicensePlate_Candidates()
    {
        OrderedMap<String,LicensePlate> lpMap = new OrderedMap<String,LicensePlate>();
        // -- main LicensePlate
        LicensePlate mainLP = this.getAlprLicensePlate_Main();
        if (mainLP != null) {
            lpMap.put(mainLP.getPlateID(),mainLP);
        }
        // -- candidate license plates
        LicensePlate lpCand[] = LicensePlate.DecodeLicensePlates(this.getAlprCandidates());
        if (!ListTools.isEmpty(lpCand)) {
            for (LicensePlate lp : lpCand) {
                String pid = lp.getPlateID();
                if (!StringTools.isBlank(pid) && !lpMap.containsKey(pid)) {
                    lpMap.put(pid,lp);
                }
            }
        }
        // -- do we have any license plates left to sort?
        if (ListTools.isEmpty(lpMap)) {
            return new LicensePlate[0];
        }
        // -- convert to array and sort
        LicensePlate lpArr[] = lpMap.valueArray(LicensePlate.class);
        ListTools.sort(lpArr, new LicensePlate.ConfidenceComparator());
        return lpArr;
    }
    ...
    */
    ...
    /**
    *** Gets the impact severity
    *** (-1=Unknown, 0=NonCrach, 1=VeryLight, 2=Light, 3=Moderate, 4=Heavy, 5=VeryHeavy)
    **/
    @JSONBeanGetter(tags="impact", ignore="==-1")
    public int getImpactSeverity()
    {
        return this.getOptionalFieldValue(FLD_impactSeverity, -1);
    }

    /**
    *** Sets the impact severity
    **/
    public void setImpactSeverity(int v)
    {
        v = (v < -1)? -1 : (v > 5)? 5 : v;
        this.setOptionalFieldValue(FLD_impactSeverity, v);
    }
    ...
    *** Gets the impact ID
    **/
    @JSONBeanGetter(tags="impact", ignore="$blank")
    public String getImpactID()
    {
        return this.getOptionalFieldValue(FLD_impactID, "");
    }

    /**
    *** Sets the impact ID
    **/
    public void setImpactID(String v)
    {
        this.setOptionalFieldValue(FLD_impactID, StringTools.trim(v));
    }

    // --------------------------------

    public static final int IMPACT_PERIOD_UNKNOWN   = 0;
    public static final int IMPACT_PERIOD_PRE       = 1;
    public static final int IMPACT_PERIOD_POST      = 2;

    /**
    *** Gets the impact data period.
    *** (0=pre-impact, 1=post-impact)
    **/
    @JSONBeanGetter(tags="impact", ignore="==0")
    public int getImpactDataPeriod()
    {
        return this.getFieldValue(FLD_impactDataPeriod, IMPACT_PERIOD_UNKNOWN);
    }
    ...
    **/
    ...
    public static final int IMPACT_STATUS_NONE      = 0;
    public static final int IMPACT_STATUS_PARTIAL   = 1;
    public static final int IMPACT_STATUS_COMPLETE  = 2;
    ...
    **/
    ...
    {
        return this.getFieldValue(FLD_impactDataStatus, IMPACT_STATUS_NONE);
    }
    ...
    **/
    ...
    /**
    *** Gets the impact data type.<br>
    *** Current possible values: "Raw", "Accelerometer[]"
    **/
    @JSONBeanGetter(tags="impact", ignore="$blank")
    ...
    **/
    ...
    /**
    *** Gets the impact data.<br>
    *** The data format depends on "<code>getImpactDataType()</code>"
    **/
    @JSONBeanGetter(tags="impact", ignore="$blank")
    ...
    **/
    @JSONBeanGetter(tags="brake", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="acceleration", ignore="==0")
    ...
    **/
    @JSONBeanGetter(tags="acceleration", ignore="$blank")
    ...
    **/
    @JSONBeanGetter(tags="rfid", ignore="$blank")
    ...
    **/
    ...
    /**
    *** Gets the attachment data as a String
    *** @return The attachment data as a String
    **/
    public String getAttachDataString()
    {
        // -- MySQL: (CONVERT(attachData USING utf8))
        byte b[] = this.getAttachData();
        return (b != null)? StringTools.toStringValue(b) : "";
    }
    ...
    **/
    public RTProperties getAttachRTProperties()
    {
        ...
        if (this.hasAttachData() && this.isAttachType(HTMLTools.CONTENT_TYPE_RTPROP)) {
            ...
            //String rtpS = StringTools.toStringValue(this.getAttachData());
            String rtpS = this.getAttachDataString();
    ...
    /**
    *** Gets the Fingerprint of this EventData record.
    *** (used for obtaining a signature)
    *** @param event  The EventData record for which the signature is obtained
    **/
    public static String getFingerprint(EventData event)
    {
        // -- TODO:
        return "";
    }
    ...
    /**
    *** Gets the EventData signature for this record
    *** @return The EventData signature for this record
    **/
    public String getSignature()
    {
        return this.getFieldValue(FLD_signature, "");
    }

    /**
    *** Sets the EventData signature for this record
    *** @param v The EventData signature for this record
    **/
    public void setSignature(String v)
    {
        this.setFieldValue(FLD_signature, StringTools.trim(v));
    }

    // ------------------------------------------------------------------------

    /**
    *** Gets the Rotational Attitude Pitch (degrees)
    *** @return The Rotational Attitude Pitch (degrees)
    **/
    public double getRotationPitch()
    {
        return this.getFieldValue(FLD_rotationPitch, 0.0);
    }

    /**
    *** Sets the Rotational Attitude Pitch (degrees)
    *** @param v  The Rotational Attitude Pitch (degrees)
    **/
    public void setRotationPitch(double v)
    {
        this.setFieldValue(FLD_rotationPitch, v);
    }

    // --------------------------------

    /**
    *** Gets the Rotational Attitude Roll (degrees)
    *** @return The Rotational Attitude Roll (degrees)
    **/
    public double getRotationRoll()
    {
        return this.getFieldValue(FLD_rotationRoll, 0.0);
    }

    /**
    *** Sets the Rotational Attitude Roll (degrees)
    *** @param v  The Rotational Attitude Roll (degrees)
    **/
    public void setRotationRoll(double v)
    {
        this.setFieldValue(FLD_rotationRoll, v);
    }

    // --------------------------------

    /**
    *** Gets the Rotational Attitude Yaw (degrees)
    *** @return The Rotational Attitude Yaw (degrees)
    **/
    public double getRotationYaw()
    {
        return this.getFieldValue(FLD_rotationYaw, 0.0);
    }

    /**
    *** Sets the Rotational Attitude Yaw (degrees)
    *** @param v  The Rotational Attitude Yaw (degrees)
    **/
    public void setRotationYaw(double v)
    {
        this.setFieldValue(FLD_rotationYaw, v);
    }
    ...
    **/
    @JSONBeanGetter(tags="fuel", ignore="==0")
    ...
    **/
    @JSONBeanGetter(tags="fuel,temperature", ignore="<-273,==0")
    ...
    **/
    @JSONBeanGetter(tags="fuel,pto", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="fuel,engine", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="engine", ignore="<=0")
    ...
    **/
    ...
    {
        this.setFieldValue(FLD_engineRpm, ((v >= 0L)? v : 0L));
    }
    ...
    **/
    @JSONBeanGetter(tags="engine,hours", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="idle,engine,hours", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="work,hours", ignore="<=0")
    ...
    **/
    ...
    public static final double TRANS_UNKNOWN   = EventData.TransmissionGear(0,99); //  099/0xx
    // --
    public static final double TRANS_PARK      = EventData.TransmissionGear(9,99); //  999/9xx
    // --
    public static final double TRANS_NEUTRAL   = EventData.TransmissionGear(0, 0); //  000
    public static final double TRANS_NEUTRAL2  = EventData.TransmissionGear(1, 0); //  100      Unknown?
    // --
    public static final double TRANS_REVERSE   = EventData.TransmissionGear(1,-1); // -101/-1xx
    public static final double TRANS_REVERSE2  = EventData.TransmissionGear(1,-1); // -100      Neutra2l/Unknown?
    // --
    public static final double TRANS_DRIVE     = EventData.TransmissionGear(1,99); //  199
    public static final double TRANS_FIRST     = EventData.TransmissionGear(1, 1); //  101
    public static final double TRANS_SECOND    = EventData.TransmissionGear(1, 2); //  102
    public static final double TRANS_THIRD     = EventData.TransmissionGear(1, 3); //  103
    public static final double TRANS_FORTH     = EventData.TransmissionGear(1, 4); //  104
    public static final double TRANS_FIFTH     = EventData.TransmissionGear(1, 5); //  105
    public static final double TRANS_SIXTH     = EventData.TransmissionGear(1, 6); //  106
    // --
    public static final double TRANS_4H_1ST    = EventData.TransmissionGear(2, 1); //  201
    public static final double TRANS_4H_2ND    = EventData.TransmissionGear(2, 2); //  202
    public static final double TRANS_4H_3RD    = EventData.TransmissionGear(2, 3); //  203
    // --
    public static final double TRANS_4L_1ST    = EventData.TransmissionGear(3, 1); //  301
    public static final double TRANS_4L_2ND    = EventData.TransmissionGear(3, 2); //  302
    public static final double TRANS_4L_3RD    = EventData.TransmissionGear(3, 3); //  303

    /**
    *** Return a transmission gear indicator from transfer-case and transmission-gear values
    **/
    public static double TransmissionGear(int xfer, int gear) 
    { 
        // -- [-]TGG
        // -    Prefixed with "-" (negative) if reverse
        // -    T  : 0=Unknown, 1=Normal gearing, 2=4-high, 4=4-low
        // -    GG : Gear number (99=Drive)

        /* gear limit (may be negative) */
        int G = (Math.abs(gear) <= 99)? gear : 99;

        /* transfer case limit (non-negative) */
        xfer = Math.abs(xfer);
        int XC = (xfer <= 9)? xfer : 9;
        ...
        double TG = (double)((XC * 100) + Math.abs(G));
        return (G < 0)? -TG : TG;

    }

    /**
    *** Return a human readable string from transmission-gear value
    **/
    public static String TransmissionGearString(double rTGG)
    {
        int     tgi = (int)rTGG;
        int     tga = (tgi < 0)? -tgi : tgi; // absolute value
        boolean REV = (tgi < 0)? true : false;
        int     XC  = tga / 100; // Txx: transfer-case
        int     G   = tga % 100; // xGG: gear
        if (XC == 0) {
            // -- 0xx: Neutral transfer case
            if (G == 0) {
                // -- 000: Neutral
                return "Neutral"; // TRANS_NEUTRAL
            } else 
            if (G == 99) {
                // -- 099: Unknown
                return "Unknown"; // TRANS_UNKNOWN
            } else {
                // -- 0xx: Unknown
                return "Unknown"; // TRANS_UNKNOWN
            }
        ...
        if (XC >= 9) {
            // -- 9xx: G should also be "99", but is ignored
            return "Park"; // TRANS_PARK
        } else 
        if (REV) {
            // -- -xxx: "Rev[XC]-G"
            StringBuffer sb = new StringBuffer();
            ...
            if (G <= 0) {
                // -- -100: Reverse/Neutral? [TRANS_REVERSE2]
                sb.append("-").append("N");
            } else
            if ((G <= 1) || (G >= 99)) {
                // -- -101/-199: unknown gear, or first reverse gear [TRANS_REVERSE]
            } else {
                // -- -102: specific gear > 1 and < 99
                sb.append("-").append(G); 
            }
            return sb.toString();
        } else {
            ...
            if (G <= 0) {
                // -- 100: unknown gear (neutral?) [TRANS_NEUTRAL2]
                sb.append("-").append("N");
            } else
            if (G >= 99) { 
                // -- 199: Drive [TRANS_DRIVE]
                sb.append("-").append("D");
            } else {
                // -- 101: specific gear
                sb.append("-").append(G);
    ...
    **/
    public double getTransGear()
    {
        ...
        return (v != null)? v.doubleValue() : TRANS_NEUTRAL;
    }
    ...
    **/
    ...
    /**
    *** Returns true if transmission gear is in reverse
    **/
    public boolean isTransGearReverse()
    {
        int tg = (int)this.getTransGear();
        return (tg < 0.0)? true : false;
    }

    /**
    *** Returns true if transmission gear is in reverse
    **/
    public boolean isTransGearNeutral()
    {
        int tg = (int)this.getTransGear();
        if (tg < 0) {               // -xxx:
            return false;   // reverse
        } else
        if (tg == TRANS_NEUTRAL) {  // 000:
            return true;    // neutral
        } else
        if (tg == TRANS_NEUTRAL2) { // 100:
            return true;    // unknown
        } else 
        if ((tg % 100) == 0) {      // x00:
            return true;    // unknown (but assume neutral)
        } else {
            return false;
        }
    }
    ...
    **/
    @JSONBeanGetter(tags="engine,coolant", ignore="<=0")
    ...
    **/
    @JSONBeanGetter(tags="engine,coolant,temperature", ignore="<-273,==0")
    ...
    **/
    @JSONBeanGetter(tags="engine,temperature", ignore="<-273,==0")
    ...
    **/
    @JSONBeanGetter(tags="engine,pto", ignore="false")
    public boolean getPtoEngaged()
    {
        return this.getFieldValue(FLD_ptoEngaged, false); // default set to 'false' [2.6.7-B47v]
    }
    ...
    **/
    ...
    /**
    *** Gets the vehicle battery amps/current
    *** @return The vehicle battery amps/current
    **/
    @JSONBeanGetter(tags="battery", ignore="<=0")
    public double getVBatteryAmps()
    {
        return this.getFieldValue(FLD_vBatteryAmps, 0.0);
    }

    /**
    *** Sets the vehicle battery amps/current
    *** @param v The vehicle battery amps/current
    **/
    public void setVBatteryAmps(double v)
    {
        this.setFieldValue(FLD_vBatteryAmps, v);
    }
    ...
    **/
    public long getOBDFault()
    {
        ...
        if (!StringTools.isBlank(evFault)) {
            RTProperties faultRTP = new RTProperties(evFault);
            return DTOBDFault.EncodeFault(faultRTP);
        } else {
    ...
    **/
    public static String trimFaultCode(String v)
    {
        ...
        if ((EventData.FaultColumnLength > 0)              &&
            ...
            fault = fault.substring(0,newLen).trim(); // truncate to max-length
    ...
    *** Trims the faultCode to the proper length for the field
    **/
    public static String trimFaultCode(RTProperties v)
    {
        return EventData.trimFaultCode((v != null)? v.toString() : "");
    }
    ...
    **/
    @JSONBeanGetter(tags="engine,fault", ignore="$blank")
    ...
    *** @param v The fault code string
    **/
    public void setFaultCode(RTProperties rtp)
    {
        if ((rtp != null) && !rtp.isEmpty()) {
            this.setFaultCode(rtp.toString());
        } else {
            this.setFaultCode((String)null);
        }
    }
    ...
    **/
    public void setFaultCode_OBDII(String dtc[])
    {
        if (!ListTools.isEmpty(dtc)) {
            String make = null; // this.getDevice().getVehicleMake();
            this.setFaultCode(DTOBDFault.GetRTProperties_OBDII(dtc,make));
        } else {
            this.setFaultCode((String)null);
        }
    }
    ...
    /** 
    *** Sets the J1708 fault codes 
    *** @param dtc  An array of DTC value codes (format: "MID/sPID/FMI/OC")
    **/
    public void setFaultCode_J1708(String dtc[])
    {
        if (!ListTools.isEmpty(dtc)) {
            this.setFaultCode(DTOBDFault.GetRTProperties_J1708(dtc));
        } else {
            this.setFaultCode((String)null);
        }
    }
    ...
    **/
    ...
    {
        if (!ListTools.isEmpty(dtc)) {
            this.setFaultCode(DTOBDFault.GetRTProperties_J1939(dtc));
        } else {
            this.setFaultCode((String)null);
        }
    }
    ...
    **/
    @JSONBeanGetter(tags="engine,fault", ignore="false")
    ...
    **/
    ...
    /**
    *** Gets the MIL distance tripometer value in kilometers.
    *** @return The MIL distance tripometer value in kilometers.
    **/
    public double getMilDistanceKM()
    {
        return this.getFieldValue(FLD_milDistanceKM, 0.0);
    }

    /**
    *** Sets the MIL distance tripometer value in kilometers.
    *** @param v The MIL distance tripometer value in kilometers.
    **/
    public void setMilDistanceKM(double v)
    {
        this.setFieldValue(FLD_milDistanceKM, v);
    }
    ...
    **/
    @JSONBeanGetter(tags="brake", ignore="false")
    ...
    **/
    ...
    /* indicator that we have set a copy of this device */
    private boolean isDeviceCopy = false; // [2.6.6-B19b]

    /**
    *** Set this Device instance.
    *** This is identical to "eventData.setDevice(..)", except that this method also
    *** resets the "isDeviceCopy()" method to false.
    **/
    public void setDeviceNoCopy(Device dev) // Note: cannot override "setDevice(...)"
    {
        this.setDevice(dev);
        this.isDeviceCopy = false;
    }
    
    /**
    *** Sets an unmodified copy of the actual Device instance (see also "setInsertionDevice")
    **/
    public void setDeviceCopy(Device dev) // [2.6.6-B19b]
    {
        this.setDevice(dev);
        this.isDeviceCopy = true;
    }

    /**
    *** Returns true if the cached Device instance is an unmodified copy of the original
    **/
    public boolean isDeviceCopy()
    {
        return this.isDeviceCopy;
    }
    ...
    *** This is set within the "device._insertEventData" method.  This method is necessary
    *** because the "EventData.getDevice()" instance must return an unmodified copy
    *** of the Device instance when "device.getDeferRuleCheckToPostInsert()" returns true.
    **/
    ...
    **/
    public boolean isStartEvent(int ssc[], boolean checkSpeed)
    {
        ...
        if (checkSpeed) {
            return this.isInMotion()? true : false;
        } else {
            return false;
        }
    }
    ...
    **/
    ...
    private String triggerRuleID = null;

    /**
    *** Sets the trigger RuleID (if this event triggered a rule)
    **/
    public void setTriggerRuleID(String ruleID)
    {
        this.triggerRuleID = ruleID;
    }

    /**
    *** Gets the trigger RuleID (if this event triggered a rule)
    **/
    @JSONBeanGetter(ignore="$blank")
    public String getTriggerRuleID()
    {
        return this.triggerRuleID;
    }
    ...
    **/
    ...
    /* rule trigger event */
    private boolean isSkipRuleChecks = false;

    /**
    *** Sets the skip-rule-check state.
    *** (Set by the EventRuleAction "addEvent" pre-defined action)
    *** @param skipRules  True to skip rule checking for this event
    **/
    public void setSkipRuleChecks(boolean skipRules)
    {
        this.isSkipRuleChecks = skipRules;
    }

    /**
    *** Returns the skip-rule-check state
    *** @return The skip-rule-check state
    **/
    public boolean getSkipRuleChecks()
    {
        return this.isSkipRuleChecks;
    }
    ...
    **/
    ...
    public static final String PPNAME_speeding      = "speeding";   // isSpeeding(...)
    ...
    **/
    ...
    {   // PushpinChooser
        Device dev = this.getDevice(); // should not be null, but check anyway!
        ...
        // ---------------------------------------
        // -- 9) Use "speeding" pushpin, if device is moving/speeding

        /* SpeedingPushpin: "speeding" icon index */
        if (this.isSpeeding()) { // check for speeding using default values
            int speedingIconNdx = EventData._getPushpinIconIndex(PPNAME_speeding, iconMap, -1);
            if (speedingIconNdx >= 0) { // '0' is a valid index
                if (debugPP) PushpinDebug("\""+PPNAME_speeding+"\" name [#9]", iconMap, speedingIconNdx);
                return speedingIconNdx;
            }
        }

        // ---------------------------------------
        // -- 10) Use "moving" pushpin, if device is moving

        /* MovingPushpin: "moving" icon index */
        if (this.isInMotion()) { // check for non-zero speed
            int movingIconNdx = EventData._getPushpinIconIndex(PPNAME_moving, iconMap, -1);
            if (movingIconNdx >= 0) { // '0' is a valid index
                if (debugPP) PushpinDebug("\""+PPNAME_moving+"\" name [#10]", iconMap, movingIconNdx);
                return movingIconNdx;
            }
        }

        // ---------------------------------------
        // -- 11) Check the default pushpin specified by "EventData.defaultPushpinName"
        ...
        if (dftIconNdx >= 0) {
            if (debugPP) PushpinDebug("default(\""+dftIconName+"\") name [#11]", iconMap, dftIconNdx);
            return dftIconNdx;
        }

        // ---------------------------------------
        // -- 12) No pushpin found, use "black"

        /* NoPushpin: no pushpin found! */
        if (debugPP) PushpinDebug("Not Found [#12]", iconMap, PushpinIcon.ICON_PUSHPIN_BLACK);
    ...
    **/
    ...
    /**
    *** Returns the Color for the Route-Line Segment immediately following the
    *** Pushpin on a map.   Returns blank if no special color should be set.
    **/
    public String getRouteSegmentColor( // RouteSegmentColor
        boolean isFleet, BasicPrivateLabel bpl)
    {

        // --------------------------------
        // -- Choose color by rule-selector

        /* get route segment color selector */
        String rtColorSel;
        getColorSelector_block: {
            // -- get selector from device
            Device dev = this.getDevice();
            if (dev != null) { // this.hasDevice()
                String rcs = dev.getRouteSegmentColorSelector();
                if (!StringTools.isBlank(rcs)) {
                    rtColorSel = rcs; // non-blank
                    break getColorSelector_block;
                }
            }
            // -- get selector from BasicPrivateLabel
            if (bpl != null) {
                String rcs = bpl.getRTProperties().getString(BasicPrivateLabel.PROP_TrackMap_routeSegmentColorSelector, null);
                if (!StringTools.isBlank(rcs)) {
                    rtColorSel = rcs; // non-blank
                    break getColorSelector_block;
                }
        ...
        RuleFactory rf = Device.getRuleFactory();
        if (rf == null) {
            // -- no RuleFactory defined
            Print.logDebug("[RouteSegmentColorSelector] RuleFactory not defined");
            return "";
        } else
        if (!rf.checkRuntime()) { // <== fails quickly on error
            // -- invalid RuleFactory defined
            return "";
        }

        /* evaluate selector */
        try {
            Object result = rf.evaluateSelector(rtColorSel, this);
            if (result == null) {
                // -- no result
                Print.logError("[RouteSegmentColorSelector] no result: " + rtColorSel);
                return "";
            } else
            if (!(result instanceof String)) {
                // -- invalid result
                Print.logError("[RouteSegmentColorSelector] non-String result returned: " + rtColorSel + " ["+result+"]");
                return "";
            } else {
                return result.toString();
            }
        } catch (RuleParseException rpe) {
            Print.logError("[RouteSegmentColorSelector] Selector parse error: " + rtColorSel);
            return "";
        }
    ...
    **/
    ...
    @Override
    public EventData _reload(DBReadWriteMode rwMode, String... fldNames)
        throws DBException
    {
        EventData ev = super._reload(rwMode, fldNames);
        return ev;
    }
    ...
    **/
        ...
        throws DBException // if error occurs while testing existence
    {
        ...
        if (stCode < 0) {
            ...
            return evKey.exists(DBReadWriteMode.READ_WRITE);
        }
    }
    ...
    **/
    public static String getWhereClause(
        String acctId, String devId, String drvId,
        ...
        String andSelect_1, String andSelect_2)
    {
        ...
        if (!StringTools.isBlank(acctId)) {
            ...
            if (!StringTools.isBlank(drvId) && !drvId.equals("*")) {
                // -- "driverID" specified
                dwh.append(dwh.AND_(dwh.EQ(EventData.FLD_driverID , drvId)));
            }
        }
    ...
    **/
        ...
        throws DBException
    {
        ...
        try {
            ...
            ed = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel, null); // select:DBSelect
        } finally {
            if (EventData.LockTableOnRead()) {
        ...
        throws DBException
    {
        ...
        try {
            ...
            ed = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel, rcdHandler);
        } finally {
            if (EventData.LockTableOnRead()) {
                DBProvider.unlockTables();
            }
        ...
        throws DBException
    {
        ...
        try {
            ...
            //ed = (EventData[])DBRecord.select(rwMode, EventData.getFactory(), dsel.toString(false), rcdHandler);
            ed = DBRecord.select(rwMode, dsel, rcdHandler); // select:DBSelect
    ...
    **/
        ...
        throws DBException
    {
        ...
        wh.append(EventData.getWhereClause(
            ...
            false /*gpsRequired*/,
            null  /*andSelect*/  ));
        return DBRecord.getRecordCount(rwMode, EventData.getFactory(), wh);
    }
    ...
    **/
    ...
    /* get EventData records by "creationTime" (does not return null) */
    public static EventData[] getEventsByCreationTime(
        String acctId, 
        String devId,
        long createStartTS, long createEndTS, // seconds
        long limit)
        throws DBException
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_ONLY;
        ...
        /* invalid time range */
        if ((createStartTS > 0L) && (createEndTS > 0L) && (createStartTS > createEndTS)) {
            return EMPTY_ARRAY;
        }

        /* does "creationTime" have an alternate key? */
        DBField fldCreateTime = dbFact.getField(EventData.FLD_creationTime);
        if (fldCreateTime == null) {
            Print.logError("EventData column '"+EventData.FLD_creationTime+"' does not exist");
            return EMPTY_ARRAY;
        } else
        if (!fldCreateTime.isAlternateKey()) {
            Print.logError("EventData column '"+EventData.FLD_creationTime+"' does not have an alternate key");
            return EMPTY_ARRAY;
        }

        /* create/return DBSelect */
        // -- DBSelect: [SELECT * FROM EventData] <Where> ORDER BY <FLD_creationTime> LIMIT <Limit>
        DBSelect<EventData> dsel = new DBSelect<EventData>(dbFact);
        ...
        if (createStartTS >= 0L) {
            // -- AND (creationTime>=123436789)
            dwh.append(dwh.AND_(dwh.GE(EventData.FLD_creationTime,createStartTS)));
        }
        if ((createEndTS >= 0L) && (createEndTS >= createStartTS)) {
            // -- AND (creationTime<=123456789)
            dwh.append(dwh.AND_(dwh.LE(EventData.FLD_creationTime,createEndTS)));
        }
        dsel.setWhere(dwh.WHERE(dwh.toString()));
        dsel.setOrderByFields(FLD_creationTime,FLD_timestamp);
        ...
        try {
            ...
            ed = DBRecord.select(rwMode, dsel, null/*rcdHandler*/); // select:DBSelect
        } finally {
            if (EventData.LockTableOnRead()) {
                DBProvider.unlockTables();
            }
    ...
    public static EventData[] getEventsByCreationMillis(
        String acctId, 
        String devId,
        long createStartMS, long createEndMS, // milliseconds
        long limit)
        throws DBException
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_ONLY;
    ...
    **/
        ...
        throws DBException
    {
        ...
        // -- read count from 'READ' database for quicker result
    ...
    **/
    ...
    /**
    *** Gets the most recent EventData record for the specified account
    **/
    public static EventData getLastEventForAccount(String acctId)
        throws DBException
    {
        EventData ed[] = EventData.getRangeEvents(
            acctId, null/*DeviceID*/,
            -1L/*TimeStart*/, -1L/*TimeEnd*/,
            null/*StatusCodes*/,
            false/*ValidGPS*/,
            EventData.LimitType.LAST, 1L/*Limit*/, false/*ascending?*/,
            null/*AdditionalSelect_1*/);
        return !ListTools.isEmpty(ed)? ed[0] : null;
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        //  -- "atkey" alternate key (may not be needed)
        //    ALTER TABLE EventData_copy DROP INDEX atkey;
        //    CREATE INDEX atkey ON EventData_copy (accountID,timestamp);
        ...
        if (StringTools.isBlank(accountID) || accountID.equals("ALL") || accountID.equals("*")) {
            ...
            for (String acctID : acctList) {
                // -- get account
                Account account = Account.getAccount(rwMode, acctID); // may return null
    ...
    **/
        ...
        throws DBException
    {
        ...
        User user = null;
        boolean inclInactv = true;
        OrderedSet<String> devIDList = Device.getDeviceIDsForAccount(rwMode, accountID, user, inclInactv);
        for (String devID : devIDList) {
            Device device = Device.getDevice(rwMode, account, devID);
    ...
    **/
        ...
        throws DBException
    {
        ...
        final String destXTableName;
        {
            ...
            // -- read last event
            EventData lastED[] = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel, null/*rcdHandler*/); // throws DBException
        ...
        for (;;) {
            ...
            // -- read
            try {
                DBRecord.select(DBReadWriteMode.READ_ONLY, dsel, 
    ...
    private static final String KEY_GPS_SPEED[]       = new String[] { "gpsSpeed"                               };  // "34.9 mph"
    ...
    private static final String KEY_MOTION_STATE[]    = new String[] { "motionState"        , "motion"          };  // "moving"|"stopped"|"idle"
    ...
    private static final String KEY_BATTERY_LEVEL[]   = new String[] { "batteryLevel"       , "battLevel"       };  // "75%"
    private static final String KEY_BATTERY_VOLTS[]   = new String[] { "batteryVolts"       , "battVolts"       };  // "4.5"
    ...
    private static final String KEY_IMPACT_ID[]       = new String[] { "impactID"                               };  // 
    private static final String KEY_IMPACT_SEVERITY[] = new String[] { "impactSeverity"                         };  // 

    private static final String KEY_PULSE_COUNT[]     = new String[] { "pulseCount"                             };  // 
    ...
    public  static final String KEY_FAULT_DESCS[]     = new String[] { "faultDescs"                             };  // 
  ...
  //private static final String KEY_TEMP_7[]          = new String[] { "temp7", "thermoAverage7"              };  // 47.3F
    ...
    private static final String KEY_ARGS[]            = new String[] { "args"                                   }; //
    ...
    **/
    public static boolean _keyMatch(String key, String keyMatchList[])
    {
        for (int i = 0; i < keyMatchList.length; i++) {
            if (key.equalsIgnoreCase(keyMatchList[i])) {
                return true;
            }
        }
        return false;
    ...
    /**
    *** Returns trus if the key-prefix is a proper prefix of the specified key
    **/
    public static boolean _keyPrefix(String key, String keyPfx)
    {
        if ((key == null) || (keyPfx == null)) {
            // -- invalid parameters
            return false;
        } else
        if (key.length() <= keyPfx.length()) {
            // -- not a proper prefix
            return false;
        } else {
            //return key.startsWith(keyPfx);
            return StringTools.startsWithIgnoreCase(key,keyPfx);
        }
    }
    ...
    *** Returns true if the specified key matches at least one of the target keys
    **/
    public static boolean _keyPrefix(String key, String keyPfxList[])
    {
        for (int i = 0; i < keyPfxList.length; i++) {
            if (EventData._keyPrefix(key,keyPfxList[i])) {
                return true;
            }
        }
        return false;
    ...
    **/
        ...
        Locale locale, BasicPrivateLabel bpl, EventData ed)
    {
        ...
        /* Account/Device */
        Account account = (ed != null)? ed.getAccount() : null;
        Device  device  = (ed != null)? ed.getDevice()  : null;
      ...
      //String args[] = StringTools.split(arg,',');
        String args[] = StringTools.parseArray(arg,',');
        ...
        if (EventData._keyMatch(key,EventData.KEY_GEOPOINT)) {
            if (getTitle) {
                ...
                Account.LatLonFormat latlonFmt = Account.getLatLonFormat(account);
        ...
        if (EventData._keyMatch(key,EventData.KEY_GPS_SPEED)) {
            if (getTitle) {
                return i18n.getString("EventData.key.gpsSpeed", "GPS Speed");
            } else {
                double kph = ed.getGpsSpeedKPH();
        ...
        if (EventData._keyMatch(key,EventData.KEY_MOTION_STATE)) {
            if (getTitle) {
                return i18n.getString("EventData.key.motionState", "Motion\nState");
            } else {
                if (ed.getSpeedKPH() > 0.0) {
                    return i18n.getString("EventData.key.moving", "Moving");
                }
                IgnitionState ignState = EventData.getIgnitionState(ed);
                if (ignState.isON()) {
                    return i18n.getString("EventData.key.idle", "Idle");
                } else {
                    return i18n.getString("EventData.key.stopped", "Stopped");
                }
            }
        } else
        ...
        if (EventData._keyMatch(key,EventData.KEY_BATTERY_VOLTS)) {
            if (getTitle) {
                ...
                double bv = ed.getBatteryVolts();
                if ((bv <= 0.0) && (device != null)) {
                    bv = device.getLastBatteryVolts();
                }
        ...
        if (EventData._keyMatch(key,EventData.KEY_VEH_BATTERY_V)) {
            if (getTitle) {
                ...
                double bv = ed.getVBatteryVolts();
                if ((bv <= 0.0) && (device != null)) {
                    bv = device.getLastVBatteryVolts();
                }
                return StringTools.format(bv, "0.0");
            }
        }
        ...
        if (EventData._keyMatch(key,EventData.KEY_FUEL_LEVEL)) {
            if (getTitle) {
                ...
                double CAP_1 = device.getFuelCapacity(Device.FuelTankIndex.TANK_1); // liters [tank #1]
                double CAP_2 = device.getFuelCapacity(Device.FuelTankIndex.TANK_2); // liters [tank #2]
        ...
        if (EventData._keyMatch(key,EventData.KEY_FUEL_DROP_VOL)) {
            if (getTitle) {
                ...
                double LEV_1 = device.getLastFuelLevel(Device.FuelTankIndex.TANK_1) - ed.getFuelLevel(Device.FuelTankIndex.TANK_1,true/*estimate*/);
                double LEV_2 = device.getLastFuelLevel(Device.FuelTankIndex.TANK_2) - ed.getFuelLevel(Device.FuelTankIndex.TANK_2,true/*estimate*/);
                double CAP_1 = device.getFuelCapacity(Device.FuelTankIndex.TANK_1); // liters [tank #1]
                double CAP_2 = device.getFuelCapacity(Device.FuelTankIndex.TANK_2); // liters [tank #2]
                if ((CAP_1 <= 0.0) && (CAP_2 <= 0.0)) {
                    return i18n.getString("EventData.notAvailable","n/a");
        ...
        if (EventData._keyMatch(key,EventData.KEY_FUEL_VOLUME1)) {
            if (getTitle) {
                ...
                double LEV_1 = ed.getFuelLevel(Device.FuelTankIndex.TANK_1,true/*estimate*/);
                double CAP_1 = device.getFuelCapacity(Device.FuelTankIndex.TANK_1);
        ...
        if (EventData._keyMatch(key,EventData.KEY_FUEL_VOLUME2)) {
            if (getTitle) {
                ...
                double CAP_2 = device.getFuelCapacity(Device.FuelTankIndex.TANK_2);
        ...
        if (EventData._keyMatch(key,EventData.KEY_TIRE_TEMP)) {
            if (getTitle) {
                ...
                Account.TemperatureUnits tu = Account.getTemperatureUnits(account);
                int tireNdx = StringTools.parseInt(arg, -1);
                // --
                if (tireNdx >= 0) {
                    double tempC = ed.getTireTemperature(tireNdx);
                    if (Temperature.isValidTemperatureC(tempC)) {
        ...
        if (EventData._keyMatch(key,EventData.KEY_TIRE_PRESSURE)) {
            if (getTitle) {
                ...
                Account.PressureUnits pu = Account.getPressureUnits(account);
                int tireNdx = StringTools.parseInt(arg, -1);
                // --
                if (tireNdx >= 0) {
        ...
        /* pulse count */
        if (EventData._keyMatch(key,EventData.KEY_PULSE_COUNT)) { // [2.6.7-B46c]
            if (getTitle) {
                return i18n.getString("EventData.key.pulseCount", "Pulse Count");
            } else {
                double pc  = ed.getPulseCount();
                String fmt = !StringTools.isBlank(arg)? arg : ((double)((long)pc) != pc)? "0.00" : "0";
                return StringTools.format(pc, fmt);
            }
        }

        /* impact id/severity */
        if (EventData._keyMatch(key,EventData.KEY_IMPACT_ID)) { // [2.6.7-B46c]
            if (getTitle) {
                return i18n.getString("EventData.key.impactID", "Impact ID");
            } else {
                return StringTools.trim(ed.getImpactID());
            }
        } else
        if (EventData._keyMatch(key,EventData.KEY_IMPACT_SEVERITY)) { // [2.6.7-B46c]
            if (getTitle) {
                return i18n.getString("EventData.key.impactSeverity", "Impact\nSeverity");
            } else {
                if (StringTools.isBlank(arg) || arg.equalsIgnoreCase("num") || arg.equals("#")) {
                    // -- numeric value
                    return String.valueOf(ed.getImpactSeverity());
                } else
                if (arg.equalsIgnoreCase("desc")) {
                    // -- description
                    ImpactSeverity impSev = EventData.getImpactSeverity(ed); // non-null
                    return impSev.toString(locale);
                } else {
                    // -- unrecognized arg, return default numeric
                    return String.valueOf(ed.getImpactSeverity());
                }
            }
        }
        ...
        /* OBD fault values */
        // -- ruleTest.sh:
        // -    /set EventData.faultCode=TYPE=OBDII DTC=P0420,P0421
        // -    /msg ${faultDesc}
        // -    /msg ${faultDescs:"  $F: $D"}
        // -    /msg ${faultCode}
        // -    /msg ${faultCodes}
        if (EventData._keyMatch(key,EventData.KEY_FAULT_HEADER)) {
            if (getTitle) {
                ...
                RTProperties faultRTP = ed.getFaultCodeRTProperties(); // may be null
                return DTOBDFault.GetFaultHeader(faultRTP); // may return blank
            }
        } else
        if (EventData._keyMatch(key,EventData.KEY_FAULT_CODE)) {
            if (getTitle) {
                ...
                return DTOBDFault.GetFaultString(faultRTP, firstOnly); // may return blank
            }
        } else
        if (EventData._keyMatch(key,EventData.KEY_FAULT_CODES)) {
            if (getTitle) {
                ...
                RTProperties faultRTP = ed.getFaultCodeRTProperties();
                boolean firstOnly = false;
                for (int i = 0; i < args.length; i++) {
                    if (args[i].equalsIgnoreCase("first")) {
                        firstOnly = true;
                    }
                }
                return DTOBDFault.GetFaultString(faultRTP, firstOnly); // may return blank
        ...
        if (EventData._keyMatch(key,EventData.KEY_FAULT_DESC)) {
            if (getTitle) {
                ...
                RTProperties faultRTP = ed.getFaultCodeRTProperties();
                String  make      = (device != null)? device.getVehicleMake() : null;
                boolean firstOnly = true;
                String  fmt       = null;  // use default
                for (int i = 0; i < args.length; i++) {
                    if (StringTools.isBlank(args[i])) {
                        // -- skip blank args
                    } else
                    if (args[i].equalsIgnoreCase("all")) {
                        // -- ${faultDesc:first}
                    ...
                    if (args[i].equalsIgnoreCase("cr") || args[i].equalsIgnoreCase("\\n")) {
                        // -- ${faultDesc:all,cr}, ${faultDesc:all,"\n"}
                        fmt = DTOBDFault.FAULT_DESC_FORMAT_ + "\n";
                    } else
                    if (DTOBDFault.IsDescFormat(args[i])) { // contains '$F' and/or '$D'
                        // -- ${faultDesc:all,"[$F] $D\n"}
                        fmt = args[i];
                    } 
                }
                return DTOBDFault.GetFaultDescription(faultRTP, make, locale, firstOnly, fmt);
            }
        } else
        if (EventData._keyMatch(key,EventData.KEY_FAULT_DESCS)) {
            if (getTitle) {
                return i18n.getString("EventData.key.faultDescrs", "Fault Descriptions");
            } else {
                RTProperties faultRTP = ed.getFaultCodeRTProperties();
                String  make      = (device != null)? device.getVehicleMake() : null;
                boolean firstOnly = false;
        ...
        */
        ...
        if (EventData._keyMatch(key,EventData.KEY_ETA_DATETIME)) {
            if (getTitle) {
                ...
                return EventData.getTimestampString(ts, account, tmz, null);
            }
        } else
        ...
        /* DEBUG: echo args */
        if (EventData._keyMatch(key,EventData.KEY_ARGS)) {
            if (getTitle) {
                return "Display replacement var parameters";
            } else {
                return StringTools.encodeArray(args,',',true);
            }
        }
        ...
        /* try account */
        // -- control will liky not reach here, since "device" will likely be non-null
        if (getTitle) {
    ...
    public static void main(String argv[])
    {
        ...
        if (RTConfig.getBoolean(ARG_MAKE_INNODB,false)) {
            ...
            if (isInnoDB) {
                // -- already InnoDB
                try {
                    // -- read count from 'READ' database for quicker results
                    long rcdCnt = edFact.getRecordCount(DBReadWriteMode.READ_ONLY,"",false);
            ...
            try {
                // -- read count from 'READ' database for quicker results
                recordCount = edFact.getRecordCount(DBReadWriteMode.READ_ONLY,"",true);
            } catch (DBException dbe) {
                Print.logException("Error getting record count", dbe);
                System.exit(99);
            }
