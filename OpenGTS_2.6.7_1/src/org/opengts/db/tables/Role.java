    ...
    extends RoleRecord<Role>
{
    ...
    public String[] getAclsForRole(DBReadWriteMode rwMode)
        throws DBException
    {
        ...
        throws DBException
    {
        ...
        return this.getAclsForRole(rwMode);
    }
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (roleID != null)) {
            ...
            return roleKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
    ...
    /* Return specified role (may return null) (READ_WRITE database assumed) */
        ...
        throws DBException
    {
        ...
        /* get Role */
        Role.Key roleKey = new Role.Key(acctId, roleId);
        if (roleKey.exists(rwMode)) {
            Role role = roleKey._getDBRecord(true, rwMode);
            return role;
        } else {
            return null;
        }
        ...
        throws DBException
    {
        ...
        Role role = null;
        Role.Key roleKey = new Role.Key(acctId, roleId);
        if (!roleKey.exists(DBReadWriteMode.READ_WRITE)) { // may throw DBException
            if (create) {
                role = roleKey._getDBRecord();
    ...
    /* return list of all Roles owned by the specified Account (NOT SCALABLE) */
    // -- does not return null
    public static String[] getRoles(DBReadWriteMode rwMode, DBSelect<Role> dsel)
        throws DBException
    {
        rwMode = DBReadWriteMode.getDefaultReadWriteMode(rwMode);
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Role.getRoles(rwMode, dsel);
    }
