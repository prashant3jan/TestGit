  ...
  //public static final String FLD_exclude              = "exclude";
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (groupID != null) && (devID != null)) {
            ...
            return devListKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
    ...
    /* get/create device list (READ_WRITE database assummed) */
        ...
        throws DBException
    {
        ...
        if (devListKey.exists(rwMode)) { // may throw DBException
            // already exists
            DeviceList list = devListKey._getDBRecord(true, rwMode);
            list.setGroup(group);
            return list;
        } else
        if (createOK) {
            DeviceList list = devListKey._getDBRecord();
