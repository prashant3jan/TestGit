...
public class DeviceGroup
    ...
    implements DeviceGroupProvider,
               JSON.JSONBean
{
    ...
    **/
        ...
        throws DBException
    {
        ...
        if (devListKey.exists(DBReadWriteMode.READ_WRITE)) {
            // -- already exists
            Print.logInfo("Device ["+deviceID+"] already added to group: " + accountID + "/" + groupID);
        } else {
            DeviceList devListEntry = devListKey._getDBRecord();
    ...
    **/
        ...
        throws DBException
    {
        ...
        devList = DeviceGroup.getDeviceIDsForGroup(DBReadWriteMode.READ_ONLY, acctID, groupID, null, true/*inclInactv*/, -1L);;
    ...
    **/
        ...
        throws DBException
    {
        ...
        /* get device list */
        OrderedSet<String> devList = null;
        devList = DeviceGroup.getDeviceIDsForGroup(rwMode, acctID, groupID, null, true/*inclInactv*/, -1L);;
        int devCount = ListTools.size(devList);
        if (devCount <= 0) {
            // may also mean that account/group does not exist
            if (log) {
        ...
        throws DBException // if error occurs while testing existance
    {
        ...
        if (groupID.equalsIgnoreCase(DeviceGroup.DEVICE_GROUP_ALL)) {
            ...
            return groupKey.exists(DBReadWriteMode.READ_WRITE);
        }
    }
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (groupID != null) && (deviceID != null)) {
            ...
            return deviceListKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
        ...
        throws DBException
    {
        ...
        if (groupKey.exists(rwMode)) { // may throw DBException
            DeviceGroup group = groupKey._getDBRecord(true, rwMode);
            group.setAccount(account);
            return group;
        } else
        if (createOK) {
            DeviceGroup group = groupKey._getDBRecord();
            group.setAccount(account);
    ...
    /* return list of all Devices within the specified DeviceGroup */
    public OrderedSet<String> getDevices(DBReadWriteMode rwMode, User userAuth, boolean inclInactv)
        throws DBException
    {
        String acctId  = this.getAccountID(); // TODO: matches "userAuth.getAccountID()"?
        String groupId = this.getGroupID();
        return DeviceGroup.getDeviceIDsForGroup(rwMode, acctId, groupId, userAuth, inclInactv, -1L);
    }
    // --
    @Deprecated
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return this.getDevices(rwMode, userAuth, inclInactv);
    }
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return DeviceGroup.getDeviceIDsForGroup(rwMode, acctId, groupId, userAuth, inclInactv, limit);
    }

    // ------------------------------------------------------------------------

    /* return list of all DeviceGroups owned by the specified Account */
    // -- does not return null
    public static java.util.List<String> getDeviceGroupsForAccount(DBReadWriteMode rwMode, String acctId, boolean includeAll)
        throws DBException
    {
        ...
        /* return list */
        return DeviceGroup.getDeviceGroups(rwMode, dsel, includeAll);

    }
    // --
    @Deprecated
    public static java.util.List<String> getDeviceGroupsForAccount(String acctId, boolean includeAll)
        throws DBException
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return DeviceGroup.getDeviceGroupsForAccount(rwMode, acctId, includeAll);
    }

    /* return list of all DeviceGroups owned by the specified Account (NOT SCALABLE) */
    // -- does not return null
    public static OrderedSet<String> getDeviceGroups(DBReadWriteMode rwMode, DBSelect<DeviceGroup> dsel, boolean includeAll)
        throws DBException
    {
    ...
    public static Collection<String> getDeviceGroupsForDevice(DBReadWriteMode rwMode, String acctId, String deviceId)
        throws DBException
    {
        return DeviceGroup.getDeviceGroupsForDevice(rwMode, acctId, deviceId, true);
    }
    // --
    @Deprecated
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return DeviceGroup.getDeviceGroupsForDevice(rwMode, acctId, deviceId);
    }

    /* return list of all DeviceGroups in which the specified device is a member */
    public static Collection<String> getDeviceGroupsForDevice(DBReadWriteMode rwMode, String acctId, String deviceId, boolean inclAll)
        throws DBException
    {
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return DeviceGroup.getDeviceGroupsForDevice(rwMode, acctId, deviceId, inclAll);
    }
        ...
        if (RTConfig.hasProperty(ARG_LIST)) {
            ...
            if (hasGroupID) {
                if (!groupExists) {
                    ...
                    try {
                        OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(DBReadWriteMode.READ_ONLY, accountID, groupID, null, true/*inclInactv*/, -1L);
                        if (devList.size() <= 0) {
                ...
                try {
                    ...
                    java.util.List<String> groupList = DeviceGroup.getDeviceGroupsForAccount(DBReadWriteMode.READ_ONLY, accountID, true);
                    if (groupList.size() == 0) {
