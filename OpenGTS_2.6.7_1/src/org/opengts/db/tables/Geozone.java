...
//     -Added support for roleID-based Geozone visibility (see RoleVisibility) [2.6.7-B46h]
// ----------------------------------------------------------------------------
    ...
    extends AccountRecord<Geozone>
{
    ...
    /* supports RoleVisibility? */
    private static final boolean _UserRoleVisibilityEnabled  = false; // RoleVisibility

    /**
    *** Returns true if User Geozone RoleID visibility is enabled
    **/
    public static boolean GetUserRoleVisibilityEnabled() // RoleVisibility
    {
        return RTConfig.getBoolean(DBConfig.PROP_Geozone_userRoleVisibility, _UserRoleVisibilityEnabled);
    }

    /**
    *** Sets the User Geozone RoleID visibility enabled
    **/
    public static void SetUserRoleVisibilityEnabled(boolean urvEnable) // RoleVisibility
    {
        RTConfig.setBoolean(DBConfig.PROP_Geozone_userRoleVisibility, urvEnable);
    }
    ...
    *** Gets the Geozone active state
    **/
    public static boolean getIsActive(Geozone gz)
    {
        return (gz != null)? gz.getIsActive() : false;
    }
    ...
    public static final String FLD_sortID                   = "sortID";         // ordering of this point within the geozone-id
    // -- bounding box
    ...
    // -- DeviceGroup association
    public static final String FLD_roleID                   = User.FLD_roleID; // RoleVisibility
    // -- custom address
    ...
    private static DBField FieldInfo[] = {
        ...
        // -- Role assignment
        new DBField(FLD_roleID              , String.class  , DBField.TYPE_ROLE_ID()   , "User Role"        , "edit=2"), // RoleVisibility
    ...
    *** @return True if the current Geozone is applicable to the specified DeviceID
    **/
    public static boolean isDeviceInGroup(Geozone gz, String deviceID)
    {
        return (gz != null)? gz.isDeviceInGroup(deviceID) : false;
    }

    // ------------------------------------------------------------------------

    /**
    *** Returns true if the RoleID is defined
    **/
    public boolean hasRoleID() // RoleVisibility
    {
        return !StringTools.isBlank(this.getRoleID());
    }

    /**
    *** Gets the user role id to which this Geozone visibility is limited
    **/
    public String getRoleID() // RoleVisibility
    {
    ...
    /**
    *** Sets the user role id to which this Geozone visibility is limited
    **/
    /* set the user role id */
    public void setRoleID(String v) // RoleVisibility
    {
    ...
    ***     device group defined in this instance
    **/
    public static boolean isArrivalZone(Geozone gz, String deviceID)
    {
        return (gz != null)? gz.isArrivalZone(deviceID) : false;
    }
    ...
    ***     device group defined in this instance
    **/
    public static boolean isDepartureZone(Geozone gz, String deviceID)
    {
        return (gz != null)? gz.isDepartureZone(deviceID) : false;
    }
    ...
    **/
    ...
    /* return true if this geozone contains the specified point */
    public boolean containsPoint(GeoPointProvider gpp)
    {
        return (gpp != null)? this.containsPoint(gpp.getGeoPoint()) : false;
    }
    ...
    **/
        ...
        String  roleID) // RoleVisibility
    {
        ...
        /* limit to specific roleIDs? (RoleVisibility) */
        if (!StringTools.isBlank(roleID) && GetUserRoleVisibilityEnabled()) { // RoleVisibility
            dwh.append(dwh.AND_(
                dwh.OR(
                    dwh.EQ(Geozone.FLD_roleID,""),           // all roleID's
                    dwh.EQ(Geozone.FLD_roleID,roleID.trim()) // specific roleID
                    )
                )
            );
        }
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (zoneID != null)) {
            if (sortID >= 0) {
                ...
                return zoneKey.exists(DBReadWriteMode.READ_WRITE);
            } else {
                // -- test for any zone with specified zoneID
                Geozone.Key zoneKey = new Geozone.Key(acctID,zoneID,-1);
                return zoneKey.exists(DBReadWriteMode.READ_WRITE, false);
            }
        }
        return false;
    }
    ...
    /* gets the Geozone matching the specifie criteria */
        ...
        GeoPoint gp, boolean reverseGeocodeOnly)
    {
        ...
        return Geozone.getGeozone(rwMode, account, zoneID, gp, reverseGeocodeOnly);
    }
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozone(rwMode, acctID, zoneID, gp, reverseGeocodeOnly);
    }
        ...
        GeoPoint gp, String purposeID, boolean reverseGeocodeOnly)
    {
        ...
        try {
            ...
            gz = DBRecord.select(rwMode, dsel); // select:DBSelect
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozone(rwMode, acctID, zoneID, gp, purposeID, reverseGeocodeOnly);
    }

    // ------------------------------------------------------------------------

    /* Get all active Geozones in which the GeoPoint resides (sorted by priority) */
    public static Geozone[] getGeozones(
        DBReadWriteMode rwMode,
        String acctID, GeoPoint gp)
        throws DBException
    {
        ...
        if (Geozone.supportsPriority()) {
            dsel.setOrderByFields(FLD_priority, FLD_sortID, FLD_geozoneID);
        } else {
            dsel.setOrderByFields(FLD_sortID, FLD_geozoneID);
        }
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozones(rwMode, acctID, gp);
    }
        ...
        throws DBException
    {
        ...
        try {
            DBProvider.lockTables(new String[] { TABLE_NAME() }, null);
            gz = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel); // select:DBSelect
        } catch (DBException dbe) {
            Print.logError("Geozone error: " + dbe);
            //return null;
            throw dbe;
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozones(rwMode, acctID, gb);
    }

    // ------------------------------------------------------------------------

    /* Get specific Geozone [TODO: return all 'sortID's) */
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozone(rwMode, account, geozoneID);
    }
        ...
        throws DBException
    {
        ...
        if (!zoneKey.exists(rwMode)) { // may throw DBException
            if (create) {
                geozone = zoneKey._getDBRecord();
        ...
        if (create) {
            ...
            geozone = zoneKey._getDBRecord(true, rwMode); // may throw DBException
            if (geozone == null) {
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozone(rwMode, account, geozoneID, sortID, create);
    }
        ...
        throws DBNotFoundException
    {
        ...
        try {
            DBProvider.lockTables(new String[] { TABLE_NAME() }, null);
            //gz = (Geozone[])DBRecord.select(rwMode, Geozone.getFactory(), dsel.toString(false));
            gz = DBRecord.select(rwMode, dsel); // select:DBSelect
        } catch (DBException dbe) {
    ...
    **/
    ...
    /* return list of all Geozone IDs owned by the specified Account */
    // -- does not return null
    public static String[] getGeozoneIDsForAccount(DBReadWriteMode rwMode, Account account, User user)
        throws DBException
    {
        return Geozone.getGeozoneIDsForAccount(rwMode, account, user, (String[])null);
    }
    // -- retained here for legacy purposes (used by 'ctrac')
    @Deprecated
    public static String[] getGeozoneIDsForAccount(Account account, User user)
        throws DBException
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozoneIDsForAccount(rwMode, account, user);
    }

    /* return list of all Geozone IDs owned by the specified Account */
    // -- does not return null
    public static String[] getGeozoneIDsForAccount(DBReadWriteMode rwMode, Account account, User user, String devGrpID[])
        throws DBException
    {
        ...
        /* get user limited roleID [RoleVisibility] */
        String roleID = null;
        if (GetUserRoleVisibilityEnabled() && (user != null) && user.hasRoleID()) {
        ...
        dsel.setWhere(Geozone.getWhereClause(
            ...
            roleID              // RoleID [RoleVisibility]
            ));
        dsel.setOrderByFields(FLD_geozoneID, FLD_sortID);

        /* return list */
        return Geozone.getGeozoneIDs(rwMode, dsel);

    }
    // --
    @Deprecated
    public static String[] getGeozoneIDsForAccount(Account account, User user, String devGrpID[])
        throws DBException
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Geozone.getGeozoneIDsForAccount(rwMode, account, user, devGrpID);
    }

    /* return list of all Geozones owned by the specified Account (NOT SCALABLE) */
    // -- does not return null
    public static String[] getGeozoneIDs(DBReadWriteMode rwMode, DBSelect<Geozone> dsel)
        throws DBException
    {
    ...
    /** 
    *** List Geozones by account
    **/
    public static void listZones(Account account, boolean update)
    {
    ...
    **/
    ...
    {
        // -- bin/admin.pl Geozone -account=ACCOUNT -list [-update]
        ...
        try {
            DBProvider.lockTables(new String[] { TABLE_NAME() }, null);
            //gz = (Geozone[])DBRecord.select(DBReadWriteMode.READ_ONLY, Geozone.getFactory(), dsel.toString(false));
            gz = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel); // select:DBSelect
        } catch (DBException dbe) {
            Print.logError("Geozone error: " + dbe);
            return;
        ...
        /* list Geozones */
        Geozone._listZones(gz, update);

    }

    /** 
    *** List Geozones by User (via 'user.getRoldID()')
    **/
    public static void listZones(User user, boolean update)
    {

        /* invalid user */
        if (user == null) {
            Print.logError("User not specified");
            return;
        }
        String acctID = user.getAccountID();

        /* get RoleID if RoleVisibility is in effect */
        String roleID = null;
        if (GetUserRoleVisibilityEnabled() && user.hasRoleID()) {
            roleID = user.getRoleID();
        }
    ...
    private static void _listZones(Geozone gz[], boolean update)
    {
        // -- we expect that all listed Geozones belong to the same Account
        int invalidBoundingBoxes = 0;
        if ((gz != null) && (gz.length > 0)) {
            String acctID = gz[0].getAccountID();
            Print.sysPrintln("");
            Print.sysPrintln("Account: " + acctID);
            for (int i = 0; i < gz.length; i++) {
                // -- check current Geozone
                if (gz[i] == null) {
                    continue; // quietly ignore
                } else
                if (!acctID.equals(gz[i].getAccountID())) {
                    Print.sysPrintln("ERROR: Unauthorized Geozone Account: " + gz[i].getAccountID());
                    continue;
                }
                // -- display this Geozone
                int ptCnt = Geozone.GetMaxVerticesCount(); // refresh count
                StringBuffer sb = new StringBuffer();
                sb.append(" ---------------------------------------------------------\n");
    ...
    private static final String ARG_USER[]      = new String[] { "user"    , "usr"    }; // -user=<id>
    ...
    public static void main(String argv[])
    {
        ...
        if (!StringTools.isBlank(userID)) {
            try {
                user = User.getUser(account, userID); // may return DBException
                if (user == null) {
                    Print.sysPrintln("ERROR: User-ID does not exist: " + acctID + "/" + userID);
                    usage();
                }
            } catch (DBException dbe) {
        ...
        if (RTConfig.hasProperty(ARG_LIST)) {
            ...
            if (user != null) {
                Geozone.SetUserRoleVisibilityEnabled(true); // force RoleVisibility enabled
                Print.sysPrintln("Listing Geozones by User '"+user.getUserID()+"' (RoleID:"+user.getRoleID()+") ...");
                Geozone.listZones(user, update);
            } else 
            if (account != null) {
                Print.sysPrintln("Listing Geozones by Account ...");
                Geozone.listZones(account, update);
            } else {
                Print.logError("Missing Account/User");
            }
            System.exit(0);
        }
        ...
        if (RTConfig.hasProperty(ARG_LIST)) {
            ...
            try {
                DBReadWriteMode rwMode = DBReadWriteMode.READ_ONLY;
                String gzIDs[] = Geozone.getGeozoneIDsForAccount(rwMode, account, user);
            } catch (DBException dbe) {
                Print.logException("Unable to read Geozones for Account", dbe);
                System.exit(99);
            }
            System.exit(0);
        }
        ...
        if (RTConfig.hasProperty(ARG_CREATE)) {
            ...
            if (zoneExists) {
                ...
                try {
                    ...
                    Geozone gz = key.getDBRecord(); // no reload (new record)
        ...
        if (isArgEdit) { // ARG_EDIT, ARG_EDITALL
            ...
            if (!zoneExists) {
                ...
                try {
                    ...
                    Geozone.Key key = new Geozone.Key(acctID,zoneID,sortID);
                    Geozone gz = key._getDBRecord(true, rwMode);
