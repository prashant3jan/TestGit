...
//     -Added "PrivateLabelLookupUrlPath()" and set default to "false"
// ----------------------------------------------------------------------------
    ...
    extends AccountRecord<Resource>
{
    ...
    private static final boolean PRIVLABEL_LOOKUP_URL_PATH      = false;

    private static boolean PrivateLabelLookupUrlPath()
    {
        //return PRIVLABEL_LOOKUP_URL_PATH;
        return RTConfig.getBoolean(DBConfig.PROP_Resource_PrivateLabelLookupUrlPath, PRIVLABEL_LOOKUP_URL_PATH);
    }
    ...
    **/
        ...
        throws DBException // if error occurs while testing existance
    {
        if ((acctID != null) && (resID != null)) {
            ...
            return resKey.exists(DBReadWriteMode.READ_WRITE);
        }
        return false;
    }
    ...
    /* get Resource (READ_WRITE database assumed) */
    // -- may return null
        ...
        throws DBException
    {
        ...
        if ((acctID != null) && (resID != null)) {
            ...
            if (key.exists(rwMode)) {
                Resource res = key._getDBRecord(true, rwMode);
                return res;
            } else {
    ...
    **/
        ...
        throws DBException
    {
        ...
        Resource res = null;
        Resource.Key resKey = new Resource.Key(acctID, resID);
        if (!resKey.exists(DBReadWriteMode.READ_WRITE)) {
            if (create) {
                res = resKey._getDBRecord();
              //res.setAccount(account);
    ...
    **/
    ...
    /* return list of all Resource keys owned by the specified Account */
    // does not return null
    public static OrderedSet<String> getResourcesForAccount(DBReadWriteMode rwMode, String acctId, String startsWith)
        throws DBException
    {
        ...
        /* return list */
        return Resource.getResources(rwMode, dsel);
    ...
    {
        DBReadWriteMode rwMode = DBReadWriteMode.READ_WRITE;
        return Resource.getResourcesForAccount(rwMode, acctId, startsWith);
    }

    /* return list of Resources based on DBSelect */
    // -- does not return null
    public static OrderedSet<String> getResources(DBReadWriteMode rwMode, DBSelect<Resource> dsel)
        throws DBException
    {
    ...
    **/
    public static RTProperties getPrivateLabelPropertiesForHost(String hostName, String urlPath)
    {
        ...
        for (;;) { // single-pass loop
            ...
            if (Resource.PrivateLabelLookupUrlPath() && !StringTools.isBlank(urlPath)) {
                // -- This section has occasionally cause MySQL errors, such as the following:
                // -    [ERROR|Resource.getPrivateLabelPropertiesForHost] Exception: Error loading Resource: sysadmin/privatelabel.properties:eld.example.net/track/Track
                // -    DBException: Record existence Resource='sysadmin,privatelabel.properties:eld.example.net/track/Track' [com.mysql.jdbc.exceptions.jdbc4.CommunicationsException: Communications link failure
                // -- This may be due to a MySQL-JDBC issume
