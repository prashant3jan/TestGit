    ...
    extends DeviceRecord<Diagnostic>
{
        ...
        throws DBException
    {
        ...
        try {
            ...
            //d = (Diagnostic[])DBRecord.select(DBReadWriteMode.READ_ONLY, Diagnostic.getFactory(), dsel.toString(false));
            d = DBRecord.select(DBReadWriteMode.READ_ONLY, dsel); // select:DBSelect
        } finally {
