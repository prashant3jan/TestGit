    ...
    implements CustomParser
{
    ...
    public static Map<String,Object> CreatePropertyMap(Map<String,Object> dftProps)
    {
        return (dftProps != null)? dftProps : new HashMap<String,Object>();
    }
    ...
    private static Map<String,Object> _InitTemporaryVars(
        ...
        int count, int index) 
    {
        Map<String,Object> map = CreatePropertyMap(evMap);
    ...
    **/
    public byte[] parseData(
        ...
        Map<String,Object> props) {
        if (account != null) {
            props = CreatePropertyMap(props);
            props.put(CustomParser.ACCOUNT, account); // possible this already contains the Account
        }
        if (device != null) {
            props = CreatePropertyMap(props);
            props.put(CustomParser.DEVICE, device); // possible this already contains the Device
        }
        return this.parseData(type, data, props);
    }
