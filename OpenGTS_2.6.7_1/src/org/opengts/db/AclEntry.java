               ...
               JSON.JSONBean
{
    ...
    public enum AccessLevel implements EnumTools.StringLocale, EnumTools.IntValue, EnumTools.IsDefault, JSON.JSONBean {
        ...
        @JSONBeanGetter(name="intValue")
        public int     getIntValue()                { return vv; }
        @JSONBeanGetter(name="description", arg="${locale}")
        public String  getDescription(String loc)   { return aa.toString(I18N.getLocale(loc)); }
        public String  toString()                   { return aa.toString(); }
        public String  toString(Locale loc)         { return aa.toString(loc); }
        public boolean isNone()                     { return this.equals(NONE); }
        public boolean isDefault()                  { return this.isNone(); }
    ...
    **/
    //@JSONBeanGetter() <== 'Locale' not available here
    ...
    **/
    ...
    /**
    *** Gets the access level int-values for this AclEntry
    *** @return The access level int-values for this AclEntry (does not return null)
    **/
    @JSONBeanGetter()
    public int[] getAccessLevelIntValues()
    {
        AccessLevel al[] = this.getAccessLevelValues();
        int aliv[] = new int[al.length];
        for (int a = 0; a < al.length; a++) {
            aliv[a] = al[a].getIntValue();
        }
        return aliv;
    }
